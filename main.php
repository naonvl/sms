...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Yayasan Permata Sari</title>
		...
		<?php if ( $act == obraxabrix('chart_surat_masuk') || $act == obraxabrix('chart_surat_keluar') || $act == obraxabrix('chart_pengunjung') || $act == obraxabrix('chart_pinjam') || $act == obraxabrix('chart_rating_buku') || $act == obraxabrix('chart_presensi')  ) { ?>
		...
		<!----finance only------>
		<script src="<?= $__folder ?>app/finance/script/tooltips.js" language="javascript"></script>
		<script src="<?= $__folder ?>app/finance/script/tools.js" language="javascript"></script>
		<!------------------------->
		
		<script>
			function presensi_harian_siswa() 
{	
				window.open('app/presensi_harian_siswa.php', '_blank', 'width=1000,height=500');
				//newWindow('app/presensi_harian_siswa.php','Presensi Harian Siswa','2000','1500','resizable=1,scrollbars=1,status=0,toolbar=0');
			}

			function presensi_absen_siswa() 
			{	
				window.open('app/presensi_absen_siswa.php', '_blank', 'width=1000,height=500');
				//newWindow('app/presensi_absen_siswa.php','Presensi Absen Siswa','1000','500','resizable=1,scrollbars=1,status=0,toolbar=0');
			}
			
			function presensi_piket() 
{	
				window.open('app/presensi_piket.php', '_blank', 'width=1000,height=500');
				//newWindow('app/presensi_piket.php','Presensi Guru Piket','1000','500','resizable=1,scrollbars=1,status=0,toolbar=0');
			}

			function presensipelajaran() 
{	
				window.open('app/presensipelajaran.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/presensi_general.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/import_pemetaan_kd.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/import_user_guru.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_user_siswa.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_revisi_siswa.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_update_nisn_siswa.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_pa_verifikasi.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_ekskul_siswa.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/daftar_nilai_update.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/import_user_pa_ledger.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/copy_mapel_krs.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_user_siswa_baru.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/import_siswa_baru.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_gugus_siswa_baru.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/import_update_siswa.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/import_update_siswa_baru.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_capital_name.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_siswa_ujian.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_guru_ujian.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_mapel_ujian.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/import_nilai_ujian.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_user_siswa_new.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/copy_mapel_krs_siswa.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_acess_raport_siswa.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_acess_raport_guru.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_siswa_baru_kelas.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/generate_ar.php', '_blank', 'width=1000,height=500');
...
{	
				window.open('app/import_siswa.php', '_blank', 'width=1000,height=500');
				//newWindow('app/import_siswa.php','Generate Data Siswa','1000','500','resizable=1,scrollbars=1,status=0,toolbar=0');
			}

			//generate data pegawai
			function import_pegawai() 
{	
				window.open('app/import_pegawai.php', '_blank', 'width=1000,height=500');
				//newWindow('app/import_pegawai.php','Generate Data Pegawai','1000','500','resizable=1,scrollbars=1,status=0,toolbar=0');
			}

			//generate data pegawai non pns
			function import_pegawai_non_pns() 
{	
				window.open('app/import_pegawai_non_pns.php', '_blank', 'width=1000,height=500');
				//newWindow('app/import_pegawai_non_pns.php','Generate Data Pegawai Non PNS','1000','500','resizable=1,scrollbars=1,status=0,toolbar=0');
			}
			
			//generate data item
			function import_item() 
{	
				window.open('app/import_item.php', '_blank', 'width=1000,height=500');
				//newWindow('app/import_item.php','Generate Data Inventaris','1000','500','resizable=1,scrollbars=1,status=0,toolbar=0');
			}

			//generate data pustaka
			function import_pustaka() 
{	
				window.open('app/import_pustaka.php', '_blank', 'width=1000,height=500');
				//newWindow('app/import_pustaka.php','Generate Data Pustaka','1000','500','resizable=1,scrollbars=1,status=0,toolbar=0');
			}

			function import_data_siswa() 
{	
				window.open('app/generate_siswa.php', '_blank', 'width=1000,height=500');
				//newWindow('app/generate_siswa.php','Generate Data Pustaka','1000','500','resizable=1,scrollbars=1,status=0,toolbar=0');
			}

			function cronjob_wa() 
{
				window.open('app/cronjob_wa.php', '_blank', 'width=1000,height=500');

				//newWindow('app/cronjob_wa.php','Cron Job WA','1000','500','resizable=1,scrollbars=1,status=0,toolbar=0');
			}
			...
			<div class="main-content">
				<div class="main-content-inner">
						...
						<div class="breadcrumbs" id="breadcrumbs">
							...
							<ul class="breadcrumb">
	                            ...
	                            <?php 
	                                ...
	                                if ( $act == obraxabrix('penempatan_gugus') ) {  
	                                    echo '<li><a href="#">PPDB</a></li><li class="active">Penempatan Kelompok</li>';
	                                }
	                                if ( $act == obraxabrix('registrasi_list') ) {  
	                                    echo '<li><a href="#">PPDB</a></li><li class="active">Seleksi Pendaftaran</li>';
	                                }
	                                ...
	                                if ( $act == obraxabrix('kartu_rencana_studi') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Setup Mapel Rapor</li>';
	                                }
	                                if ( $act == obraxabrix('kartu_rencana_studi_view') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Daftar Setup Mapel Rapor</li>';
	                                }
	                                ...
	                                if ( $act == obraxabrix('soal_ukbm') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Master Soal PAT</li>';
	                                }
	                                if ( $act == obraxabrix('soal_ukbm_view') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Daftar Master Soal PAT</li>';
	                                }
	                                if ( $act == obraxabrix('soal_ukbm_select') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Seleksi Soal PAT</li>';
	                                }
	                                if ( $act == obraxabrix('soal_ukbm_select_view') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Daftar Seleksi Soal PAT</li>';
	                                }
	                                if ( $act == obraxabrix('soal_ukbm_siswa') || $act == obraxabrix('soal_ukbm_siswa_filter')  ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Soal PAT Siswa</li>';
	                                }
	                                if ( $act == obraxabrix('soal_ukbm_siswa_view') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Daftar Soal PAT Siswa</li>';
	                                }
	                                
	                                if ( $act == obraxabrix('ukbm_siswa') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">PAT Siswa</li>';
	                                }
	                                if ( $act == obraxabrix('ukbm_siswa_view') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Daftar PAT Siswa</li>';
	                                }
	                                
	                                if ( $act == obraxabrix('ukbm_siswa_approved') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">PAT Siswa Approved</li>';
	                                }
	                                ...
	                                if ( $act == obraxabrix('deskripsi_raport_p5') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Setup Deskripsi Rapor P5</li>';
	                                }
	                                if ( $act == obraxabrix('deskripsi_raport_p5_view') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Daftar Setup Deskripsi Rapor P5</li>';
	                                }
	                                ...
	                                if ( $act == obraxabrix('raport_p5') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Rapor P5</li>';
	                                }
	                                if ( $act == obraxabrix('raport_p5_view') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Daftar Rapor P5</li>';
	                                }
	                                if ( $act == obraxabrix('raport_p5_list') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Rapor P5</li>';
	                                }
	                                if ( $act == obraxabrix('raport_p5_update') ) {  
	                                    echo '<li><a href="#">Kurikulum</a></li><li class="active">Rapor P5</li>';
	                                }
	                                

	                                ##PERPUSTAKAAN
	                                if ( $act == obraxabrix('kunjungan_perpustakaan') ) {  
	                                    echo '<li><a href="#">Perpustakaan</a></li><li class="active">Buku Kunjungan</li>';
	                                }
	                                if ( $act == obraxabrix('kunjungan_perpustakaan_view') ) {  
	                                    echo '<li><a href="#">Perpustakaan</a></li><li class="active">Daftar Buku Kunjungan</li>';
	                                }
	                                ...
	                                if ( $act == obraxabrix('presensi_harian_siswa') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Presensi Harian Siswa</li>';
	                                }
	                                if ( $act == obraxabrix('presensi_harian_siswa_view') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Daftar Presensi Harian Siswa</li>';
	                                }

	                                if ( $act == obraxabrix('presensi_absen_siswa') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Absensi Izin Siswa</li>';
	                                }
	                                if ( $act == obraxabrix('presensi_absen_siswa_view') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Daftar Absensi Izin Siswa</li>';
	                                }

	                                
	                                if ( $act == obraxabrix('presensipelajaran') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Presensi Mapel</li>';
	                                }
	                                if ( $act == obraxabrix('presensi_ukbm') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Presensi KBM</li>';
	                                }
	                                
	                                if ( $act == obraxabrix('presensi_ukbm_view') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Daftar Presensi KBM</li>';
	                                }
	                                ...
	                                if ( $act == obraxabrix('siswa_terlambat') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Siswa Terlambat</li>';
	                                }
	                                if ( $act == obraxabrix('siswa_terlambat_view') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Daftar Siswa Terlambat</li>';
	                                }
	                                
	                                if ( $act == obraxabrix('rpt_presensi_harian_siswa') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Lap. Presensi Harian Siswa</li>';
	                                }
	                                if ( $act == obraxabrix('rpt_presensi_harian_siswa_sps') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Lap. Presensi Harian Siswa Spesial</li>';
	                                }
	                                if ( $act == obraxabrix('rpt_absensi_harian_siswa') || $act == obraxabrix('absensi_harian_siswa') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Lap. Absensi Harian Siswa</li>';
	                                }
	                                if ( $act == obraxabrix('rpt_presensi_siswa_pelajaran') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Lap. Presensi Pelajaran Siswa</li>';
	                                }
	                                if ( $act == obraxabrix('rpt_presensi_guru_pelajaran') ) {  
	                                    echo '<li><a href="#">Presensi</a></li><li class="active">Lap. Presensi Guru Pelajaran</li>';
	                                }
	                                if ( $act == obraxabrix('rpt_presensi_ukbm') ) {  
	                                    echo '<li><a href="#">Presensi Siswa</a></li><li class="active">Lap. Presensi KBM (Siswa)</li>';
	                                }
	                                if ( $act == obraxabrix('chart_presensi') ) {  
	                                    echo '<li><a href="#">Presensi</a></li><li class="active">Lap. Grafik Presensi</li>';
	                                }

	                                /*PRESENSI GURU*/
	                                if ( $act == obraxabrix('presensi_general_filter') || $act == obraxabrix('presensi_general') ) {  
	                                    echo '<li><a href="#">Presensi Guru</a></li><li class="active">Presensi PPK</li>';
	                                }
	                                if ( $act == obraxabrix('presensi_general_view') || $act == obraxabrix('presensi_general') ) {  
	                                    echo '<li><a href="#">Presensi Guru</a></li><li class="active">Daftar Presensi PPK</li>';
	                                }
	                                if ( $act == obraxabrix('rpt_presensi_piket') ) {  
	                                    echo '<li><a href="#">Presensi Guru</a></li><li class="active">Lap. Guru Piket</li>';
	                                }
	                                if ( $act == obraxabrix('rpt_presensi_general') ) {  
	                                    echo '<li><a href="#">Presensi Guru</a></li><li class="active">Lap. Presensi Harian Umum</li>';
	                                }
	                                ...
	                                if ( $act == obraxabrix('setup_periode_raport_p5') ) {  
	                                    echo '<li><a href="#">Utility</a></li><li class="active">Setup Titimangsa Rapor P5</li>';
	                                } 
	                                if ( $act == obraxabrix('setup_periode_raport_p5_view') ) { 
	                                    echo '<li><a href="#">Utility</a></li><li class="active">Daftar Setup Titimangsa Rapor P5</li>';
	                                }
	                                if ( $act == obraxabrix('query_string') ) {  
	                                    echo '<li><a href="#">Utility</a></li><li class="active">Execute Query</li>';
	                                }
	                                if ( $act == obraxabrix('presensiharian_setup') ) {  
	                                    echo '<li><a href="#">Utility</a></li><li class="active">Seting Jam Presensi Siswa</li>';
	                                } 
	                                if ( $act == obraxabrix('presensiharian_setup_view') ) { 
	                                    echo '<li><a href="#">Utility</a></li><li class="active">Daftar Seting Jam Presensi Siswa</li>';
	                                }
	                                ...
	                                if ( $act == obraxabrix('pinjam_alat_filter') ) {  
	                                    echo '<li><a href="#">Sarana & Prasarana</a></li><li class="active">Peminjaman Barang</li>';
	                                }
	                                if ( $act == obraxabrix('pinjam_alat') ) {  
	                                    echo '<li><a href="#">Sarana & Prasarana</a></li><li class="active">Peminjaman Barang</li>';
	                                }
	                                if ( $act == obraxabrix('pinjam_alat_view') ) {  
	                                    echo '<li><a href="#">Sarana & Prasarana</a></li><li class="active">Daftar Peminjaman</li>';
	                                }
	                                if ( $act == obraxabrix('pinjam_alat_list') ) {  
	                                    echo '<li><a href="#">Sarana & Prasarana</a></li><li class="active">Pengembalian Barang</li>';
	                                }
	                                ...
	                                if ( $act == obraxabrix('surat_masuk_disposisi_list') || $act == obraxabrix('surat_masuk_disposisi') ) {  
	                                    echo '<li><a href="#">Surat Menyurat</a></li><li class="active">Disposisi Surat Masuk</li>';
	                                }
	                                if ( $act == obraxabrix('surat_masuk_disposisi_view') ) {  
	                                    echo '<li><a href="#">Surat Menyurat</a></li><li class="active">Daftar Disposisi Surat Masuk</li>';
	                                }
	                                ...
	                                if ( $act == obraxabrix('chart_surat_masuk') ) {  
	                                    echo '<li><a href="#">Surat Menyurat</a></li><li class="active">Grafik Surat Masuk</li>';
	                                }
	                                if ( $act == obraxabrix('chart_surat_keluar') ) {  
	                                    echo '<li><a href="#">Surat Menyurat</a></li><li class="active">Grafik Surat Keluar</li>';
	                                }


									// KEUANGAN
									if ( $act == obraxabrix('registrasireg_view') ) {  
	                                    echo '<li><a href="#">PPDB</a></li><li class="active">Verifikasi Pendaftaran</li>';
	                                }
	                                ...
	                                // KEPEGAWIAN
									if ( $act == obraxabrix('pegawai') ) {  
	                                    echo '<li><a href="#">Kepegawaian</a></li><li class="active">Input PTK</li>';
	                                } 
	                                if ( $act == obraxabrix('pegawai_view') ) {  
	                                    echo '<li><a href="#">Kepegawaian</a></li><li class="active">PTK List</li>';
	                                }
	                                if ( $act == obraxabrix('pegawai_non_pns') ) {  
	                                    echo '<li><a href="#">Kepegawaian</a></li><li class="active">Input PTK Non PNS</li>';
	                                } 
	                                if ( $act == obraxabrix('pegawai_non_pns_view') ) {  
	                                    echo '<li><a href="#">Kepegawaian</a></li><li class="active">PTK Non PNS List</li>';
	                                }
					...
					<?php
		                ...
		                if ($act == obraxabrix('setup_periode_raport_p5') ) { include_once("app/setup_periode_raport_p5.php"); }
		                if ($act == obraxabrix('setup_periode_raport_p5_view')) { include_once("app/setup_periode_raport_p5_view.php"); }
		                if ($act == obraxabrix('query_string')) { include_once("app/query_string.php"); }
		                if ($act == obraxabrix('presensiharian_setup')) { include_once("app/presensiharian_setup.php"); }
		                if ($act == obraxabrix('presensiharian_setup_view')) { include_once("app/presensiharian_setup_view.php"); }
						...
						if ($act == obraxabrix('penempatan_gugus')) { include_once("app/penempatan_gugus.php"); }
						if ($act == obraxabrix('registrasi_list')) { include_once("app/registrasi_list.php"); }
						...
						if ($act == obraxabrix('registrasireg_view')) { include_once("app/registrasireg_view.php"); }
						
						##perpustakaan
						if ($act == obraxabrix('kunjungan_perpustakaan')) { include_once("app/kunjungan_perpustakaan.php"); }
						if ($act == obraxabrix('kunjungan_perpustakaan_view')) { include_once("app/kunjungan_perpustakaan_view.php"); }
						...
						if ($act == obraxabrix('chart_pengunjung')) { 
							include_once("app/chart/chart_pengunjung.php"); 
							include_once("app/js_css.php"); 
						}
						if ($act == obraxabrix('chart_pinjam')) { 
							include_once("app/chart/chart_pinjam.php"); 
							include_once("app/js_css.php"); 
						}
						if ($act == obraxabrix('chart_rating_buku')) { 
							include_once("app/chart/chart_rating_buku.php"); 
							include_once("app/js_css.php"); 
						}
						...
						if ($act == obraxabrix('pegawai_non_pns')) { include_once("app/pegawai_non_pns.php"); }
						if ($act == obraxabrix('pegawai_non_pns_view')) { include_once("app/pegawai_non_pns_view.php"); }
						...
						if ($act == obraxabrix('presensi_absen_siswa')) { include_once("app/presensi_absen_siswa.php"); }
						if ($act == obraxabrix('presensi_absen_siswa_view')) { include_once("app/presensi_absen_siswa_view.php"); }
						...
						if ($act == obraxabrix('rpt_presensi_harian_siswa_sps')) { include_once("app/rpt_presensi_harian_siswa_sps.php"); }
						if ($act == obraxabrix('rpt_absensi_harian_siswa')) { include_once("app/rpt_absensi_harian_siswa.php"); }
						if ($act == obraxabrix('absensi_harian_siswa')) { include_once("app/absensi_harian_siswa.php"); }
						if ($act == obraxabrix('rpt_presensi_siswa_pelajaran')) { include_once("app/rpt_presensi_siswa_pelajaran.php"); }
						if ($act == obraxabrix('presensi_general_filter')) { include_once("app/presensi_general_filter.php"); }
						if ($act == obraxabrix('presensi_general')) { include_once("app/presensi_general.php"); }
						if ($act == obraxabrix('presensi_general_view')) { include_once("app/presensi_general_view.php"); }
						...
						if ($act == obraxabrix('rpt_presensi_piket')) { include_once("app/rpt_presensi_piket.php"); }
						if ($act == obraxabrix('rpt_presensi_ukbm')) { include_once("app/rpt_presensi_ukbm.php"); }

						if ($act == obraxabrix('chart_presensi')) { 
							include_once("app/chart/chart_presensi.php"); 
							include_once("app/js_css.php"); 
						}
						...
						if ($act == obraxabrix('deskripsi_raport_p5')) { include_once("app/deskripsi_raport_p5.php"); }
						if ($act == obraxabrix('deskripsi_raport_p5_view')) { include_once("app/deskripsi_raport_p5_view.php"); }
						...
						if ($act == obraxabrix('raport_p5')) { include_once("app/raport_p5.php"); }
						if ($act == obraxabrix('raport_p5_view')) { include_once("app/raport_p5_view.php"); }
						if ($act == obraxabrix('raport_p5_list')) { include_once("app/raport_p5_list.php"); }
						if ($act == obraxabrix('raport_p5_update')) { include_once("app/raport_p5_update.php"); }
						...
						if ($act == obraxabrix('pinjam_alat_filter')) { include_once("app/pinjam_alat_filter.php"); }
						if ($act == obraxabrix('pinjam_alat')) { include_once("app/pinjam_alat.php"); }
						if ($act == obraxabrix('pinjam_alat_view')) { include_once("app/pinjam_alat_view.php"); }
						if ($act == obraxabrix('pinjam_alat_list')) { include_once("app/pinjam_alat_list.php"); }
						...
						if ($act == obraxabrix('surat_masuk_disposisi_list')) { include_once("app/surat_masuk_disposisi_list.php"); }
						if ($act == obraxabrix('surat_masuk_disposisi')) { include_once("app/surat_masuk_disposisi.php"); }
						if ($act == obraxabrix('surat_masuk_disposisi_view')) { include_once("app/surat_masuk_disposisi_view.php"); }
						if ($act == obraxabrix('chart_surat_masuk')) { 
							include_once("app/chart/chart_surat_masuk.php");
							include_once("app/js_css.php"); 
						}
						if ($act == obraxabrix('chart_surat_keluar')) { 
							include_once("app/chart/chart_surat_keluar.php");
							include_once("app/js_css.php"); 
						}
