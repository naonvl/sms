<?php if ( allow("frmregistrasi")==1 || allow("frmregistrasiview")==1 || allow("frmgugus")==1 || allow("frmpenempatan_gugus")==1 || allow("registrasi_list")==1) { ?>
	...
	<li class="<?php echo $psb ?>">
		...
		<ul class="submenu">
			...
			<?php if ( allow("registrasi_list")==1 ) { ?>
			...
			<?php if ( allow("frmpenempatan_gugus")==1 ) { ?>
...
<?php if ( allow("frmsiswa")==1 || allow("frmsiswa_list")==1 || allow("frmsiswa_baru")==1 || allow("frmkelas")==1 || allow("frmtingkat")==1 || allow("frmtahunajaran")==1 || allow("frmagama")==1 || allow("kenaikan")==1 || allow("penempatan")==1 || allow("barcode")==1 || allow("frmdepartemen")==1 || allow("frmangkatan")==1 || allow("kelulusan")==1 || allow("alumni_list")==1 || allow("pindah_kelas")==1 || allow("frmsiswa_ekstrakurikuler")==1 || allow("pelajaran_un_minat")==1 || allow("pelajaran_raport_minat")==1 || allow("penempatan_siswa_prioritas")==1 || allow("frmsiswa_izin")==1 || allow("frmkejadian_lain")==1 || allow("frmguru_bk")==1 || allow("siswa_list2")==1 || allow("frmsiswa_baru_list")==1 || allow("frminfonap")==1 || allow("frmsiswa_input_ekskul")==1 || allow("raport_siswa_cover")==1 || allow("frmalumni")==1 ) { ?>
...
<?php if ( allow("frmpelajaran")==1 || allow("frmsemester")==1 || allow("frmrpp")==1 || allow("frmkompetensi")==1 || allow("frmdasarpenilaian")==1 || allow("frmsiswa_krs")==1 || allow("siswa_krs_approved")==1 || allow("frmkartu_rencana_studi")==1 || allow("frmguru")==1 || allow("frmjadwal")==1 || allow("frmjam")==1 || allow("frmsoal")==1 || allow("frmsoal_select")==1 || allow("frmsoal_siswa")==1 || allow("frmpemetaan_kd")==1 || allow("frmpemetaan_kd_siswa")==1 || allow("frmukbm")==1 || allow("frmsoal_ukbm")==1 || allow("frmsoal_ukbm_select")==1 || allow("frmsoal_ukbm_siswa")==1 || allow("frmukbm_siswa")==1 || allow("ukbm_siswa_approved")==1 || allow("frmguru_ekskul")==1 || allow("frmguru_absen")==1 || allow("siswa_pertemuan_krs")==1 || allow("daftar_absensi")==1 || allow("frmguru_penugasan")==1 ) { ?>
	...
	<?php } ?>
		...
		<ul class="submenu">
			...
			<?php if ( allow("frmsoal_ukbm_siswa")==1 ) { ?>
				<li class="<?php echo $soal_ukbm_siswa_active ?>">
    				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('soal_ukbm_siswa') ?>">
    					<i class="menu-icon fa fa-caret-right"></i>
    					<?php if ($_SESSION['bahasa']==1) { echo "Question PAT Student"; } else { echo "Soal PAT Siswa"; } ?>
    				</a>
			...
			<?php if ( allow("frmguru_penugasan")==1 ) { ?>
...
<!--RAPOR-->
<?php if (allow("frmdaftarnilai")==1 || allow("raport_siswa")==1 || allow("raport_siswa_ledger")==1 || allow("frmpredikat_raport")==1 || allow("frmdeskripsi_raport")==1 || allow("frmsetup_siswa_khusus")==1 || allow("raport_p5")==1 || allow("frmdeskripsi_raport_p5")==1 ) { ?>
	<li class="<?php echo $rapor ?>">
		...
		<ul class="submenu">
			...
			<?php if ( allow("frmdeskripsi_raport_p5")==1 ) { ?>
...
<?php if ( allow("frmtahunbuku")==1 || allow("rpt_lunas")==1 || allow("frmreceipt")==1 || allow("frmgeneral_journal")==1 || allow("frmgeneral_journal_in")==1 || allow("frmfinance_type")==1 || allow("generate_ar")==1 || allow("frmcoa")==1 || allow("frmpurchase_inv")==1 || allow("purchase_inv_list")==1 || allow("frmpurchase_return")==1 || allow("frmgood_receipt")==1 || allow("frmpayment")==1 || allow("rpt_ar")==1 || allow("frmrregistrasireg")==1 ) { ?>
	...
	<li class="<?php echo $keuangan ?>">
		...
		<ul class="submenu">
			<?php if ( allow("frmrregistrasireg")==1 ) { ?>
...
<!--PERPUSTAKAAN-->
<?php if ( allow("frmperpustakaan")==1 || allow("frmformat")==1 || allow("frmrak")==1 || allow("frmkatalog")==1 || allow("frmpenerbit")==1 || allow("frmpenulis")==1 || allow("frmpustaka")==1 || allow("frmpinjam")==1 || allow("frmkembali")==1 || allow("rpt_pinjam_telat")==1 || allow("frmkonfigurasi")==1 || allow("frmsupplier")==1 || allow("frmanggota")==1 || allow("frmperpustakaan")==1 || allow("frmkunjungan_perpustakaan")==1 || allow("chart_pengunjung")==1 || allow("chart_pinjam")==1 || allow("chart_rating_buku")==1 ) { ?>
	...
	<li class="<?php echo $perpustakaan ?>">
		...
		<ul class="submenu">
			...
			<?php if ( allow("frmkunjungan_perpustakaan")==1 ) { ?>
...
<?php if ( allow("frmpegawai")==1 || allow("frmstatusguru")==1 || allow("pegawai_jabatan")==1 || allow("frmjabatan")==1 || allow("frmpangkat")==1 || allow("frmpegawai_pangkat")==1 || allow("frmjenis_sertifikasi")==1 || allow("frmstatus_pegawai")==1 || allow("frmkenaikan_gaji")==1 || allow("frmpegawai_pendidikan")==1 || allow("frmpegawai_keluarga")==1 || allow("frmpegawai_prestasi")==1 || allow("frmpegawai_skmengajar")==1 || allow("frmjenis_sertifikasi")==1 || allow("frmpegawai_non_pns")==1 ) { ?>
	...
	<li class="<?php echo $kepegawaian ?>">
		...
		<ul class="submenu">
			...
			<?php if ( allow("frmpegawai")==1 ) { ?>
				<li class="<?php echo $pegawai_active ?>">
					<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('pegawai') ?>">
						<i class="menu-icon fa fa-caret-right"></i>
						<?php if ($_SESSION['bahasa']==1) { echo "Staff"; } else { echo "Input Pegawai/PTK"; } ?>
					</a>
			...
			<?php if ( allow("frmpegawai_non_pns")==1 ) { ?>
...
<!--PRESENSI-->
<?php if ( allow("frmpresensi_harian_siswa")==1 || allow("frmpresensi_absen_siswa")==1 || allow("frmpresensipelajaran")==1 || allow("rpt_presensi_harian_siswa")==1 || allow("rpt_presensi_siswa_pelajaran")==1 || allow("rpt_presensi_guru_pelajaran")==1 || allow("frmpresensi_general")==1 || allow("rpt_presensi_general")==1 || allow("frmpresensi_ukbm")==1 || allow("frmsiswa_terlambat")==1 || allow("frmpresensi_piket")==1 || allow("rpt_presensi_piket")==1 || allow("rpt_presensi_ukbm")==1 || allow("rpt_absensi_harian_siswa")==1 || allow("chart_presensi")==1 ) { ?>
	...
	<li class="<?php echo $presensi ?>">
		...
		<ul class="submenu">
			...
			<?php if ( allow("frmpresensi_piket")==1 ) { ?>
			...
			<?php if ( allow("frmpresensi_absen_siswa")==1 || allow("rpt_absensi_harian_siswa")==1 ) { ?>
			...
			<?php if ( allow("rpt_presensi_piket")==1 ) { ?>
			...
			<?php if ( allow("rpt_absensi_harian_siswa")==1 ) { ?>
			...
			<?php if ( allow("rpt_presensi_ukbm")==1 ) { ?>
...
<!--ASSET-->
<?php if ( allow("frmmaterial")==1 || allow("frmitem_group")==1 || allow("frmbrand")==1 || allow("frmbuild")==1 || allow("frmasset_type")==1 || allow("frmroom")==1 || allow("frmroom_booking")==1 || allow("frmpinjam_alat")==1 ) { ?>
	...
	<li class="<?php echo $asset ?>">
		...
		<ul class="submenu">
			...
			<?php if ( allow("frmroom_booking")==1 ) { ?>
				<li class="<?php echo $room_booking_active ?>">
					<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('room_booking_filter') ?>">
						<i class="menu-icon fa fa-caret-right"></i>
						<?php if ($_SESSION['bahasa']==1) { echo "Booking Room-2"; } else { echo "Peminjaman Ruang"; } ?>
					</a>
    		...
    		<?php /*if ( allow("frmreturn_goods")==1 ) { ?>
...
<!--SURAT MENYURAT-->
<?php if ( allow("frmkelompok_surat")==1 || allow("frmsurat_keluar")==1 || allow("frmsurat_masuk")==1 || allow("frmbuku_kunjungan")==1 || allow("frmsurat_masuk_disposisi")==1 || allow("chart_surat_masuk")==1 || allow("chart_surat_keluar")==1 ) { ?>
	<li class="<?php echo $suratmenyurat ?>">
		...
		<ul class="submenu">
			...
			<?php if ( allow("frmsurat_masuk_disposisi")==1 ) { ?>
			...
			<?php if ( allow("chart_surat_masuk")==1 ) { ?>
    		...
    		<?php if ( allow("chart_surat_keluar")==1 ) { ?>
...
<!--SYSTEM MANAGER-->
<?php if ( allow("frmcompany")==1 || allow("frmusr")==1 || allow("frmsetup_periode")==1 || allow("frmsetup_periode_raport")==1 || allow("frmsetup_periode_raport_pts")==1 || allow("frmsetup_periode_raport_p5")==1 || allow("frmpresensiharian_setup")==1 ) { ?>
	...
	<li class="<?php echo $pengaturan_system ?>">
		...
		<ul class="submenu">
			<?php if ( allow("frmpresensiharian_setup")==1 ) { ?>
			...
			<?php if ( allow("frmsetup_periode_raport_p5")==1 ) { ?>
