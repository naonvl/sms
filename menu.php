...
if ( $act == obraxabrix('registrasi_list') ) {  
    $psb = "active open";
    $registrasi_list_active = "active";
}
if ( $act == obraxabrix('penempatan_gugus') ) {  
    $psb = "active open";
    $penempatan_gugus_active = "active";
}
...
if ( $act == obraxabrix('buku_kerja') || $act == obraxabrix('buku_kerja_view') ) {  
	$akademik = "active open";
	$buku_kerja_active = "active";
}
...
if ( $act == obraxabrix('deskripsi_raport_p5') || $act == obraxabrix('deskripsi_raport_p5_view')) {  
	$rapor = "active open";
	$deskripsi_raport_p5_active = "active";
}
if ( $act == obraxabrix('raport_p5') || $act == obraxabrix('raport_p5_view') || $act == obraxabrix('raport_p5_list') || $act == obraxabrix('raport_p5_update') ) {  
	$rapor = "active open";
	$raport_p5_active = "active";
}      			
...
if ( $act == obraxabrix('perpustakaan') || $act == obraxabrix('perpustakaan_view') ) {  
	...
	$perpustakaan_active = "active";
}
if ( $act == obraxabrix('kunjungan_perpustakaan') || $act == obraxabrix('kunjungan_perpustakaan_view') ) {  
	$perpustakaan = "active open";
	$kunjungan_perpustakaan_active = "active";
}
...
if ( $act == obraxabrix('pegawai_non_pns') || $act == obraxabrix('pegawai_non_pns_view') ) {  
	$kepegawaian = "active open";
	$pegawai_non_pns_active = "active";
}
if ( $act == obraxabrix('pegawai') || $act == obraxabrix('pegawai_view')) {
	$kepegawaian = "active open";
	$pegawai_active = "active";
...
/*if ( $act == obraxabrix('presensi_piket') || $act == obraxabrix('presensi_piket_view') ) {  
    $presensi = "active open";
    $presensi_piket_active = "active";
}*/
...
if ( $act == obraxabrix('rpt_presensi_harian_siswa_sps') ) {  
	$presensi = "active open";
    $rpt_presensi_harian_siswa_sps_active = "active";
}
...
if ( $act == obraxabrix('rpt_absensi_harian_siswa') || $act == obraxabrix('absensi_harian_siswa') ) {  
	$presensi = "active open";
    $rpt_absensi_harian_siswa_active = "active";
}
...
if ( $act == obraxabrix('rpt_presensi_piket') ) {  
	$presensi = "active open";
    $rpt_presensi_piket_active = "active";
}*/
if ( $act == obraxabrix('rpt_presensi_ukbm') ) {  
	$presensi = "active open";
    $rpt_presensi_ukbm_active = "active";
}
if ( $act == obraxabrix('chart_presensi') ) {  
	$presensi = "active open";
    $chart_presensi_active = "active";
}
...
##presensi guru
$presensi_guru = '';
if ( $act == obraxabrix('presensi_general_filter') || $act == obraxabrix('presensi_general') || $act == obraxabrix('presensi_general_view') ) {  
    $presensi_guru = "active open";
    $presensi_general_active = "active";
}
if ( $act == obraxabrix('presensi_piket') || $act == obraxabrix('presensi_piket_view') ) {  
    $presensi_guru = "active open";
...
if ( $act == obraxabrix('pinjam_alat_view') || $act == obraxabrix('pinjam_alat') || $act == obraxabrix('pinjam_alat_filter') ) {  
    $asset = "active open";
    $pinjam_alat_active = "active";
}
if ( $act == obraxabrix('pinjam_alat_list') ) {  
    $asset = "active open";
    $pinjam_alat_list_active = "active";
}
...
if ( $act == obraxabrix('surat_masuk_disposisi_list') || $act == obraxabrix('surat_masuk_disposisi') || $act == obraxabrix('surat_masuk_disposisi_view') ) {  
    $suratmenyurat = "active open";
    $surat_masuk_disposisi_active = "active";
}
if ( $act == obraxabrix('chart_surat_masuk') ) {  
    $suratmenyurat = "active open";
    $chart_surat_masuk_active = "active";
}
if ( $act == obraxabrix('chart_surat_keluar') ) {  
    $suratmenyurat = "active open";
    $chart_surat_keluar_active = "active";
}
...
if ( $act == obraxabrix('presensiharian_setup') || $act == obraxabrix('presensiharian_setup_view') ) {  
    $pengaturan_system = "active open";
    $presensiharian_setup_active = "active";
} 
...
if ( $act == obraxabrix('setup_periode_raport_p5') || $act == obraxabrix('setup_periode_raport_p5_view') ) {  
    $pengaturan_system = "active open";
    $setup_periode_raport_p5_active = "active";
}
//Query Execute
      ...
      ?>
                ...
                <li class="<?php echo $psb ?>">
            		...
            		<ul class="submenu">
            			...
            			<li class="<?php echo $registrasi_list_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('registrasi_list') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Registration Selection"; } else { echo "Seleksi Pendaftaran"; } ?>
            				</a>

            				<b class="arrow"></b>
            			</li>

            			<li class="<?php echo $penempatan_gugus_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('penempatan_gugus') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Group Student"; } else { echo "Penempatan Kelompok"; } ?>
            				</a>
            		...
            		<ul class="submenu">
            			...
            			<li class="<?php echo $siswa_krs_approved_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('siswa_krs_approved_view') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Study Planning Card Student Approved"; } else { echo "Generate Mapel Siswa"; } ?>
            				</a>
						...
						<li class="<?php echo $kartu_rencana_studi_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('kartu_rencana_studi') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Study Planning Card"; } else { echo "Setup Mapel Rapor"; } ?>
            				</a>
            			...
            			<li class="<?php echo $ukbm_siswa_approved_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('ukbm_siswa_approved') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Approved PAT Student"; } else { echo "Approved Modul Belajar"; } ?>
            				</a>
            			...
            			<li class="<?php echo $ukbm_siswa_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('ukbm_siswa') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "PAT Student"; } else { echo "PAT Siswa"; } ?>
            				</a>
            			...
            			<li class="<?php echo $ukbm_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('ukbm') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "PAT"; } else { echo "Modul Ajar"; } ?>
            				</a>

            				<b class="arrow"></b>
            			</li>

            			<li class="<?php echo $buku_kerja_active ?>">
            				<a href="#">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Jobs Book"; } else { echo "Buku Kerja"; } ?>
            				</a>
                ...
                <li class="<?php echo $rapor ?>">
            		...
            		<ul class="submenu">
            			...
            			<li class="<?php echo $raport_p5_active ?>">
		    				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('raport_p5_view') ?>">
		    					<i class="menu-icon fa fa-caret-right"></i>
		    					<?php if ($_SESSION['bahasa']==1) { echo "Raport P5"; } else { echo "Rapor P5"; } ?>
		    				</a>
            			...
            			<li class="<?php echo $deskripsi_raport_p5_active ?>">
		    				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('deskripsi_raport_p5_view') ?>">
		    					<i class="menu-icon fa fa-caret-right"></i>
		    					<?php if ($_SESSION['bahasa']==1) { echo "Setup Description Raport P5"; } else { echo "Setup Deskripsi Rapor P5"; } ?>
		    				</a>
                ...
                <li class="<?php echo $keuangan ?>">
            		...
            		<ul class="submenu">
            			<li class="<?php echo $registrasireg_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('registrasireg_view') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Registration Verification List"; } else { echo "Verifikasi Pendaftaran"; } ?>
            				</a>
                ...
                <li class="<?php echo $perpustakaan ?>">
            		...
            		<ul class="submenu">
            			...
            			<li class="<?php echo $kunjungan_perpustakaan_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('kunjungan_perpustakaan') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Guest Book"; } else { echo "Buku Kunjungan"; } ?>
            				</a>
                ...
                <li class="<?php echo $kepegawaian ?>">
            		...
            		<ul class="submenu">
            			...
            			<li class="<?php echo $pegawai_non_pns_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('pegawai_non_pns') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Staff Non PNS"; } else { echo "Input PTK Non PNS"; } ?>
            				</a>
                ...
                <li class="<?php echo $presensi ?>">
            		<a href="#" class="dropdown-toggle">
            			<i class="menu-icon fa fa-pencil-square-o"></i>
            			<span class="menu-text">
            				<?php if ($_SESSION['bahasa']==1) { echo "Presensi"; } else { echo "Presensi Siswa"; } ?>
            			</span>
            		...
            		<ul class="submenu">
            			...
            			<li class="<?php echo $presensi_piket_active ?>">
            				<a href="#"  onClick="JavaScript:presensi_piket()">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Presensi Piket"; } else { echo "Guru Piket"; } ?>
            				</a>
            				<b class="arrow"></b>
            			</li> -->*/ ?>
            			...
            			<li class="<?php echo $presensi_absen_siswa_active ?>">
            				...
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('presensi_absen_siswa') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            						Absensi Izin Siswa
            				</a>
            				<b class="arrow"></b>
            			...
            			<li class="<?php echo $rpt_presensi_piket_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('rpt_presensi_piket') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "General Duty Report"; } else { echo "Lap. Guru Piket"; } ?>
            				</a>
            			...
            			<li class="<?php echo $rpt_presensi_harian_siswa_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('rpt_presensi_harian_siswa') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Absensi Daily Report"; } else { echo "Lap. Presensi Harian Siswa"; } ?>
            				</a>

            				<b class="arrow"></b>
            			</li>

            			<?php if($_SESSION['loginname']=="ndf") { ?>
	            			<li class="<?php echo $rpt_presensi_harian_siswa_sps_active ?>">
	            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('rpt_presensi_harian_siswa_sps') ?>">
	            					<i class="menu-icon fa fa-caret-right"></i>
	            					<?php if ($_SESSION['bahasa']==1) { echo "Absensi Daily Report"; } else { echo "Lap. Presensi Harian Siswa Spesial"; } ?>
	            				</a>
            			...
            			<li class="<?php echo $rpt_absensi_harian_siswa_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('rpt_absensi_harian_siswa') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Abstain Daily Report"; } else { echo "Lap. Absensi Harian Siswa"; } ?>
            				</a>

            				<b class="arrow"></b>
            			</li>
            			
            			<li class="<?php echo $rpt_presensi_ukbm_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('rpt_presensi_ukbm') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            			...
            			<li class="<?php echo $chart_presensi_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('chart_presensi') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Grafik Absens"; } else { echo "Grafik Presensi"; } ?>
            				</a>
            			...
            			<li class="<?php echo $cronjob_wa_active ?>">
            				<a href="#"  onClick="JavaScript:cronjob_wa()">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Cron Job WA"; } else { echo "Cron Job WA"; } ?>
            				</a>
            				<b class="arrow"></b>
            			</li>
            	...
            	<!--PRESENSI GURU-->
                <li class="<?php echo $presensi_guru ?>">
            		<a href="#" class="dropdown-toggle">
            			<i class="menu-icon fa fa-pencil-square-o"></i>
            			<span class="menu-text">
            				<?php if ($_SESSION['bahasa']==1) { echo "Teacher Presensi"; } else { echo "Presensi Guru"; } ?>
            			</span>
            		...
            		<ul class="submenu">
            			...
            			<li class="<?php echo $presensi_general_active ?>">
            				<!-- <a href="#"  onClick="JavaScript:presensi_general()"> -->
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('presensi_general_filter') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Presensi General"; } else { echo "Presensi PPK"; } ?>
            				</a>
            				<b class="arrow"></b>
            		...
            		<ul class="submenu">
            			...
            			<li class="<?php echo $room_booking_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('room_booking_filter') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Booking Room"; } else { echo "Peminjaman Ruang"; } ?>
            				</a>

            				<b class="arrow"></b>
            			</li>

            			<li class="<?php echo $pinjam_alat_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('pinjam_alat_filter') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Booking Item"; } else { echo "Peminjaman Barang"; } ?>
            				</a>
            			...
            			<?php /*
            			<li class="<?php echo $pinjam_alat_list_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('pinjam_alat_list') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Booking Item Return"; } else { echo "Pengembalian Barang"; } ?>
            				</a>
            		...
            		<ul class="submenu">
            			...
            			<li class="<?php echo $buku_kunjungan_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('buku_kunjungan') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Guest Book"; } else { echo "Buku Kunjungan/Tamu"; } ?>
            				</a>
            			...
            			<li class="<?php echo $surat_masuk_disposisi_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('surat_masuk_disposisi_list') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Disposition Document In"; } else { echo "Disposisi Surat Masuk"; } ?>
            				</a>
            			...
            			<li class="<?php echo $chart_surat_masuk_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('chart_surat_masuk') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            			...
            			<li class="<?php echo $chart_surat_keluar_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('chart_surat_keluar') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Letter Out Graph"; } else { echo "Grafik Surat Keluar"; } ?>
            				</a>
                ...
                <li class="<?php echo $pengaturan_system ?>">
            		...
            		<ul class="submenu">
            			<li class="<?php echo $presensiharian_setup_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('presensiharian_setup') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Presensi Student Setup"; } else { echo "Seting Jam Presensi Siswa"; } ?>
            				</a>
            			...
            			<li class="<?php echo $setup_periode_raport_p5_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('setup_periode_raport_p5') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Period Raport P5 Setup"; } else { echo "Seting Titimangsa Rapor P5"; } ?>
            				</a>
            			...
            			<!--<li class="<?php echo $company_active ?>">
            				<a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('company') ?>">
            					<i class="menu-icon fa fa-caret-right"></i>
            					<?php if ($_SESSION['bahasa']==1) { echo "Company"; } else { echo "Setup Yayasan"; } ?>
            				</a>
            			...
            			<?php if($_SESSION['adm']==1) { ?>
	            			<li class="<?= $query_string_active ?>">
			                    <a href="<?php echo $nama_folder ?>/<?php echo obraxabrix('query_string') ?>">
			                        <i class="menu-icon fa fa-caret-right"></i>
			                        Execute Query
			                    </a>
			                    <b class="arrow"></b>
		                ...
		                <li class="<?= $apiwayps_active ?>">
		                    <a href="https://apiwayps.dianglobaltech.co.id/pengaturan.php" target="_blank">
								<i class="menu-icon fa fa-qrcode"></i>
								<span class="menu-text">Scan QRCode WA</span>
							</a>
							<b class="arrow"></b>
		                </li>
                ...
                <li class="<?php echo $download_upload ?>">
            		...
            		<ul class="submenu">
            			...
            			<li class="<?php echo $import_siswa_active ?>">
            			...
            			<li class="<?php echo $import_pegawai_active ?>">
            				<a href="#"  onClick="JavaScript:import_pegawai()">
            					<i class="menu-icon fa fa-caret-right"></i>
            					Upload Data Pegawai
            				</a>
            				<b class="arrow"></b>
            			...
            			<li class="<?php echo $import_item_active ?>">
            				<a href="#"  onClick="JavaScript:import_item()">
            					<i class="menu-icon fa fa-caret-right"></i>
            					Upload Data Inventaris
            				</a>
            				<b class="arrow"></b>
            			</li>

            			<li class="<?php echo $import_siswa_active ?>">
            				<a href="#"  onClick="JavaScript:import_data_siswa()">
            					<i class="menu-icon fa fa-caret-right"></i>
            					Generate Siswa
            				</a>
            				<b class="arrow"></b>
            			...
            			<?php /*
            			<li class="<?php echo $import_pustaka_active ?>">
            				<a href="#"  onClick="JavaScript:import_pustaka()">
            					<i class="menu-icon fa fa-caret-right"></i>
            					Upload Pustaka
            				</a>
            				<b class="arrow"></b>
