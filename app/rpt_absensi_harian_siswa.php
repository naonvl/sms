...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/rpt_absensi_harian_siswa_xls.php?departemen="+departemen+"&daritgl="+daritgl+"&ketgl="+ketgl+"&idtingkat="+idtingkat+"&idkelas="+idkelas+"&nama="+nama+"";
	}

	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo obraxabrix('rpt_absensi_harian_siswa') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			?>
                    ...
                    <meta http-equiv="Refresh" content="0;url=<?php echo $nama_folder . '/' . obraxabrix('rpt_absensi_harian_siswa'); ?>" />
			<?php
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="rpt_absensi_harian_siswa" id="rpt_absensi_harian_siswa" class="form-horizontal" enctype="multipart/form-data" >
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th style="font-weight:bold ">Edit | Hapus &nbsp;&nbsp;</th>
								</tr>
							</thead>
							...
							<tbody>
                                <?php			
									$i = 0;
            						$total = 0;													
									$sql=$selectview->rpt_absensi_harian_siswa($daritgl, $ketgl, $nis, $idkelas, $idtingkat, $nama, $departemen, $departemen_sekolah_id);												
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td> 
                                            <td><?php echo $rpt_presensi_harian_siswa_view->departemen ?></td>
                                            <td><?php echo $rpt_presensi_harian_siswa_view->nama_sekolah ?></td>
                                            ...
                                            <td align="center">                                            
                                                <?php if (allowupd('rpt_absensi_harian_siswa')==1) { ?>
    												<a href="<?php echo obraxabrix('absensi_harian_siswa') ?>/<?php echo $rpt_presensi_harian_siswa_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
