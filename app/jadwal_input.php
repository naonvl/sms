	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("exec/insert_jadwal.php"); 
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="client_cheque" id="client_cheque" enctype="multipart/form-data" onSubmit="return cekinput('date');" >
            	...
            	<input type="hidden" id="idjam1" name="idjam1" value="<?php echo $idjam; ?>" >
            	
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tingkat *)</label>
					<div class="col-sm-3">
						<select name="idtingkat2" id="idtingkat2" disabled="" class="chosen-select form-control" >
							<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idkelas2" id="idkelas2" disabled="" class="chosen-select form-control" >
							<option value=""></option>
				...
				<table class="table table-bordered table-condensed table-hover table-striped" style="width: auto;">
					<thead>
						<tr style="color: #168124; font-weight: bold; border: 1px solid #ccc; background-color: #e6ffea"> 
							...
							<td align="center">Kode Pelajaran</td>
							<td align="center">Pelajaran</td>
					...
					<tbody>
						...
						?>								
								...
								<tr style="background-color:ffffff;" > 
									...
									<td>
										<?php echo $row_guru_detail->kode; ?>		
									</td>
									
									<td>
										<?php echo $row_guru_detail->nama_pelajaran; ?>		
									</td>
									
									<td align="center">
										<input type="radio" id="idpelajaran" name="idpelajaran" class="ace" value="<?php echo $row_guru_detail->idpelajaran; ?>" /><span class="lbl"></span>
									</td>
