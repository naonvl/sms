<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('pegawai_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/pegawai_xls.php?bagian="+bagian+"&nip="+nip+"&nama="+nama+"&all="+all+"";	
	}
</script>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			?>
                    ...
                    <!--<meta http-equiv="Refresh" content="0;url=main.php?menu=app&act=<?php echo obraxabrix('pegawai_view') ?>" />-->
			<?php
				...
				<div class="col-xs-12">
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$sql=$selectview->list_pegawai($bagian, $nip, $nama, $all);
                                        ...
                                        <tr>
											...
											<td align="center">
                                                ...
                                                <?php if (allowupd('frmpegawai')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('pegawai') ?>/<?php echo $pegawai_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
