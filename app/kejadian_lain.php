	...
	function cekinput(fid) {  
	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='jenis') {
			alert('Jenis Kejadian tidak boleh kosong!');				
		  }
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_kejadian_lain.php");
				
				$tanggal = date("d-m-Y");
				
				if ($ref != "") {
					$sql=$select->list_kejadian_lain($ref);
					$kejadian_lain_data=$sql->fetch(PDO::FETCH_OBJ);	
					
					$tanggal = date("d-m-Y", strtotime($kejadian_lain_data->tanggal));					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="kejadian_lain2" id="kejadian_lain2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tanggal,jenis');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control">
							<option value=""></option>
							<?php select_departemen($kejadian_lain_data->departemen); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jenis Kejadian *)</label>
					<div class="col-sm-5">
						<textarea id="jenis" name="jenis" class="form-control"><?php echo $kejadian_lain_data->jenis ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<textarea id="penanganan" name="penanganan" class="form-control"><?php echo $kejadian_lain_data->penanganan ?></textarea>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmkejadian_lain')==1) { ?>
    						<?php if($ref=='') { ?>
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('kejadian_lain_view') ?>'" />
