	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_kunjungan_perpustakaan.php");
				...
				if ($ref != "") {
					$sql=$select->list_kunjungan_perpustakaan($ref);
					$kunjungan_perpustakaan_data=$sql->fetch(PDO::FETCH_OBJ);	
					
					$tanggal = date("d-m-Y", strtotime($kunjungan_perpustakaan_data->tanggal));		
					$jam     = date("H", strtotime($kunjungan_perpustakaan_data->jam));
					$menit     = date("i", strtotime($kunjungan_perpustakaan_data->jam));			
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="kunjungan_perpustakaan2" id="kunjungan_perpustakaan2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tanggal,idguru,idtingkat,idkelas');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-5">						
						<select name="idsiswa" id="idsiswa" class="chosen-select form-control" onchange="loadHTMLPost3('<?php echo $__folder ?>app/kunjungan_perpustakaan_ajax.php','tingkat_kelas_id','gettingkat_kelas','idsiswa')" >
							<option value=""></option>
							<?php select_siswa_id($kunjungan_perpustakaan_data->idsiswa) ?>
						</select>						
					</div>
				</div>
	                ...
	                <div class="form-group">
						...
						<div class="col-sm-3">
							<select name="idtingkat1" id="idtingkat1" disabled class="chosen-select form-control">
								<option value=""></option>
								<?php select_tingkat_unit("SMA", $kunjungan_perpustakaan_data->idtingkat); ?>
							</select>		
							<input type="hidden" name="idtingkat" id="idtingkat" value="<?= $kunjungan_perpustakaan_data->idtingkat ?>">		
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3" id="kelas_id">
							<select name="idkelas1" id="idkelas1" disabled class="chosen-select form-control" >
								<option value=""></option>
								<?php select_kelas($kunjungan_perpustakaan_data->idtingkat, $kunjungan_perpustakaan_data->idkelas); ?>
							</select>		
							<input type="hidden" name="idkelas" id="idkelas" value="<?= $kunjungan_perpustakaan_data->idkelas ?>">	
						</div>
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Pesan dan Kesan</label>
					<div class="col-sm-5">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $kunjungan_perpustakaan_data->keterangan ?></textarea>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmkunjungan_perpustakaan')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmkunjungan_perpustakaan')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Simpan" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frmkunjungan_perpustakaan')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('kunjungan_perpustakaan_view') ?>'" />
