...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('setup_periode_raport_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_setup_periode_raport_p5($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('setup_periode_raport_p5_view') ?>" />
			<?php
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th style="font-weight:bold ">Titimangsa &nbsp;&nbsp;</th>
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_setup_periode_raport_p5("", $idtahunajaran, $semester_id, $tingkat_id, $all);
						            while($setup_periode_raport_view=$sql->fetch(PDO::FETCH_OBJ)){
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $setup_periode_raport_view->departemen ?></td>
                                            <td><?php echo $setup_periode_raport_view->nama_sekolah ?></td>
                                            <td><?php echo $setup_periode_raport_view->tahunajaran ?></td>
											<td><?php echo $setup_periode_raport_view->semester ?></td>
											<td><?php echo $setup_periode_raport_view->tingkat ?></td>
											<td><?php echo date("d-m-Y", strtotime($setup_periode_raport_view->tanggal_ttd)) ?></td>
											<td>
												<?php if ($setup_periode_raport_view->aktif == 1) { ?>
													<button class="btn btn-xs btn-success">
														<i class="ace-icon fa fa-check bigger-120"></i>
													</button>
												<?php } ?>
											</td>
											<td><?php echo $setup_periode_raport_view->uid ?></td>
											<td><?php echo $setup_periode_raport_view->dlu ?></td>								
											<td align="center">
                                            
                                                <?php if (allowupd('frmsetup_periode_raport_p5')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('setup_periode_raport_p5') ?>/<?php echo $setup_periode_raport_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmsetup_periode_raport_p5')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $setup_periode_raport_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
