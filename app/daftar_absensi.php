	...
	function cekinput(fid) {  
		...
		for(i=0; i < arrf.length; i++) {
			if(document.getElementById(arrf[i]).value=='') {       
			  ...
			  if (document.getElementById(arrf[i]).name=='idtahunajaran2') {
...
<script type="text/javascript">
	function daftarnilai_input(idpelajaran, idtingkat, idkelas, semester_id, iddasarpenilaian, idtahunajaran) {
		window.open("app/daftarnilai_input.php?idpelajaran="+idpelajaran+"&idtingkat="+idtingkat+"&idkelas="+idkelas+"&semester_id="+semester_id+"&iddasarpenilaian="+iddasarpenilaian+"&idtahunajaran="+idtahunajaran,"Find","width=1000,height=600,left=50,top=10,toolbar=0,status=0,scroll=1,scrollbars=yes");
	}
...
<script>
	function export_excel(nis) {
		...
		window.open('<?php echo $__folder ?>app/daftar_absensi_xls.php?nis='+nis+'&semester_id='+semester_id, 'Ekspor KRS','200','200','resizable=1,scrollbars=1,status=0,toolbar=0');								
	}
	
	function daftar_absensi(pelajaran_id) {
		...
		window.open("app/daftar_absensi_mapel.php?idtingkat="+idtingkat+"&idkelas="+idkelas+"&semester_id="+semester_id+"&idtahunajaran="+idtahunajaran+"&pelajaran_id="+pelajaran_id,"Find","width=1000,height=600,left=50,top=10,toolbar=0,status=0,scroll=1,scrollbars=yes");
	}
</script>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="jadwal" id="jadwal" enctype="multipart/form-data" onSubmit="return cekinput('idtahunajaran2,idtingkat,idkelas,semester_id');" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/daftar_nilai_ajax.php','tingkat_id','gettingkat_list','departemen'), loadHTMLPost('<?php echo $__folder ?>app/daftar_nilai_ajax.php','semester_id','getsemester','departemen')" >
							<option value=""></option>
        ...
        <div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-2" id="semester_id">
	...
	<?php 
		//if( $idtingkat !="" && $idkelas !="" && $semester_id != "" && $iddasarpenilaian != "") {
			include("daftar_absensi_pelajaran.php");
		/*} else {
