								...
								<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-sm-6" id="sekolah_id">
											<select name="departemen_sekolah_id" id="departemen_sekolah_id" class="chosen-select form-control">
												<option value=""></option>
												<?php select_sekolah_unit($registrasi->departemen, $registrasi->departemen_sekolah_id); ?>
											</select>
										</div>
									</div>
