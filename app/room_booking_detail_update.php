		...
		<div class="hide">
			...
			<tr <?php if($row_registration_detail->slc==1) { ?>style="background-color:#094416; color: #ffffff" <?php } ?>> 
				...
				<td align="center">
					...
					<?php } else { ?>									
						<input type="checkbox" class="ace" id="registration_slc_<?php echo $no; ?>" name="registration_slc_<?php echo $no; ?>" onclick="checklist_update(<?php echo $no ?>)" value="1" <?php if($row_registration_detail->slc==1) echo "checked"; ?> ><span class="lbl"></span>
					<?php } ?>
				</td>
				<td align="center">
					<?php if($row_registration_detail->slc==1) { ?>
						<input type="checkbox" class="ace" id="delete_<?php echo $no; ?>" name="delete_<?php echo $no; ?>" onclick="checklist_update(<?php echo $no ?>)" value="1"><span class="lbl"></span>
					<?php } ?>
				</td>
