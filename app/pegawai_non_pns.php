	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='nip') {
			alert('NIKKI tidak boleh kosong!');				
		  }
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_pegawai_non_pns.php");
				
				if ($ref != "") {
					$sql=$select->list_pegawai_non_pns($ref);			
			...
			<form class="form-horizontal" role="form" action="" method="post" name="pegawai" id="pegawai" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('bagian,nip,nama,kelamin');" >
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="row">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<select name="jabatan_id" id="jabatan_id" class="chosen-select form-control" >
										<option value=""></option>
										<?php select_jabatan($pegawai->jabatan_id); ?>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">NIKKI *)</label>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<select name="pendidikan_terakhir_id" id="pendidikan_terakhir_id" class="chosen-select form-control" >
										<option value=""></option>
										<?php select_pendidikan($pegawai->pendidikan_terakhir_id); ?>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="jurusan" id="jurusan" class="form-control" value="<?php echo $pegawai->jurusan; ?>" >
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="tahun_lulus" id="tahun_lulus" class="form-control" value="<?php echo $pegawai->tahun_lulus; ?>" >
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Universitas/Sekolah</label>
								<div class="col-sm-6">
									<input type="text" name="universitas" id="universitas" class="form-control" value="<?php echo $pegawai->universitas; ?>" >
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Gelar Depan</label>
								<div class="col-sm-6">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Gelar Belakang</label>
								<div class="col-sm-6">
									<input type="text" name="gelar_belakang" id="gelar_belakang" class="form-control" value="<?php echo $pegawai->gelar_belakang; ?>" >
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<input type="text" name="idjenis_sertifikasi" id="idjenis_sertifikasi" class="form-control" value="<?php echo $pegawai->idjenis_sertifikasi; ?>" >
								</div>
							</div>
					...
					<div class="col-sm-6">
						<div class="row">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">TMT di SMAN</label>
								<div class="col-sm-6">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">No. SK KKI</label>
								<div class="col-sm-6">
									<input type="text" name="no_skkki" id="no_skkki" class="form-control" value="<?php echo $pegawai->no_skkki; ?>" >
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tahun SK KKI</label>
								<div class="col-sm-6">
									<input type="text" name="tahun_skkki" id="tahun_skkki" class="form-control" value="<?php echo $pegawai->tahun_skkki ?>">
								</div>
							</div>
							<?php /*
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<select name="idstatus_pegawai" id="idstatus_pegawai" class="chosen-select form-control" >
										<option value=""></option>
										<?php select_status_non_pns($pegawai->idstatus_pegawai); ?>
									</select>
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Banyak Jam di induk</label>
								<div class="col-sm-6">
									<input type="text" name="jumlah_jam_induk" id="jumlah_jam_induk" class="form-control" value="<?php echo $pegawai->jumlah_jam_induk ?>">
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Banyak Jam di non induk</label>
								<div class="col-sm-6">
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmpegawai_non_pns')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmpegawai_non_pns')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Simpan" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frmpegawai_non_pns')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('pegawai_non_pns_view') ?>'" />
                        
                        &nbsp;
                        <a href="<?php echo $__folder ?>app/pegawai_non_pns_download_format.php" target="_blank" title="Download Format Non PNS File">
							<span class="blue">
								<i class="ace-icon fa fa-cloud-download bigger-220"></i>
							</span>
						</a>          
						&nbsp;
						<a href="#"  onClick="JavaScript:import_pegawai_non_pns()" title="Upload Data Pegawai non PNS">
        					<span class="blue">
