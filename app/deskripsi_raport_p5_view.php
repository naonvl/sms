...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('deskripsi_raport_p5_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}

	function newform() {
		document.location.href = "<?php echo obraxabrix('deskripsi_raport_p5') ?>";
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_deskripsi_raport_p5($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('deskripsi_raport_p5_view') ?>" />
			<?php
				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="deskripsi_raport_p5_view" id="deskripsi_raport_p5_view" enctype="multipart/form-data" >
		            	...
		            	<div class="form-group">
							...
							<div class="col-sm-3">
								<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/raport_p5_ajax.php','sekolah_id','getsekolah_tingkat','departemen')" >
									<option value=""></option>
						...
						<div class="form-group">
							...
							<div class="col-sm-4" id="sekolah_id">
								<select name="departemen_sekolah_id" id="departemen_sekolah_id" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/raport_p5_ajax.php','tingkat_id','getkelas_tingkat_sekolah','departemen_sekolah_id')">
									<option value=""></option>
						...
						<div class="form-group">
							...
							<div class="col-sm-3" id="tingkat_id">
								<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/general_ajax.php','kelas_id','getkelas_departemen_sekolah','idtingkat')" >
									<option value=""></option>
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th style="font-weight:bold ">Tgl Update &nbsp;&nbsp;</th>
									<th>Edit/Hapus</th>
								</tr>
							</thead>
							...
							<tbody>
                                <?php			
                                	$i = 0;
            						$sql=$select->list_deskripsi_raport_p5("", $tahunajaran_id, $tingkat_id, $semester_id, $guru_id, $all, $departemen, $departemen_sekolah_id);
								...
								?>
                                        ...
                                        <tr>
											...
											<td><?php echo $deskripsi_raport_p5_view->departemen ?></td>
											<td><?php echo $deskripsi_raport_p5_view->nama_sekolah ?></td>
											...
											<td>
												<table width="100%" border="1" style="border: 1px solid #93d145;" id="detail_<?= $y?>">
													...
													<?php
														$no = 0;
														$sql2=$select->list_deskripsi_raport_p5_dimensi($deskripsi_raport_p5_view->replid); 
											...
											<td><?php echo $deskripsi_raport_p5_view->uid ?></td>
											<td><?php echo $deskripsi_raport_p5_view->dlu ?></td>
																		
											<td align="center">
                                            
                                                <?php if (allowupd('frmdeskripsi_raport_p5')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('deskripsi_raport_p5') ?>/<?php echo $deskripsi_raport_p5_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmdeskripsi_raport_p5')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $deskripsi_raport_p5_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
