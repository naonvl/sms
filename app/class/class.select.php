...
class select{	
	...
	//-----------user departemen(saat update)
	function list_usr_departemen($id) {
		$dbpdo = DB::create();
		...
		$sqlstr = "select aa.* from (select a.id, a.departemen_id, a.departemen_sekolah_id, b.departemen, c.nama nama_sekolah, 1 mslc, 1 old from usr_departemen a left join departemen b on a.departemen_id=b.replid left join departemen_sekolah c on a.departemen_sekolah_id=c.replid where a.usrid='$data->usrid' union all
		select 0 id, a.departemen_id, a.replid departemen_sekolah_id, b.departemen, a.nama nama_sekolah, 0 mslc, 0 old from departemen_sekolah a left join departemen b on a.departemen_id=b.replid where a.replid not in (select departemen_sekolah_id from usr_departemen where usrid='$data->usrid' )) aa order by aa.id desc, aa.departemen, aa.nama_sekolah ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data registrasi
	function list_registrasi($ref='', $replid='', $token=''){
		$dbpdo = DB::create();
	...
	//---------get data registrasi
	function list_registrasi_verif($ref='', $replid='', $token='', $verifikasi=''){
		$dbpdo = DB::create();
		...
		if ($verifikasi == 1) {
			if ($where == "") {
				$where = " where a.verifikasi = 1 ";
			} else {
				$where = $where . " and a.verifikasi = 1 ";
			}
		}

		if ($verifikasi == 2) {
			if ($where == "") {
				$where = " where ifnull(a.verifikasi,0) = 0 ";
			} else {
				$where = $where . " and ifnull(a.verifikasi,0) = 0 ";
			}
		}
		
		$sqlstr	=	"select a.replid, a.departemen, a.idproses, a.idkelompok, a.tanggal, a.nopendaftaran, a.idtingkat, a.idjurusan, a.idminat, a.idminat1, a.foto_file, a.nama, a.panggilan, a.kelamin, a.nisn, a.nis, a.noijazah, a.tahunijazah, a.skhun, a.tahunskhun, a.noujian, a.nik, a.tmplahir, a.tgllahir, a.agama, a.kebutuhan_khusus_chk, a.kebutuhan_khusus, a.tahunmasuk, a.alamatsiswa, a.dusun, a.rt, a.rw, a.kelurahan, a.kodepossiswa, a.kecamatan, a.kabupaten, a.provinsi, a.transportasi, a.transportasi_kode, a.citacita, a.citacita_lain, a.idjenis_tinggal, a.jenis_tinggal, a.telponsiswa, a.hpsiswa, a.emailsiswa, a.kps, a.nokps, a.nokip, a.nokks, a.namaayah, a.tahunayah, a.alamatortu, a.kodeposortu, a.hportu, a.butuhkhususayah, a.butuhkhususketayah, a.pekerjaanayah, a.pekerjaanayah_lain, a.pendidikanayah, a.penghasilanayah, a.penghasilanayah_kode, a.namaibu, a.tahunibu, a.butuhkhususibu, a.butuhkhususketibu, a.pekerjaanibu, a.pekerjaanibu_lain, a.pendidikanibu, a.penghasilanibu, a.penghasilanibu_kode, a.wali, a.tahunwali, a.pekerjaanwali, a.pekerjaanwali_lain, a.pendidikanwali, a.penghasilanwali, a.tinggi, a.berat, a.jaraksekolah, a.jarak_km, a.waktutempuh, a.waktutempuh_menit, a.jsaudara, a.uid, a.dlu, a.darah, a.file_darah, a.almayah, a.almibu, a.alamatibu, a.kodeposibu, a.hpibu, a.info3, a.departemen_sekolah_id, ifnull(a.verifikasi,0) verifikasi, b.dcr jalur_masuk from calonsiswa a left join 	
		(select '1' cde, 'Akademik' dcr, 0 nmr union all 
		select '2' cde, 'Non Akademik' dcr, 1 nmr union all
	...
	//---------get departemen_sekolah
	function list_departemen_sekolah($departemen_id=''){
		$dbpdo = DB::create();
		
		$where = " where a.departemen_id = '$departemen_id' ";

		$sqlstr	=	"select a.replid, a.departemen_id, a.nama, a.nipkepsek, a.alamat, a.kuota, a.tanggal_awal, a.tanggal_akhir, a.link_registrasi, a.biaya, a.bank, a.no_rekening, a.nama_pemilik, b.nama kepalasekolah from departemen_sekolah a left join pegawai b on a.nipkepsek=b.nip " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get departemen_sekolah
	function get_departemen_sekolah($replid=''){
		$dbpdo = DB::create();
		
		$where = " where a.replid = '$replid' ";

		$sqlstr	=	"select a.replid, a.departemen_id, a.nama, a.nipkepsek, a.alamat, a.kuota, a.tanggal_awal, a.tanggal_akhir, a.biaya, a.bank, a.no_rekening, a.nama_pemilik, b.nama kepalasekolah, c.departemen from departemen_sekolah a left join pegawai b on a.nipkepsek=b.nip left join departemen c on a.departemen_id=c.replid " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data tingkat
	function list_tingkat($replid='', $departemen='', $all='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if ($departemen_sekolah_id != "") {
			if ($where == "") {
				$where = " where a.departemen_sekolah_id = '$departemen_sekolah_id' ";
			} else {
				$where = $where . " and a.departemen_sekolah_id = '$departemen_sekolah_id' ";
			}
		}

		if($_SESSION["adm"] == 0) {
			$uid	=	$_SESSION["loginname"];
			##jika selain siswa ksh hak akses unit (banyak sekolah)
			if ($where == "") {
				$where = " where a.departemen_sekolah_id in (select departemen_sekolah_id from usr_departemen where usrid='$uid') ";
			} else {
				$where = $where . " and a.departemen_sekolah_id in (select departemen_sekolah_id from usr_departemen where usrid='$uid') ";
			}		
		}
		...
		$sqlstr	=	"select a.replid, a.tingkat, a.departemen, a.departemen_sekolah_id, a.aktif, a.keterangan, a.urutan, a.tanggal_ttd, a.ts, b.nama nama_sekolah from tingkat a left join departemen_sekolah b on a.departemen_sekolah_id=b.replid " . $where . " order by a.replid ";	
	...
	//---------get data kelas
	function list_kelas($replid='', $idtingkat='', $nipwali='', $departemen='', $all='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select a.replid, a.idtahunajaran, a.departemen_sekolah_id, a.idtingkat, a.kelas, a.kapasitas, a.nipwali, a.aktif, a.keterangan, a.ttd_file_hd, a.ts, b.tingkat, b.departemen, c.tahunajaran, d.replid idwali, d.nama walikelas, e.nama nama_sekolah from kelas a left join tingkat b on a.idtingkat=b.replid left join tahunajaran c on a.idtahunajaran=c.replid left join pegawai d on a.nipwali=d.nip left join departemen_sekolah e on a.departemen_sekolah_id=e.replid " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function list_tahunajaran($replid='', $departemen='', $all=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select a.replid, a.tahunajaran, a.departemen, a.tglmulai, a.tglakhir, a.aktif, a.info1, a.info2, a.info3 ttd_file, a.keterangan, a.ts, b.nama nama_kepsek from tahunajaran a left join pegawai b on a.info1=b.nip " . $where . " order by a.replid ";	
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function list_pustaka($replid=''){
		...
		$sqlstr	=	"select a.replid, a.judul, a.abstraksi, a.keyword, a.tahun, a.keteranganfisik, a.penulis, a.penerbit, a.format, a.katalog, a.photo, a.file_ebook, a.keterangan, a.harga, a.info1, a.info2, a.info3, a.departemen, a.tanggal_masuk, a.keterangan_pustaka, a.ts, b.nama namapenulis, c.nama namapenerbit from pustaka a left join penulis b on a.penulis=b.replid left join penerbit c on a.penerbit=c.replid " . $where . " order by a.replid ";	
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function list_pegawai($replid='', $bagian='', $nip='', $nama='', $all=''){
		...
		$where = " where ifnull(a.info1,0)=0 ";
		...
		if($all == 1) {
			$where = " where a.replid=0 and ifnull(a.info1,0)=0";
		}
		
		$sqlstr	= "select a.replid, a.nip, a.nrk, a.nama, a.panggilan, a.kelamin, a.gelar, a.gelar_belakang, a.tmplahir, a.tgllahir, a.agama, a.suku, a.jabatan_id, a.pangkat_id, a.nikah, a.jenis_id, a.pendidikan_terakhir_id, a.jurusan, a.tahun_lulus, a.universitas, a.noid, a.alamat, a.telpon, a.handphone, a.email, a.karpeg, a.no_sertifikasi, a.idjenis_sertifikasi, a.npwp, a.nuptk, a.tmt_cpns, a.unit_cpns, a.no_sk_masuk, a.idstatus_pegawai, a.nik, a.nama_ibu, a.nama_pasangan, a.tempat_lahir_pasangan, a.tanggal_lahir_pasangan, a.tanggal_nikah, a.tempat_nikah, a.pekerjaan_pasangan, a.instansi_pasangan, a.nip_pasangan, a.keluarga_tanggungan, a.usia, a.ajar_lain, a.jumlah_jam_induk, a.jumlah_jam_ajar_lain, a.nama_bank, a.unit_bank, a.no_rek, a.nama_pemilik, a.desa, a.kecamatan, a.kode_pos, a.tanggal_pensiun, a.foto_file, a.bagian, b.bagian nama_bagian, a.keterangan, a.no_sk_tetap, a.tanggal_sk_tetap, a.ts, c.nama status_pegawai, d.nama jabatan, e.nama pangkat, f.pendidikan pendidikan_terakhir from pegawai a left join bagianpegawai b on a.bagian=b.replid left join status_pegawai c on a.idstatus_pegawai=c.replid left join jabatan d on a.jabatan_id=d.replid left join pangkat e on a.pangkat_id=e.replid left join tingkatpendidikan f on a.pendidikan_terakhir_id=f.replid " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data pegawai
	function list_pegawai_non_pns($replid='', $bagian='', $nip='', $nama='', $all=''){
		$dbpdo = DB::create();
		
		$where = " where ifnull(a.info1,0)=1 ";
		...
		$sqlstr	= "select a.replid, a.nip, a.nama, a.panggilan, a.kelamin, a.gelar, a.gelar_belakang, a.tmplahir, a.tgllahir, a.agama, a.suku, a.nikah, a.jenis_id, a.noid, a.alamat, a.telpon, a.handphone, a.email, a.karpeg, a.no_sertifikasi, a.idjenis_sertifikasi, a.pendidikan_terakhir_id, a.jurusan, a.tahun_lulus, a.universitas, a.npwp, a.nuptk, a.tmt_cpns, a.unit_cpns, a.no_sk_masuk, a.idstatus_pegawai, a.no_skkki, a.tahun_skkki, a.nik, a.nama_ibu, a.nama_pasangan, a.tempat_lahir_pasangan, a.tanggal_lahir_pasangan, a.tanggal_nikah, a.tempat_nikah, a.pekerjaan_pasangan, a.instansi_pasangan, a.nip_pasangan, a.keluarga_tanggungan, a.usia, a.ajar_lain, a.jumlah_jam_induk, a.jumlah_jam_ajar_lain, a.nama_bank, a.unit_bank, a.no_rek, a.nama_pemilik, a.desa, a.kecamatan, a.kode_pos, a.tanggal_pensiun, a.foto_file, a.bagian, a.jabatan_id, b.bagian nama_bagian, a.keterangan, a.no_sk_tetap, a.tanggal_sk_tetap, a.ts, f.pendidikan pendidikan_terakhir from pegawai a left join bagianpegawai b on a.bagian=b.replid left join tingkatpendidikan f on a.pendidikan_terakhir_id=f.replid " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data pelajaran
	function list_pelajaran($replid='', $sifat='', $all='', $merdeka='', $departemen='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if ($merdeka == 1) {
			if ($where == "") {
				$where = " where a.merdeka = 1 ";
			} else {
				$where = $where . " and a.merdeka = 1 ";
			}
		}
		...
		$sqlstr	=	"select a.replid, a.kode, a.nama, a.departemen, a.departemen_sekolah_id, a.sifat, a.ekstra_sifat, a.pegawai_id, a.aktif, a.keterangan, a.info1, a.info2, a.info3, a.alias, a.idpelajaran_alias, a.minat, a.bentrok, a.merdeka, b.nama nama_alias, a.token, a.ts, c.nama nama_sekolah from pelajaran a left join pelajaran b on a.idpelajaran_alias=b.replid left join departemen_sekolah c on a.departemen_sekolah_id=c.replid " . $where . " order by a.replid ";	
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data semester
	function list_semester($ref='', $departemen='', $all=''){
		$dbpdo = DB::create();
	...
	//---------get data rpp
	function list_rpp($ref='', $idtingkat='', $idpelajaran='', $all='', $departemen=''){
		$dbpdo = DB::create();
	...
	function list_dasarpenilaian($ref='', $departemen='', $all=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select a.replid, a.departemen, a.dasarpenilaian, a.keterangan, a.ts from dasarpenilaian a " . $where . " order by a.replid ";
	...
	//---------get data kompetensi
	function list_kompetensi($ref='', $departemen='', $all=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select a.replid, a.departemen, a.kode, a.kompetensi, a.aktif, a.dlu from kompetensi a " . $where . " order by a.replid ";
	...
	//---------get data KRS
	function list_kartu_rencana_studi($replid='', $kelompok_pelajaran_id='', $tingkat_id='', $semester_id='', $peminatan='', $idtahunajaran='', $idminat='', $pelajaran_id='', $departemen=''){
		$dbpdo = DB::create();
	...
	//---------get data jam
	function list_jam($id='', $hari='', $all='', $departemen=''){
		$dbpdo = DB::create();
	...
	function list_pemetaan_kd($ref ='', $idtingkat='', $idpelajaran='', $kd='', $all='', $departemen=''){	 
		$dbpdo = DB::create();
	...
	function list_pemetaan_kd_siswa($ref ='', $idsiswa='', $idpelajaran='', $all='', $departemen=''){	 
		$dbpdo = DB::create();
	...
	function list_presensi_ukbm($id='', $all='', $departemen='', $departemen_sekolah_id=''){	 
		$dbpdo = DB::create();
		...
		if($departemen_sekolah_id != "") {
			if ($where == "") {
				$where = " where b.departemen_sekolah_id = '$departemen_sekolah_id' ";
			} else {
				$where = $where . " and b.departemen_sekolah_id = '$departemen_sekolah_id' ";
			}	
		}
		...
		if($_SESSION["adm"] == 0) {
			...
			##jika selain siswa ksh hak akses unit (banyak sekolah)
			if ($where == "") {
				$where = " where c.departemen_sekolah_id in (select departemen_sekolah_id from usr_departemen where usrid='$uid') ";
			} else {
				$where = $where . " and c.departemen_sekolah_id in (select departemen_sekolah_id from usr_departemen where usrid='$uid') ";
			}		
		}
		...
		$sqlstr="select a.replid, a.tanggal, a.idtingkat, a.idkelas, a.idsiswa, a.idpelajaran, a.idguru, a.idsemester, a.idukbm, a.hadir, a.dispensasi, a.sakit, a.izin, a.alpa, a.uid, a.dlu, a.ref, b.departemen, b.departemen_sekolah_id, c.nama nama_sekolah from presensi_ukbm a left join siswa b on a.idsiswa=b.replid left join departemen_sekolah c on b.departemen_sekolah_id=c.replid " . $where . " order by a.ref";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function list_presensi_ukbm_view($id='', $all='', $tingkat='', $kelas='', $tanggal='', $idguru=''){	 
		...
		$sqlstr="select distinct a.ref, a.tanggal, a.idpelajaran, a.idguru, a.idsemester, a.idukbm, b.kelas, c.tingkat, d.semester, e.nama nama_guru, f.nama pelajaran, g.kode, g.deskripsi ukbm from presensi_ukbm a left join kelas b on a.idkelas=b.replid left join tingkat c on a.idtingkat=c.replid left join semester d on a.idsemester=d.replid left join pegawai e on a.idguru=e.replid left join pelajaran f on a.idpelajaran=f.replid left join ukbm g on a.idukbm=g.replid  " . $where . " order by a.tanggal desc";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function list_buku_kunjungan($kode ='', $from_date='', $to_date='', $all=''){	 
		...
		$sqlstr="select a.ref, a.tanggal, a.nama, a.instansi, a.telepon, a.ttd, a.keperluan, a.kesan_pesan, a.keterangan, a.uid, a.dlu from buku_kunjungan a " . $where . " order by a.ref";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function list_item($kode ='', $all=0, $active='', $code='', $old_code='', $name='', $item_group_id='', $from_date='', $to_date=''){
		...
		$sqlstr="select a.code, a.old_code, a.name, a.item_group_id, b.name item_group_name, a.item_subgroup_id, a.item_type_code, a.item_category_id, a.brand_id, a.size_id, a.uom_code_stock, a.uom_code_sales, a.uom_code_purchase, a.minimum_stock, a.maximum_stock, a.photo, a.consigned, a.balance, a.item_booking, a.active, a.uid, a.dlu, a.syscode from item a left join item_group b on a.item_group_id=b.id " . $where . " order by a.code";
		//echo $sqlstr;
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function list_room_booking($ref ='', $from_date='', $to_date='', $all=0, $year=''){	 
		...
		$sqlstr="select a.ref, a.date, a.name, a.identity_type_id, a.identity_no, a.email, a.phone, a.address, a.booking, a.booked_finish, a.booked, a.checkout_uid, a.arriving, a.sex, a.checkout, a.checkout_date, a.memo, a.uid, a.dlu from room_registration a " . $where . " order by a.date desc, a.ref";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function list_siswa_terlambat($ref='', $tanggal='', $tanggal1='', $idsiswa='', $idtingkat='', $idkelas='', $all=''){
		$dbpdo = DB::create();
		...
		if ($tanggal1 != "") {
			...
			if ($where == "") {
				$where = " where a.tanggal <= '$tanggal1' ";
			} else {
				$where = $where . " and a.tanggal <= '$tanggal1' ";
			}
		}
		...
		$sqlstr	=	"select a.replid, a.tanggal, a.jam, a.idsiswa, a.idtingkat, a.idkelas, a.alasan, a.penanganan, a.uid, a.dlu, b.nis, b.nama nama_siswa, c.tingkat, d.kelas from siswa_terlambat a left join siswa b on a.idsiswa=b.replid left join tingkat c on a.idtingkat=c.replid left join kelas d on a.idkelas=d.replid " . $where . " order by a.tanggal desc, a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data siswa izin
	function list_siswa_izin($ref='', $tanggal='', $idsiswa='', $idtingkat='', $idkelas='', $all='', $departemen=''){
		$dbpdo = DB::create();
	...
	function list_kejadian_lain($ref='', $tanggal='', $all='', $departemen=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select a.replid, a.departemen, a.tanggal, a.jenis, a.penanganan, a.uid, a.dlu from kejadian_lain a " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data guru_bk
	function list_guru_bk($ref='', $idtahunajaran='', $idguru='', $aktif='', $all='', $departemen=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select a.replid, a.departemen, a.idtahunajaran, a.idguru, a.aktif, a.uid, a.dlu, b.nip, b.nama nama_guru, c.tahunajaran from guru_bk a left join pegawai b on a.idguru=b.replid left join tahunajaran c on a.idtahunajaran=c.replid " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function list_guru_penugasan($ref='', $idtahunajaran='', $idguru='', $idtingkat='', $idkelas='', $aktif='', $all='', $departemen=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select distinct a.idtahunajaran, a.departemen, a.idguru, a.aktif, c.nip, c.nama nama_guru, d.tahunajaran from guru_penugasan a left join guru b on a.idguru=b.replid left join pegawai c on b.nip=c.replid left join tahunajaran d on a.idtahunajaran=d.replid " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data gugus
	function list_gugus($replid='', $departemen='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if($_SESSION["adm"] == 0) {
			$uid	=	$_SESSION["loginname"];
			##hak askes user per unit dan sekolah
			if ($where == "") {
				$where = " where a.departemen_sekolah_id in (select departemen_sekolah_id from usr_departemen where usrid='$uid') ";
			} else {
				$where = $where . " and a.departemen_sekolah_id in (select departemen_sekolah_id from usr_departemen where usrid='$uid') ";
		...
		$sqlstr	=	"select a.replid, a.gugus, a.departemen, a.kapasitas, a.kapasitas_l, a.kapasitas_p, a.uid, a.dlu from gugus a " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data KRS
	function get_kartu_rencana_studi_absensi($replid='', $kelompok_pelajaran_id='', $tingkat_id='', $semester_id='', $peminatan='', $idtahunajaran='', $idminat='', $departemen=''){
		$dbpdo = DB::create();
		...
		if($idminat == 1) { //MIPA
			$sqlstr	=	"select a.replid, a.peminatan, a.tingkat_id, a.kelompok_pelajaran_id, a.pelajaran_kode, a.pelajaran_id, a.semester_id, a.sks, a.idtahunajaran, a.urutan, a.uid, a.dlu, f.tahunajaran nama_tahunajaran, b.tingkat, b.departemen, c.nama nama_pelajaran, c.kode, d.semester, e.dcr kelompok_pelajaran from kartu_rencana_studi a left join tingkat b on a.tingkat_id=b.replid left join pelajaran c on a.pelajaran_id=c.replid left join semester d on a.semester_id=d.replid left join (select '1' cde, 'Kelompok A' dcr, 0 nmr union all 
		select '2' cde, 'Kelompok B' dcr, 1 nmr union all 
		select '3' cde, 'Kelompok Peminatan MIPA' dcr, 2 nmr union all 
		select '4' cde, 'Lintas Peminatan' dcr, 3 nmr) e on a.kelompok_pelajaran_id=e.cde left join tahunajaran f on a.idtahunajaran=f.replid " . $where . " order by a.kelompok_pelajaran_id, a.urutan, a.replid";
	...
	//---------get data receipt
	function list_receipt($kode ='', $from_date='', $to_date='', $client_code='', $all=0, $departemen='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if($_SESSION["adm"] == 0) {
			...
			##jika selain siswa ksh hak akses unit (banyak sekolah)
			if ($where == "") {
				$where = " where b.departemen_sekolah_id in (select departemen_sekolah_id from usr_departemen where usrid='$uid') ";
			} else {
				$where = $where . " and b.departemen_sekolah_id in (select departemen_sekolah_id from usr_departemen where usrid='$uid') ";
			}		
		}
	...
	function list_receipt_detail($id) {
		...
		$sqlstr="select a.ref, a.invoice_no, a.invoice_date, a.invoice_due_date, a.invoice_currency_code, a.departemen, a.departemen_sekolah_id, a.invoice_rate, a.amount_due, a.discount, a.amount_paid, a.ref_type invoice_type, a.amount, a.line, b.description from receipt_detail a left join ar b on a.invoice_no=b.ref where a.ref='$id' order by a.line ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
...
*/				
	...
	//---------get data siswa terlambat
	function get_siswa_terlambat($ref='', $tanggal='', $tanggal1='', $idsiswa='', $idtingkat='', $idkelas='', $all=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select distinct a.idsiswa, a.idtingkat, a.idkelas, b.nis, b.nama nama_siswa, c.tingkat, d.kelas from siswa_terlambat a left join siswa b on a.idsiswa=b.replid left join tingkat c on a.idtingkat=c.replid left join kelas d on a.idkelas=d.replid " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data siswa terlambat
	function list_kunjungan_perpustakaan($ref='', $tanggal='', $tanggal1='', $idsiswa='', $idtingkat='', $idkelas='', $all=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select a.replid, a.tanggal, a.jam, a.idsiswa, a.idtingkat, a.idkelas, a.keterangan, a.uid, a.dlu, b.nis, b.nama nama_siswa, c.tingkat, d.kelas from kunjungan_perpustakaan a left join siswa b on a.idsiswa=b.replid left join tingkat c on a.idtingkat=c.replid left join kelas d on a.idkelas=d.replid " . $where . " order by a.tanggal desc, a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data kunjungan_perpustakaan
	function get_kunjungan_perpustakaan($ref='', $tanggal='', $tanggal1='', $idsiswa='', $idtingkat='', $idkelas='', $all=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select distinct a.idsiswa, a.idtingkat, a.idkelas, b.nis, b.nama nama_siswa, c.tingkat, d.kelas from kunjungan_perpustakaan a left join siswa b on a.idsiswa=b.replid left join tingkat c on a.idtingkat=c.replid left join kelas d on a.idkelas=d.replid " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data usr_registration
	function list_usr_registration($ref=''){	
		$dbpdo = DB::create();
	 	...
	 	if ($ref == "") {
			...
			$sqlstr="select a.id, a.usrid, a.pwd, a.adm, b.pwd pwdori, a.idpegawai, '' name, '' institution, '' mobile, '' email, '' usrgrpid, a.photo, a.act, a.uid, a.dlu from usr a left join usr_bup b on a.usrid=b.usrid " . $where . " order by a.usrid";
			$sql=$dbpdo->prepare($sqlstr);
			$sql->execute();
		} else {
			$sqlstr="select a.id, a.usrid, a.pwd, b.pwd pwdori, a.adm, a.idpegawai, '' name, '' institution, '' mobile, '' email, '' usrgrpid, a.photo, a.act, a.uid, a.dlu from usr a left join usr_bup b on a.usrid=b.usrid where a.usrid='$ref' order by a.usrid";
			$sql=$dbpdo->prepare($sqlstr);
			$sql->execute();
		}
	...
	//-----------get item lab.
	function get_item_lab($submit='', $lab_code='') {
		$dbpdo = DB::create();
		
		$where = " where a.item_booking=1  ";
		
		if($submit == '') {
			//$where = " where a.ref='' ";
		}
		
		$sqlstr="select a.syscode item_code, a.old_code, a.name item_name, a.item_booking, a.photo, b.name item_group_name from item a left join item_group b on a.item_group_id=b.id ". $where . " order by a.name";

		//$sqlstr = "select 'A-1111' old_code, 'Proyektor' item_name, 'ID-999888' identity_no ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//-----------loan goods cek ready
	function get_loan_goods_ready($item_code, $submit='', $booked='', $book_finish='') {
		$dbpdo = DB::create();
		
		$where = ""; //where ifnull(b.checkout,0) = 0
		...
		if($submit == "") {
			$where = ""; //where ifnull(b.checkout,0) = 0 "; //and b.ref = '' ";
		}*/
		
		//$sqlstr="select a.item_code from loan_goods_detail a left join loan_goods b on a.ref=b.ref " . $where . " order by a.item_code limit 1";
		$sqlstr="select '' item_code";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get surat masuk
	function get_surat_masuk_outstanding($kode ='', $from_date='', $to_date='', $idkelompok='', $all=''){	 
		$dbpdo = DB::create();
			
		$where = " where a.ref not in (select ref from surat_masuk_disposisi) ";
	...
	//-----------
	function list_surat_masuk_disposisi_detail($ref) {
		$dbpdo = DB::create();
		

		$sqlstr = "select aa.* from (select a.ref, a.disposisi_id, a.nama_disposisi, a.instruksi, b.nama, a.line, 1 old from surat_masuk_disposisi a left join disposisi_surat b on a.disposisi_id=b.id where a.ref='$ref' union all
		select '' ref, id disposisi_id, '' nama_disposisi, '' instruksi, nama, 0 line, 0 old from disposisi_surat where id not in (select disposisi_id from surat_masuk_disposisi where ref='$ref' )) aa order by aa.line desc, aa.nama";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get surat masuk
	function list_surat_masuk_disposisi($kode ='', $from_date='', $to_date='', $idkelompok='', $all=''){	 
		$dbpdo = DB::create();
			
		$where = " where a.ref in (select ref from surat_masuk_disposisi) ";
	...
	//---------get booking loan goods
	function list_pinjam_alat($ref ='', $from_date='', $to_date='', $all=0, $year=''){	 
		...
		$sqlstr="select a.ref, a.date, a.date_return, a.receiver, a.status, a.employee_id, a.booking, a.booked, a.booked_finish, a.need, a.memo, a.uid, a.dlu from goods_loan a " . $where . " order by a.booked desc, a.ref";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//-----------list_pinjam_alat_detail
	function list_pinjam_alat_detail($kode='', $status='') {
		$dbpdo = DB::create();
		...
		$sqlstr="select a.ref, a.item_code, a.uom_code, a.qty, a.ref_pos, a.status, a.line, b.code item_code2, b.name item_name, c.name item_group_name from goods_loan_detail a left join item b on a.item_code=b.syscode left join item_group c on b.item_group_id=c.id " . $where . " order by a.line " . $limit;
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data leger_nilai
	function list_leger_nilai($nis='', $tahun_pelajaran='', $semester='', $tingkat='', $kelas=''){
		$dbpdo = DB::create();
		...
		if ($tahun_pelajaran != "") {
			if ($where == "") {
				$where = " where a.tahun_pelajaran = '$tahun_pelajaran' ";
			} else {
				$where = $where . " and a.tahun_pelajaran = '$tahun_pelajaran' ";
			}
		}
		...
		if ($semester != "") {
			/*$m_semester = "";
			$m_tingkat = "";
			$count_semester = explode(",", $semester);
			for($x=0; $x<=count($count_semester); $x++) {
				...
				if($count_semester[$x] == 1) {
					if($m_semester == "") {
						...
						$m_semester = $m_semester.",'Ganjil'";
						$m_tingkat = $m_tingkat.",'X'";
					}
				}
		...
		if ($tingkat != "") {
			if ($where == "") {
				$where = " where a.tingkat = '$tingkat' ";
			} else {
				$where = $where . " and a.tingkat = '$tingkat' ";
			}
		}

		/*if ($kelas != "") {
			if ($where == "") {
				$where = " where a.kelas = '$kelas' ";
			} else {
				$where = $where . " and a.kelas = '$kelas' ";
			}
		}*/

		if ($kelas != "") {
			if ($where == "") {
				$where = " where a.nis in (select distinct nis from leger_nilai where kelas='$kelas') ";
			} else {
				$where = $where . " and a.nis in (select distinct nis from leger_nilai where kelas='$kelas') ";
			}
		}
		
		$sqlstr	=	"select a.nis, a.nama, a.tahun_pelajaran, a.minat, a.tingkat, a.kelas, a.agama_p, a.agama_char, a.agama_k, a.pakr_p, a.pakr_char, a.pakr_k, a.hindu_p, a.hindu_char, a.hindu_k, a.budha_p, a.budha_char, a.budha_k, a.ppkn_p, a.ppkn_char, a.ppkn_k, a.ind_p, a.ind_char, a.ind_k, a.ing_p, a.ing_char, a.ing_k, a.mat_wjb_p, a.mat_wjb_char, a.mat_wjb_k, a.sej_wjb_p, a.sej_wjb_char, a.sej_wjb_k, a.penjas_p, a.penjas_char, a.penjas_k, a.pkwu_p, a.pkwu_char, a.pkwu_k, a.senbud_p, a.senbud_char, a.senbud_k, a.mat_pm_p, a.mat_pm_char, a.mat_pm_k, a.bio_p, a.bio_char, a.bio_k, a.fis_p, a.fis_char, a.fis_k, a.kim_p, a.kim_char, a.kim_k, a.jerman_p, a.jerman_char, a.jerman_k, a.p5_p, a.p5_char, a.p5_k, a.bk_p, a.bk_char, a.bk_k, a.mat_l_p, a.mat_l_char, a.mat_l_k, a.lintas_minat_p, a.lintas_minat_char, a.lintas_minat_k, a.rata_p, a.rata_k, a.rank_kelas, a.rank_paralel, a.kls, a.prl from leger_nilai a " . $where . " order by a.nama ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data rpt_absensi_harian_siswa
	function list_absensi_harian_siswa($replid='', $daritgl='', $ketgl='', $nis='', $kelas='', $idtingkat='', $nama='', $departemen=''){
		$dbpdo = DB::create();
		
		$where = " where ifnull(a.hadir,0)=0 ";
	...
	//---------get data pegawai
	function get_presensi_general($replid='', $all=''){
		$dbpdo = DB::create();
		...
		$sqlstr	=	"select a.replid, a.nip, a.nama from pegawai a " . $where . " order by a.nama ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data presensi general
	function list_presensi_general_view($id='', $tanggal='', $to_tanggal='', $all=''){	 
		$dbpdo = DB::create();
			
		$where = " where ifnull(a.hadir,0)=1 ";
		$where1 = " where (ifnull(a.ijin,0)=1 or ifnull(a.sakit,0)=1 or ifnull(a.alpa,0)=1 or ifnull(a.cuti,0)=1) ";
		...
		if ( $id != "") {
			...
			//----------
			if ($where1 == "") {
				$where1 = " where a.replid = '$id' ";
			} else {
				$where1 = $where1 . " and a.replid = '$id' ";
			}
		...
		if ( $tanggal != "") {
			...
			//------------
			if ($where1 == "") {
				$where1 = " where date_format(a.tanggal,'%Y-%m-%d') >= '$tanggal' ";
			} else {
				$where1 = $where1 . " and date_format(a.tanggal,'%Y-%m-%d') >= '$tanggal' ";
			}								
		}

		if ( $to_tanggal != "") {
			
			$to_tanggal = date("Y-m-d", strtotime($to_tanggal));
			
			if ($where == "") {
				$where = " where date_format(a.tanggal,'%Y-%m-%d') <= '$to_tanggal' ";
			} else {
				$where = $where . " and date_format(a.tanggal,'%Y-%m-%d') <= '$to_tanggal' ";
			}
			//----------
			if ($where1 == "") {
				$where1 = " where date_format(a.tanggal,'%Y-%m-%d') <= '$to_tanggal' ";
			} else {
				$where1 = $where1 . " and date_format(a.tanggal,'%Y-%m-%d') <= '$to_tanggal' ";
			}								
		}
		...
		$sqlstr="select sum(aa.absen) absen, sum(aa.hadir) hadir, aa.tanggal from (
				select 0 absen, count(a.replid) hadir, date_format(a.tanggal,'%d-%m-%Y') tanggal from presensi_general a " . $where . " group by date_format(a.tanggal,'%Y-%m-%d')
				union all
				select count(a.replid) absen, 0 hadir, date_format(a.tanggal,'%d-%m-%Y') tanggal from presensi_general a " . $where1 . " group by date_format(a.tanggal,'%Y-%m-%d') ) aa group by aa.tanggal order by aa.tanggal desc";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data presensi general
	function list_presensi_general_detail($tanggal='', $idpegawai=''){
		$dbpdo = DB::create();
		...
		if ($tanggal != "") {
			...
			if ($where == "") {
				$where = " where date_format(d.tanggal,'%Y-%m-%d') = '$tanggal' ";
			} else {
				$where = $where . " and date_format(d.tanggal,'%Y-%m-%d') = '$tanggal' ";
			}
		}
		...
		if ($idpegawai != "") {
			...
			if ($where == "") {
				$where = " where a.replid = '$idpegawai' ";
			} else {
				$where = $where . " and a.replid = '$idpegawai' ";
			}
		}
				
		$sqlstr	= "select a.replid, d.tanggal, a.nip, a.nama, ifnull(d.hadir,0) hadir, ifnull(d.cuti,0) cuti, ifnull(d.sakit,0) sakit, ifnull(d.ijin,0) ijin, ifnull(d.alpa,0) alpa from pegawai a left join presensi_general d on a.replid=d.idpegawai " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data presensi general
	function list_presensi_general($tanggal='', $all=''){	 
		$dbpdo = DB::create();
		...
		$sqlstr="select a.replid, a.tanggal, a.idpegawai, a.hadir, a.cuti, a.sakit, a.ijin, a.alpa, a.uid, a.dlu from presensi_general a " . $where . " order by date_format(a.tanggal,'%Y-%m-%d')";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data registrasi
	function get_registrasi_verifikasi($departemen_sekolah_id=''){
		$dbpdo = DB::create();
		
		$where = " where ifnull(a.info3,'')<>'' and a.departemen_sekolah_id='$departemen_sekolah_id'";
		
		$sqlstr	=	"select a.replid from calonsiswa a " . $where ;
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get deskripsi_raport_p5
	function list_deskripsi_raport_p5($id='', $tahunajaran_id='', $tingkat_id='', $semester_id='', $guru_id='', $all='', $departemen='', $departemen_sekolah_id=''){	 
		$dbpdo = DB::create();
		...
		if ( $tahunajaran_id != "") {
			if ($where == "") {
				$where = " where a.tahunajaran_id = '$tahunajaran_id' ";
			} else {
				$where = $where . " and a.tahunajaran_id = '$tahunajaran_id' ";
			}								
		}
		...
		if ( $guru_id != "") {
			if ($where == "") {
				$where = " where a.guru_id = '$guru_id' ";
			} else {
				$where = $where . " and a.guru_id = '$guru_id' ";
			}								
		}
		...
		$sqlstr="select a.replid, a.departemen, a.departemen_sekolah_id, a.tahunajaran_id, a.tingkat_id, a.semester_id, a.guru_id, a.tema, a.aktif, a.uid, a.dlu, b.tahunajaran, c.tingkat, d.semester, e.kode, f.nip, f.nama nama_guru, g.nama nama_sekolah from deskripsi_raport_p5 a left join tahunajaran b on a.tahunajaran_id=b.replid left join tingkat c on a.tingkat_id=c.replid left join semester d on a.semester_id=d.replid left join guru e on a.guru_id=e.replid left join pegawai f on e.nip=f.replid left join departemen_sekolah g on a.departemen_sekolah_id=g.replid " . $where . " order by a.replid";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//-------list_deskripsi_raport_p5_dimensi
	function list_deskripsi_raport_p5_dimensi($id='') {
		$dbpdo = DB::create();
		
		$where = " where a.deskripsi_p5_id = '$id' ";
		
		$sqlstr="select a.replid, a.deskripsi_p5_id, a.dimensi, a.line from deskripsi_raport_p5_dimensi a  " . $where . " order by a.line ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//-------list_deskripsi_raport_p5_elemen
	function list_deskripsi_raport_p5_elemen($id='') {
		$dbpdo = DB::create();
		
		$where = " where a.deskripsi_p5_dimensi_id = '$id' ";
		
		$sqlstr="select a.replid, a.deskripsi_p5_dimensi_id, a.elemen, a.line from deskripsi_raport_p5_elemen a  " . $where . " order by a.line ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//-------list_deskripsi_raport_p5_nilai
	function list_deskripsi_raport_p5_nilai($id='') {
		$dbpdo = DB::create();
		
		$where = " where a.deskripsi_p5_elemen_id = '$id' ";
		
		$sqlstr="select a.replid, a.deskripsi_p5_elemen_id, a.deskripsi, a.line from deskripsi_raport_p5_nilai a  " . $where . " order by a.line ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get deskripsi_raport_p5
	function get_deskripsi_raport_p5($id='', $tahunajaran_id='', $tingkat_id='', $semester_id='', $guru_id='', $all='', $departemen='', $departemen_sekolah_id=''){	 
		$dbpdo = DB::create();
		...
		$sqlstr="select a.replid, a.tahunajaran_id, a.tingkat_id, a.semester_id, a.guru_id, a.tema, a.aktif, a.uid, a.dlu, b.tahunajaran, c.tingkat, d.semester, e.kode, f.nip, f.nama nama_guru from deskripsi_raport_p5 a left join tahunajaran b on a.tahunajaran_id=b.replid left join tingkat c on a.tingkat_id=c.replid left join semester d on a.semester_id=d.replid left join guru e on a.guru_id=e.replid left join pegawai f on e.nip=f.replid " . $where . " order by a.replid";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//-------get_deskripsi_raport_p5_dimensi
	function get_deskripsi_raport_p5_dimensi($id='') {
		$dbpdo = DB::create();
	...
	//-------get_deskripsi_raport_p5_nilai
	function get_deskripsi_raport_p5_nilai($id='', $deskripsi_p5_elemen_id='') {
		$dbpdo = DB::create();
		
		$where = " where a.deskripsi_p5_dimensi_id = '$id' and a.deskripsi_p5_elemen_id='$deskripsi_p5_elemen_id' ";
		
		$sqlstr="select a.replid, a.deskripsi_p5_dimensi_id, a.deskripsi, a.line from deskripsi_raport_p5_nilai a  " . $where . " order by a.line ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//-------get_deskripsi_raport_p5_elemen
	function get_deskripsi_raport_p5_elemen($id='') {
		$dbpdo = DB::create();
	...
	//---------get raport_p5
	function list_raport_p5($deskripsi_p5_id='', $idtahunajaran='', $idtingkat='', $idsemester='', $idguru='', $all='', $line='', $idtema='', $idsiswa='', $departemen='', $departemen_sekolah_id=''){	 
		$dbpdo = DB::create();
		...
		if ( $deskripsi_p5_id != "") {
			if ($where == "") {
				$where = " where a.deskripsi_p5_id = '$deskripsi_p5_id' ";
			} else {
				$where = $where . " and a.deskripsi_p5_id = '$deskripsi_p5_id' ";
			}								
		}
		...
		if ( $idtema != "") {
			if ($where == "") {
				$where = " where a.syscode = '$idtema' ";
			} else {
				$where = $where . " and a.syscode = '$idtema' ";
			}								
		}
		...
		$sqlstr="select a.replid, a.departemen, a.departemen_sekolah_id, a.idtingkat, a.idkelas, a.idtahunajaran, a.idsemester, a.idguru, a.deskripsi_p5_id, a.tema, a.rangkuman_proses_id, a.line, b.tingkat, c.kelas, d.tahunajaran, f.nama nama_guru, g.semester, a.syscode idtema, a.syscode, ifnull((select count(x.replid) from raport_p5_nilai x where x.replid=a.replid group by x.replid),0) count_nilai, h.tema nama_tema from raport_p5 a left join tingkat b on a.idtingkat=b.replid left join kelas c on a.idkelas=c.replid left join tahunajaran d on a.idtahunajaran=d.replid left join guru e on a.idguru=e.replid left join pegawai f on e.nip=f.replid left join semester g on a.idsemester=g.replid left join raport_p5_tema h on a.tema_id=h.replid " . $where . " order by a.deskripsi_p5_id";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get raport_p5
	function list_raport_p5_view($deskripsi_p5_id='', $idtahunajaran='', $idtingkat='', $idsemester='', $idguru='', $all='', $line='', $idtema='', $idkelas='', $departemen='', $departemen_sekolah_id=''){	 
		$dbpdo = DB::create();
		...
		if($_SESSION['adm'] != 1) {
			if($_SESSION["tipe_user"] == "Guru") {
				...
				if ($where == "") {
					$where = " where a.idguru in (select a.replid from guru a left join pegawai b on a.nip=b.replid where b.replid='$idpegawai') ";
				} else {
					$where = $where . " and a.idguru in (select a.replid from guru a left join pegawai b on a.nip=b.replid where b.replid='$idpegawai') ";
				}	
			}
		}
		...
		if($deskripsi_p5_id=='' && $idtahunajaran=='' && $idtingkat=='' && $idsemester=='' && $idguru=='' && $all=='' && $line=='' && $idtema=='' && $idkelas=='' && $departemen=='' && $departemen_sekolah_id=='') {
			$where = " where a.replid=0 ";
		}
		
		$sqlstr="select distinct a.departemen, a.departemen_sekolah_id, a.idtingkat, a.idkelas, a.idtahunajaran, a.idsemester, a.idguru, a.deskripsi_p5_id, a.tema_id, a.tema, a.line, b.tingkat, c.kelas, d.tahunajaran, f.nama nama_guru, g.semester, a.syscode idtema, a.syscode, ifnull((select sum(mulai+sedang+sesuai+sangat) from raport_p5_nilai x where x.syscode=a.syscode group by x.syscode),0) count_nilai, h.tema nama_tema, i.departemen_id, i.nama nama_sekolah from raport_p5 a left join tingkat b on a.idtingkat=b.replid left join kelas c on a.idkelas=c.replid left join tahunajaran d on a.idtahunajaran=d.replid left join pegawai f on a.idguru=f.replid left join semester g on a.idsemester=g.replid left join raport_p5_tema h on a.tema_id=h.replid left join departemen_sekolah i on a.departemen_sekolah_id=i.replid " . $where . " order by a.deskripsi_p5_id";

		//$sqlstr="select distinct a.departemen, a.departemen_sekolah_id, a.idtingkat, a.idkelas, a.idtahunajaran, a.idsemester, a.idguru, a.deskripsi_p5_id, a.tema_id, a.tema, a.line, b.tingkat, c.kelas, d.tahunajaran, f.nama nama_guru, g.semester, a.syscode idtema, a.syscode, ifnull((select sum(mulai+sedang+sesuai+sangat) from raport_p5_nilai x where x.syscode=a.syscode group by x.syscode),0) count_nilai, h.tema nama_tema, i.departemen_id, i.nama nama_sekolah from raport_p5 a left join tingkat b on a.idtingkat=b.replid left join kelas c on a.idkelas=c.replid left join tahunajaran d on a.idtahunajaran=d.replid left join guru e on a.idguru=e.replid left join pegawai f on e.nip=f.replid left join semester g on a.idsemester=g.replid left join raport_p5_tema h on a.tema_id=h.replid left join departemen_sekolah i on a.departemen_sekolah_id=i.replid " . $where . " order by a.deskripsi_p5_id";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get raport_p5
	function get_siswa_raport_p5($deskripsi_p5_id='', $line='', $idtema='', $departemen='', $departemen_sekolah_id=''){	 
		$dbpdo = DB::create();
		...
		$sqlstr="select distinct a.idsiswa, a.departemen, a.departemen_sekolah_id, a.idtingkat, a.idkelas, a.idtahunajaran, a.idsemester, a.idguru, a.deskripsi_p5_id, a.tema, a.line, a.syscode, b.tingkat, c.kelas, d.tahunajaran, f.nama nama_guru, g.semester from raport_p5 a left join tingkat b on a.idtingkat=b.replid left join kelas c on a.idkelas=c.replid left join tahunajaran d on a.idtahunajaran=d.replid left join guru e on a.idguru=e.replid left join pegawai f on e.nip=f.replid left join semester g on a.idsemester=g.replid " . $where . " order by a.deskripsi_p5_id";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//-------get_raport_p5_nilai
	function get_raport_p5_nilai($replid='', $deskripsi_p5_id='', $idtingkat='', $idkelas='', $idtahunajaran='', $idsemester='', $idsiswa='', $raport_p5_id='', $line='', $line_raport='') {
		$dbpdo = DB::create();
		
		$where = " where a.idsiswa='$idsiswa' and a.deskripsi_p5_id='$deskripsi_p5_id' and b.raport_p5_id='$raport_p5_id' and b.line='$line' and a.syscode='$line_raport' ";
		
		$sqlstr="select a.replid, a.departemen, a.departemen_sekolah_id, a.idtingkat, a.idkelas, a.idtahunajaran, a.idsemester, a.idsiswa, a.deskripsi_p5_id, a.rangkuman_proses_id, b.raport_p5_id, b.mulai, b.sedang, b.sesuai, b.sangat from raport_p5 a left join raport_p5_nilai b on a.replid=b.replid  " . $where . " order by b.line ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get raport_p5
	function list_siswa_raport_p5($deskripsi_p5_id='', $idtingkat='', $idkelas='', $idtahunajaran='', $idsemester='', $idsiswa='', $raport_p5_id='', $line='', $idtema='', $departemen='', $departemen_sekolah_id=''){	 
		$dbpdo = DB::create();
		...
		$sqlstr="select a.idsiswa, a.departemen, a.departemen_sekolah_id, a.idtingkat, a.idkelas, a.idtahunajaran, a.idsemester, a.idguru, a.deskripsi_p5_id, a.tema, a.rangkuman_proses_id, a.syscode, b.tingkat, c.kelas, d.tahunajaran, f.nama nama_guru, g.semester, h.nama nama_sekolah from raport_p5 a left join tingkat b on a.idtingkat=b.replid left join kelas c on a.idkelas=c.replid left join tahunajaran d on a.idtahunajaran=d.replid left join guru e on a.idguru=e.replid left join pegawai f on e.nip=f.replid left join semester g on a.idsemester=g.replid left join departemen_sekolah h on a.departemen_sekolah_id=h.replid " . $where . " order by a.deskripsi_p5_id";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//-------list_raport_p5_nilai
	function list_raport_p5_nilai($replid='', $deskripsi_p5_id='', $idtingkat='', $idkelas='', $idtahunajaran='', $idsemester='', $idsiswa='', $raport_p5_id='', $syscode='') {
		$dbpdo = DB::create();
		
		$where = " where a.idsiswa='$idsiswa' and a.deskripsi_p5_id='$deskripsi_p5_id' and c.deskripsi_p5_dimensi_id='$raport_p5_id' and a.syscode='$syscode' ";
		
		$sqlstr="select a.departemen, a.departemen_sekolah_id, a.idtingkat, a.idkelas, a.idtahunajaran, a.idsemester, a.idsiswa, a.deskripsi_p5_id, b.raport_p5_id, b.mulai, b.sedang, b.sesuai, b.sangat, c.deskripsi from raport_p5 a left join raport_p5_nilai b on a.replid=b.replid left join deskripsi_raport_p5_nilai c on b.raport_p5_id=c.replid  " . $where . " order by b.line ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//-------get_catatan_proses_raport_p5
	function get_catatan_proses_raport_p5($id='') {
		$dbpdo = DB::create();
	...
	//---------get data setup periode raport p5
	function list_setup_periode_raport_p5($id='', $idtahunajaran='', $semester_id='', $tingkat_id='', $all='', $departemen_id='', $departemen_sekolah_id=''){	 
		$dbpdo = DB::create();
		...
		if ( $departemen_id != "") {
			if ($where == "") {
				...
				$where = $where . " and a.departemen_id = '$departemen_id' ";
			}								
		}
		...
		$sqlstr="select a.replid, a.departemen_id, a.departemen_sekolah_id, a.idtahunajaran, a.semester_id, a.tingkat_id, a.tanggal_ttd, a.aktif, a.uid, a.dlu, b.tahunajaran, c.semester, d.tingkat, e.departemen, f.nama nama_sekolah from setup_periode_raport_p5 a left join tahunajaran b on a.idtahunajaran=b.replid left join semester c on a.semester_id=c.replid left join tingkat d on a.tingkat_id=d.replid left join departemen e on a.departemen_id=e.replid left join departemen_sekolah f on a.departemen_sekolah_id=f.replid " . $where . " order by a.replid";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------list_raport_p5_dimensi
	function list_raport_p5_dimensi($id='', $idtahunajaran='', $semester_id='', $tingkat_id='', $all='', $idsiswa='', $syscode='', $raport_p5_id=''){	 
		$dbpdo = DB::create();
		...
		if ( $idtahunajaran != "") {
			if ($where == "") {
				$where = " where b.idtahunajaran = '$idtahunajaran' ";
			} else {
				$where = $where . " and b.idtahunajaran = '$idtahunajaran' ";
			}								
		}
		
		if ( $semester_id != "") {
			if ($where == "") {
				$where = " where b.semester_id = '$semester_id' ";
			} else {
				$where = $where . " and b.semester_id = '$semester_id' ";
			}								
		}
		
		if ( $tingkat_id != "") {
			if ($where == "") {
				$where = " where b.tingkat_id = '$tingkat_id' ";
			} else {
				$where = $where . " and b.tingkat_id = '$tingkat_id' ";
			}								
		}

		if ( $idsiswa != "") {
			if ($where == "") {
				$where = " where b.idsiswa = '$idsiswa' ";
			} else {
				$where = $where . " and b.idsiswa = '$idsiswa' ";
			}								
		}

		if ( $syscode != "") {
			if ($where == "") {
				$where = " where b.syscode = '$syscode' ";
			} else {
				$where = $where . " and b.syscode = '$syscode' ";
			}								
		}

		if($raport_p5_id != "") {
			if ($where == "") {
				$where = " where a.raport_p5_id = '$raport_p5_id' ";
			} else {
				$where = $where . " and a.raport_p5_id = '$raport_p5_id' ";
			}	
		}
		...
		$sqlstr="select a.replid, a.raport_p5_id, a.dimensi_id, a.line, a.syscode, c.replid iddesk,  c.dimensi from raport_p5_dimensi a left join raport_p5 b on a.syscode=b.syscode left join deskripsi_raport_p5_dimensi c on a.dimensi_id=c.replid " . $where . " order by a.replid, a.line";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------list_raport_p5_elemen
	function list_raport_p5_elemen($id='', $dimensi_id='', $idsiswa='', $syscode='', $raport_p5_id=''){	 
		$dbpdo = DB::create();
		...
		if ( $dimensi_id != "") {
			if ($where == "") {
				$where = " where a.dimensi_id = '$dimensi_id' ";
			} else {
				$where = $where . " and a.dimensi_id = '$dimensi_id' ";
			}								
		}
		...
		$sqlstr="select a.replid, a.raport_p5_id, a.dimensi_id, a.elemen_id, a.line, a.syscode, c.elemen from raport_p5_elemen a left join raport_p5 b on a.syscode=b.syscode left join deskripsi_raport_p5_elemen c on a.elemen_id=c.replid " . $where . " order by a.replid, a.line";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------list_raport_p5_subelemen
	function list_raport_p5_subelemen($id='', $elemen_id='', $idsiswa='', $syscode='', $raport_p5_id=''){	 
		$dbpdo = DB::create();
		...
		if ( $elemen_id != "") {
			if ($where == "") {
				$where = " where a.elemen_id = '$elemen_id' ";
			} else {
				$where = $where . " and a.elemen_id = '$elemen_id' ";
			}								
		}
		...
		$sqlstr="select a.replid, a.raport_p5_id, a.elemen_id, a.subelemen_id, a.mulai, a.sedang, a.sesuai, a.sangat, a.line, a.syscode, c.deskripsi from raport_p5_nilai a left join raport_p5 b on a.syscode=b.syscode left join deskripsi_raport_p5_nilai c on a.subelemen_id=c.replid left join raport_p5_elemen d on a.elemen_id=d.replid and a.syscode=d.syscode " . $where . " order by a.replid, a.line";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------list_presensiharian_setup
	function list_presensiharian_setup($replid='', $departemen='', $departemen_sekolah_id='', $all=''){	 
		$dbpdo = DB::create();
		...
		$sqlstr="select a.replid, a.departemen, a.departemen_sekolah_id, a.idtingkat, a.idkelas, a.jam_masuk, a.jam_terlambat, a.jam_pulang_cepat, a.jam_pulang, a.aktif, a.uid, a.dlu, b.nama nama_sekolah, c.tingkat, d.kelas from presensiharian_setup a left join departemen_sekolah b on a.departemen_sekolah_id=b.replid left join tingkat c on a.idtingkat=c.replid left join kelas d on a.idkelas=d.replid " . $where . " order by a.replid";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
