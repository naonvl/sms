...
class delete{
	...
	function delete_usr($ref){
		...
		$sql=$dbpdo->prepare("delete from usr_departemen where usrid='$data->usrid' ");
		$sql->execute();
	...
	function delete_departemen($ref){
		...
		$sqlstr = "delete from departemen_sekolah where departemen_id='$ref'";
	...
	function delete_pustaka($ref){
		...
		$sql=$dbpdo->prepare("delete from pustaka_supplier where pustaka_id='$ref' ");
		$sql->execute();
	...
	//----hapus pegawai non pns
	function delete_pegawai_non_pns($ref){
	...
	//---siswa kunjungan_perpustakaan
	function delete_kunjungan_perpustakaan($ref){
        $dbpdo = DB::create();
        
        $sqlstr="delete from kunjungan_perpustakaan where replid='$ref'";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---hapus pinjam alat
	function delete_pinjam_alat($ref){
        $dbpdo = DB::create();
        
        $sqlstr="delete from goods_loan_detail where ref='$ref'";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();

        $sqlstr="delete from goods_loan where ref='$ref'";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---hapus delete_rpt_absensi_harian_siswa
	function delete_rpt_absensi_harian_siswa($ref){
        $dbpdo = DB::create();
        
        $sqlstr="delete from phsiswa where replid='$ref'";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---hapus presensi general
	function delete_presensi_general($tanggal){
       	
       	$dbpdo = DB::create();
       	
       	$tanggal = date("Y-m-d", strtotime($tanggal));

		$sql=$dbpdo->prepare("delete from presensi_general where date_format(tanggal,'%Y-%m-%d')='$tanggal' ");
		$sql->execute();
	...
	//---hapus deskripsi raport P5
	function delete_deskripsi_raport_p5($ref){
       	
       	$dbpdo = DB::create();
       	
       	$sql=$dbpdo->prepare("delete from deskripsi_raport_p5 where replid='$ref' ");
		$sql->execute();

		$sql=$dbpdo->prepare("select replid from deskripsi_raport_p5_dimensi where deskripsi_p5_id='$ref' ");
		$sql->execute();
		while($data = $sql->fetch(PDO::FETCH_OBJ)) {
			$deskripsi_p5_dimensi_id = $data->replid;
			$sqlx=$dbpdo->prepare("delete from deskripsi_raport_p5_nilai where deskripsi_p5_dimensi_id='$deskripsi_p5_dimensi_id' ");
			$sqlx->execute();
		}

		$sql=$dbpdo->prepare("delete from deskripsi_raport_p5_dimensi where deskripsi_p5_id='$ref' ");
		$sql->execute();
	...
	//---delete_raport_p5
	function delete_raport_p5($ref){
       	
       	$dbpdo = DB::create();

       	$sql=$dbpdo->prepare("delete from raport_p5_nilai where syscode='$ref' ");
		$sql->execute();

		$sql=$dbpdo->prepare("delete from raport_p5_elemen where syscode='$ref' ");
		$sql->execute();

		$sql=$dbpdo->prepare("delete from raport_p5_dimensi where syscode='$ref' ");
		$sql->execute();

       	$sql=$dbpdo->prepare("delete from raport_p5 where syscode ='$ref' ");
		$sql->execute();

		return $sql;
	}

	//---hapus setu periode raport p5
	function delete_setup_periode_raport_p5($ref){
       	
       	$dbpdo = DB::create();
       	
		$sql=$dbpdo->prepare("delete from setup_periode_raport_p5 where replid='$ref' ");
		$sql->execute();
	
		return $sql;
	}

	//---hapus presensiharian_setup
	function delete_presensiharian_setup($ref){
       	
       	$dbpdo = DB::create();
       	
		$sql=$dbpdo->prepare("delete from presensiharian_setup where replid='$ref' ");
		$sql->execute();
