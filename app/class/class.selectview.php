...
class selectview{	
	...
	//---------get data registrasi
	function list_registrasi($ref='', $replid='', $tahunmasuk='', $idtingkat='', $tanggal='', $idjurusan='', $nama='', $all='', $idproses='', $idkelompok='', $departemen='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		select '2' cde, 'Mutasi' dcr, 1 nmr) e on a.idproses=e.cde left join departemen_sekolah f on a.departemen_sekolah_id=f.replid" . $where . " order by a.replid ";
	...
	//---------get data registrasi
	function list_registrasi_verif($ref='', $replid='', $tahunmasuk='', $idtingkat='', $tanggal='', $idjurusan='', $nama='', $all='', $idproses='', $idkelompok='', $departemen='', $verifikasi='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if($ref=='' && $replid=='' && $tahunmasuk=='' && $idtingkat=='' && $tanggal=='' && $idjurusan=='' && $nama=='' && $all=='' && $idproses=='' && $idkelompok=='' && $departemen=='' && $verifikasi='' && $departemen_sekolah_id=='') {
			$where = " where a.replid = 0 ";
		}
		
		$sqlstr	=	"select a.replid, a.idproses, a.idkelompok, a.departemen, a.tanggal, a.nopendaftaran, a.idtingkat, a.idjurusan, a.idminat, a.idminat1, a.foto_file, a.nama, a.panggilan, a.kelamin, a.nisn, a.nis, a.noijazah, a.tahunijazah, a.skhun, a.tahunskhun, a.noujian, a.nik, a.tmplahir, a.tgllahir, a.agama, a.kebutuhan_khusus, a.tahunmasuk, a.alamatsiswa, a.dusun, a.rt, a.rw, a.kelurahan, a.kodepossiswa, a.kecamatan, a.kabupaten, a.provinsi, a.transportasi, a.transportasi_kode, a.citacita, a.citacita_lain, a.idjenis_tinggal, a.jenis_tinggal, a.telponsiswa, a.hpsiswa, a.emailsiswa, a.kps, a.nokps, a.nokip, a.nokks, a.namaayah, a.tahunayah, a.alamatortu, a.kodeposortu, a.hportu, a.butuhkhususayah, a.butuhkhususketayah, a.pekerjaanayah, a.pekerjaanayah_lain, a.pendidikanayah, a.penghasilanayah, a.penghasilanayah_kode, a.namaibu, a.tahunibu, a.butuhkhususibu, a.butuhkhususketibu, a.pekerjaanibu, a.pekerjaanibu_lain, a.pendidikanibu, a.penghasilanibu, a.penghasilanibu_kode, a.wali, a.tahunwali, a.pekerjaanwali, a.pekerjaanwali_lain, a.pendidikanwali, a.penghasilanwali, a.tinggi, a.berat, a.jaraksekolah, a.jarak_km, a.waktutempuh, a.waktutempuh_menit, a.jsaudara, a.uid, a.dlu, b.tingkat, c.kelas jurusan, a.darah, a.file_darah, a.almayah, a.almibu, a.alamatibu, a.kodeposibu, a.hpibu, a.info3, a.departemen_sekolah_id, ifnull(a.verifikasi,0) verifikasi, d.dcr jalur_masuk, e.dcr jenis_pendaftaran, f.nama nama_sekolah from calonsiswa a left join tingkat b on a.idtingkat=b.replid left join kelas c on a.idjurusan=c.replid left join 
		(select '1' cde, 'Akademik' dcr, 0 nmr union all 
		select '2' cde, 'Non Akademik' dcr, 1 nmr union all
		select '3' cde, 'Mutasi' dcr, 2 nmr ) d on a.idkelompok=d.cde left join
		(select '1' cde, 'Siswa Baru' dcr, 0 nmr union all 
	...
	//---------get data siswa
	function list_siswa($ref='', $replid='', $idtingkat='', $kelas='', $nama='', $all='', $departemen='', $nik='', $kelamin='', $aktif='', $alumni='', $idangkatan='', $idangkatan1='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if($ref=='' && $replid=='' && $idtingkat=='' && $kelas=='' && $nama=='' && $all=='' && $departemen=='' && $nik=='' && $kelamin=='' && $aktif=='' && $alumni=='' && $idangkatan=='' && $idangkatan1=='' && $departemen_sekolah_id=='') {
			$where = " where a.replid = 0 ";
		}

		$sqlstr	=	"select a.replid, a.nis, a.nik, a.nisn, a.idangkatan, a.idangkatan1, a.departemen, a.departemen_sekolah_id, a.foto_file, a.nama, a.idkelas, a.idminat, a.kelamin, a.tmplahir, a.tgllahir, a.agama, a.warga, a.anakke, a.jsaudara, a.jtiri, a.jangkat, a.yatim, a.bahasa, a.alamatsiswa, a.alamatortu, a.telponsiswa, a.hpsiswa, a.telponortu, a.hportu, a.hpibu, a.jaraksekolah, a.kesekolah, a.berat, a.tinggi, a.kesehatan, a.darah, a.file_darah, a.kelainan, a.asalsekolah_id, a.tglijazah, a.noijazah, a.tglskhun, a.skhun, a.noujian, a.nisnasal, a.namaayah, a.namaibu, a.tmplahirayah, a.tgllahirayah, a.tmplahiribu, a.tgllahiribu, a.pekerjaanayah, a.pekerjaanibu, a.penghasilanayah, a.penghasilanibu, a.pendidikanayah, a.pendidikanibu, a.wnayah, a.wnibu, a.wali, a.tmplahirwali, a.tgllahirwali, a.pendidikanwali, a.pekerjaanwali, a.penghasilanwali, a.alamatwali, a.hpwali, a.hubungansiswa, a.pekerjaanayah_lain, a.pekerjaanibu_lain, a.pekerjaanwali_lain, a.jalurmasuk, a.uid, a.ts, b.idtingkat, b.kelas, c.tingkat, a.uid2, a.dlu2, d.nama nama_sekolah from siswa a left join kelas b on a.idkelas=b.replid left join tingkat c on b.idtingkat=c.replid left join departemen_sekolah d on a.departemen_sekolah_id=d.replid " . $where . " order by a.nama, a.idkelas, a.nis, a.replid";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data siswa
	function list_siswa_ekskul($ref='', $replid='', $idtingkat='', $kelas='', $nama='', $all='', $departemen='', $nik='', $kelamin='', $aktif='', $alumni='', $idangkatan='', $idangkatan1=''){
		$dbpdo = DB::create();
		
		$where = " where ifnull(a.alumni,0)=0 and a.aktif=1 ";
		...
		if($ref=='' && $replid=='' && $idtingkat=='' && $kelas=='' && $nama=='' && $all=='' && $departemen=='' && $nik=='' && $kelamin=='' && $alumni=='' && $idangkatan=='' && $idangkatan1=='') {
			$where = " where a.replid = 0 ";
		}
	...
	//---------get data siswa
	function list_siswa_barcode($ref='', $replid='', $idtingkat='', $kelas='', $nama='', $all='', $departemen='', $nik='', $kelamin='', $aktif='', $alumni='', $idangkatan='', $idangkatan1=''){
		$dbpdo = DB::create();
	...
	//---------get data pegawai non pns
	function list_pegawai_non_pns($bagian='', $nip='', $nama='', $all=''){
		$dbpdo = DB::create();
	...
	//---------get data alumni
	function list_alumni($ref='', $departemen='', $idangkatan1='', $tahunmasuk='', $tgllulus='', $nama='', $all='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if($ref=='' && $departemen=='' && $idangkatan1=='' && $tahunmasuk=='' && $tgllulus=='' && $nama=='' && $all=='' && $departemen_sekolah_id=='') {
			$where = " where a.replid = 0 ";
		}
		
		$sqlstr	=	"select a.replid, a.nis, a.klsakhir, a.tktakhir, a.tgllulus, a.keterangan, a.departemen, a.ts, b.replid idsiswa, b.nisn, b.nama, b.kelamin, b.tglmasuk, b.tahunmasuk, c.kelas, d.tingkat, e.angkatan, f.nama nama_sekolah from alumni a left join siswa b on a.nis=b.nis and b.alumni=1 left join kelas c on a.klsakhir=c.replid left join tingkat d on a.tktakhir=d.replid left join angkatan e on b.idangkatan1=e.replid left join departemen_sekolah f on a.departemen_sekolah_id=f.replid " . $where . " order by a.replid ";
	...
	function rpt_presensi_harian_siswa($daritgl='', $ketgl='', $nis='', $kelas='', $idtingkat='', $nama='', $departemen='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if($departemen_sekolah_id != "") {
			if ($where == "") {
				$where = " where c.departemen_sekolah_id = '$departemen_sekolah_id' ";
			} else {
				$where = $where . " and c.departemen_sekolah_id = '$departemen_sekolah_id' ";
			}
		}
		...
		$sqlstr = "select a.replid, a.nis, b.tanggal1, c.departemen, c.nama, d.kelas, f.tingkat, e.semester, a.hadir, a.ijin, a.sakit, a.alpa, a.cuti, a.keterangan, a.departemen_sekolah_id, a.ts, g.nama nama_sekolah from phsiswa a left join presensiharian b on a.idpresensi=b.replid left join siswa c on a.nis=c.nis left join kelas d on c.idkelas=d.replid left join semester e on b.idsemester=e.replid left join tingkat f on d.idtingkat=f.replid left join departemen_sekolah g on c.departemen_sekolah_id=g.replid " . $where . " order by b.tanggal1";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data rpt presensi harian siswa
	function rpt_presensi_harian_siswa_2($daritgl='', $ketgl='', $nis='', $kelas='', $idtingkat='', $nama='', $departemen='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		
		$where = " where a.info1='datang' ";
		...
		$sqlstr = "select b.replid id, a.replid, a.nis, b.tanggal1, c.departemen, c.nama, d.kelas, f.tingkat, e.semester, a.hadir, a.ijin, a.sakit, a.alpa, a.cuti, a.keterangan, a.departemen_sekolah_id, a.ts, g.nama nama_sekolah from phsiswa a left join presensiharian b on a.idpresensi=b.replid left join siswa c on a.nis=c.nis left join kelas d on c.idkelas=d.replid left join semester e on b.idsemester=e.replid left join tingkat f on d.idtingkat=f.replid left join departemen_sekolah g on c.departemen_sekolah_id=g.replid " . $where . " order by b.tanggal1";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function list_dashboard_presensi_harian_siswa($departemen='', $daritgl='', $ketgl=''){
		$dbpdo = DB::create();
		
		if ($daritgl != "") {
			$daritgl = date("Y-m-d", strtotime($daritgl));
			/*if ($where == "") {
				$where = " where date_format(b.tanggal1,'%Y-%m-%d') >= '$daritgl' ";
			} else {
				$where = $where . " and date_format(b.tanggal1,'%Y-%m-%d') >= '$daritgl' ";
			}*/
		}
		...
		if ($ketgl != "") {
			$ketgl = date("Y-m-d", strtotime($ketgl));
			/*if ($where == "") {
				$where = " where date_format(b.tanggal1,'%Y-%m-%d') <= '$ketgl' ";
			} else {
				$where = $where . " and date_format(b.tanggal1,'%Y-%m-%d') <= '$ketgl' ";
			}*/
		}


		$where = " where (a.hadir=0 and date_format(b.tanggal1,'%Y-%m-%d') >= '$daritgl' and date_format(b.tanggal1,'%Y-%m-%d') <= '$ketgl')";
		//or  ( date_format(b.ts,'%H:%i')>'07:00' and date_format(b.ts,'%H:%i')<'14:00' and date_format(b.tanggal1,'%Y-%m-%d') >= '$daritgl' and date_format(b.tanggal1,'%Y-%m-%d') <= '$ketgl' ) 
	...
	//---------get data dashboard presensi harian siswa
	function list_dashboard_terlambat_siswa($departemen='', $daritgl='', $ketgl=''){
		$dbpdo = DB::create();
		...
		$where = " where a.hadir=1 and date_format(a.ts,'%H:%i')>'06:30' and date_format(a.ts,'%H:%i')<'14:00' and date_format(b.tanggal1,'%Y-%m-%d') >= '$daritgl' and date_format(b.tanggal1,'%Y-%m-%d') <= '$ketgl' ";
	...
	function list_dashboard_presensi_harian_guru($departemen='', $daritgl='', $ketgl=''){
		$dbpdo = DB::create();
		
		$where = " where ifnull(b.nama,'')<>'' and ifnull(a.hadir,0)=1 ";
		...
		$sqlstr = "select b.nip, b.nama, a.tanggal, a.dlu from presensi_general a left join pegawai b on a.idpegawai=b.replid " . $where . " order by a.dlu desc";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data siswa baru
	function list_siswa_baru($ref='', $replid='', $idtingkat='', $kelas='', $nama='', $all='', $departemen='', $nik='', $kelamin='', $idgugus='', $idangkatan='', $idangkatan1='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if ($departemen != "") {
			if ($where == "") {
				$where = " where (c.departemen = '$departemen' or a.departemen = '$departemen') ";
			} else {
				$where = $where . " and (c.departemen = '$departemen' or a.departemen = '$departemen') ";
			}
		}
		...
		if($ref=='' && $replid=='' && $idtingkat=='' && $kelas=='' && $nama=='' && $all=='' && $departemen=='' && $nik=='' && $kelamin=='' && $idgugus=='' && $idangkatan=='' && $idangkatan1=='' && $departemen_sekolah_id=='') {
			$where = " where a.replid = 0 ";
		}
		
		$sqlstr	=	"select a.replid, a.nis, a.nik, a.departemen_sekolah_id, a.nisn, a.idangkatan, a.idangkatan1, a.foto_file, a.nama, a.idkelas, a.idminat, a.kelamin, a.tmplahir, a.tgllahir, a.agama, a.warga, a.anakke, a.jsaudara, a.jtiri, a.jangkat, a.yatim, a.bahasa, a.alamatsiswa, a.alamatortu, a.telponsiswa, a.hpsiswa, a.telponortu, a.hportu, a.hpibu, a.jaraksekolah, a.kesekolah, a.berat, a.tinggi, a.kesehatan, a.darah, a.file_darah, a.kelainan, a.asalsekolah_id, a.tglijazah, a.noijazah, a.tglskhun, a.skhun, a.noujian, a.nisnasal, a.namaayah, a.namaibu, a.tmplahirayah, a.tgllahirayah, a.tmplahiribu, a.tgllahiribu, a.pekerjaanayah, a.pekerjaanibu, a.penghasilanayah, a.penghasilanibu, a.pendidikanayah, a.pendidikanibu, a.wnayah, a.wnibu, a.wali, a.tmplahirwali, a.tgllahirwali, a.pendidikanwali, a.pekerjaanwali, a.penghasilanwali, a.alamatwali, a.hpwali, a.hubungansiswa, a.pekerjaanayah_lain, a.pekerjaanibu_lain, a.pekerjaanwali_lain, a.uid, a.ts, a.file_jalurmasuk, b.idtingkat, b.kelas, c.tingkat, d.gugus, a.uid2, a.dlu2 from siswa a left join kelas b on a.idkelas=b.replid left join tingkat c on b.idtingkat=c.replid left join gugus d on a.idgugus=d.replid " . $where . " order by a.nis, a.nama, a.idkelas, a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function rpt_ar_outstanding($date_from = '', $date_to = '', $contact_code = '', $all = 0, $so_no='') {
		...
		if ( $contact_code != "") {
			...
			if ($where2 == "") {
				$where2 = " where a.contact_code = '$contact_code' ";
			} else {
				$where2 = $where2 . " and a.contact_code = '$contact_code' ";
			}								
		}
		...
		if ( $so_no != "") {
			...
			if ($where2 == "") {
				$where2 = " where b.ref2 = '$so_no' ";
			} else {
				$where2 = $where2 . " and b.ref2 = '$so_no' ";
			}								
		}
		...
		$sqlstr = "select aa.invoice_no, aa.date, aa.due_date, aa.client_name, aa.contact_code, sum(aa.debit_amount) debit_amount, sum(aa.credit_amount) credit_amount, sum(aa.debit_amount) - sum(aa.credit_amount) amount  from (
select a.invoice_no, a.date, a.due_date, b.nama client_name, a.contact_code, (a.debit_amount) debit_amount, 0 credit_amount from ar a left join siswa b on a.contact_code=b.replid ".$where2."
union all
select a.invoice_no, a.date, a.due_date, b.nama client_name, a.contact_code, 0 debit_amount, (a.credit_amount) credit_amount from ar a left join siswa b on a.contact_code=b.replid ".$where.") aa group by aa.contact_code, aa.invoice_no";
	...
	//---------get siswa terlambat
	function dashboard_siswa_terlambat($daritgl='', $ketgl=''){
		$dbpdo = DB::create();
	...
	//---------get data rpt presensi harian piket
	function rpt_presensi_piket($daritgl='', $ketgl='', $nis='', $nama=''){
		$dbpdo = DB::create();
		...
		$sqlstr = "select a.replid, a.tanggal, a.idpegawai, b.nip, b.nama, a.tanggal, a.hadir, a.ijin, a.sakit, a.alpa, a.cuti, a.keterangan from presensi_piket a left join pegawai b on a.idpegawai=b.replid " . $where . " order by a.tanggal";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get Guru Piket
	function dashboard_presensi_general_piket($daritgl='', $ketgl='', $nis='', $nama=''){
		$dbpdo = DB::create();
	...
	function rpt_presensi_ukbm($id='', $all='', $tingkat='', $kelas='', $tanggal='', $tanggal1='', $idguru=''){	 
		$dbpdo = DB::create();
		...
		if ( $tanggal1 != "") {
			...
			if ($where == "") {
				$where = " where date_format(a.tanggal,'%Y-%m-%d') <= '$tanggal1' ";
			} else {
				$where = $where . " and date_format(a.tanggal,'%Y-%m-%d') <= '$tanggal1' ";
			}								
		}
		...
		$sqlstr="select distinct a.ref, a.tanggal, a.idpelajaran, a.idguru, a.idsemester, a.idukbm, a.idtingkat, a.idkelas, b.kelas, c.tingkat, d.semester, e.nama nama_guru, f.nama pelajaran, g.kode, g.deskripsi ukbm from presensi_ukbm a left join kelas b on a.idkelas=b.replid left join tingkat c on a.idtingkat=c.replid left join semester d on a.idsemester=d.replid left join pegawai e on a.idguru=e.replid left join pelajaran f on a.idpelajaran=f.replid left join ukbm g on a.idukbm=g.replid " . $where . " order by a.tanggal desc";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	function rpt_absensi_harian_siswa($daritgl='', $ketgl='', $nis='', $kelas='', $idtingkat='', $nama='', $departemen='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		$sqlstr = "select a.replid, a.nis, b.tanggal1, c.departemen, c.nama, d.kelas, f.tingkat, e.semester, a.hadir, a.ijin, a.sakit, a.alpa, a.cuti, a.keterangan, a.ts, g.nama nama_sekolah from phsiswa a left join presensiharian b on a.idpresensi=b.replid left join siswa c on a.nis=c.nis left join kelas d on c.idkelas=d.replid left join semester e on b.idsemester=e.replid left join tingkat f on d.idtingkat=f.replid left join departemen_sekolah g on c.departemen_sekolah_id=g.replid " . $where . " order by b.tanggal1";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data siswa
	function get_siswa_presensi($nis='', $nisn='', $nama='', $departemen='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if ($nisn != "") {
			if ($where == "") {
				$where = " where a.nisn = '$nisn' ";
			} else {
				$where = $where . " and a.nisn = '$nisn' ";
			}
		}
		...
		$sqlstr	=	"select a.replid, a.nis, a.nik, a.nisn, a.idangkatan, a.idangkatan1, a.departemen_sekolah_id, a.foto_file, a.nama, a.idkelas, a.idminat, a.kelamin, b.idtingkat, b.kelas, c.tingkat, a.departemen, d.nama nama_sekolah from siswa a left join kelas b on a.idkelas=b.replid left join tingkat c on b.idtingkat=c.replid left join departemen_sekolah d on a.departemen_sekolah_id=d.replid " . $where . " order by a.nama, a.idkelas, a.nis, a.replid";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data registrasi
	function get_registrasi($ref='', $replid='', $tahunmasuk='', $idtingkat='', $tanggal='', $idjurusan='', $nama='', $all='', $idproses='', $idkelompok='', $departemen='', $departemen_sekolah_id='', $kelamin=''){
		$dbpdo = DB::create();
		
		$where = " where a.nik not in (select nik from siswa) ";
		...
		$sqlstr	=	"select a.replid, a.idproses, a.idkelompok, a.departemen, a.tanggal, a.nopendaftaran, a.idtingkat, a.idjurusan, a.idminat, a.idminat1, a.foto_file, a.nama, a.panggilan, a.kelamin, a.nisn, a.nis, a.noijazah, a.tahunijazah, a.skhun, a.tahunskhun, a.noujian, a.nik, a.tmplahir, a.tgllahir, a.agama, a.kebutuhan_khusus, a.tahunmasuk, a.alamatsiswa, a.dusun, a.rt, a.rw, a.kelurahan, a.kodepossiswa, a.kecamatan, a.kabupaten, a.provinsi, a.transportasi, a.transportasi_kode, a.citacita, a.citacita_lain, a.idjenis_tinggal, a.jenis_tinggal, a.telponsiswa, a.hpsiswa, a.emailsiswa, a.kps, a.nokps, a.nokip, a.nokks, a.namaayah, a.tahunayah, a.alamatortu, a.kodeposortu, a.hportu, a.butuhkhususayah, a.butuhkhususketayah, a.pekerjaanayah, a.pekerjaanayah_lain, a.pendidikanayah, a.penghasilanayah, a.penghasilanayah_kode, a.namaibu, a.tahunibu, a.butuhkhususibu, a.butuhkhususketibu, a.pekerjaanibu, a.pekerjaanibu_lain, a.pendidikanibu, a.penghasilanibu, a.penghasilanibu_kode, a.wali, a.tahunwali, a.pekerjaanwali, a.pekerjaanwali_lain, a.pendidikanwali, a.penghasilanwali, a.tinggi, a.berat, a.jaraksekolah, a.jarak_km, a.waktutempuh, a.waktutempuh_menit, a.jsaudara, a.uid, a.dlu, b.tingkat, c.kelas jurusan, a.darah, a.file_darah, a.almayah, a.almibu, a.alamatibu, a.kodeposibu, a.hpibu, d.dcr jalur_masuk, e.dcr jenis_pendaftaran, f.nama nama_sekolah from calonsiswa a left join tingkat b on a.idtingkat=b.replid left join kelas c on a.idjurusan=c.replid left join 
		(select '1' cde, 'Akademik' dcr, 0 nmr union all 
		select '2' cde, 'Non Akademik' dcr, 1 nmr union all
		select '3' cde, 'Mutasi' dcr, 2 nmr ) d on a.idkelompok=d.cde left join
		(select '1' cde, 'Siswa Baru' dcr, 0 nmr union all 
	...
	function rpt_receipt_history($invoice_no='') {
		...
		$where = " where ifnull(b.name,'') <> '' and (a.invoice_type = 'RCI') and a.invoice_no = '$invoice_no' ";
		...
		$sqlstr="select a.ref, a.invoice_no, a.date, c.receipt_type, b.name client_name, a.credit_amount from ar a left join  (select replid code, concat(nama, ' ( ','Employee',' )') name, 'E' type from pegawai where aktif=1 union all  select replid code, nama name, 'C' type from siswa where aktif=1 and ifnull(nama,'') <> '' ) b on a.contact_code=b.code left join receipt c on a.ref=c.ref " . $where . " order by a.date, a.ref ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data siswa
	function get_siswa_raport_p5($ref='', $replid='', $tingkat_id='', $alumni='', $departemen='', $departemen_sekolah_id=''){
		$dbpdo = DB::create();
		...
		if ($replid != "") {
			if ($where == "") {
				$where = " where a.replid in ($replid)";
			} else {
				$where = $where . " and a.replid in ($replid) ";
			}
		}
		...
		if ($tingkat_id != "") {
			if ($where == "") {
				...
				$where = $where . " and b.idtingkat = '$tingkat_id' ";
			}
		}
		...
		$sqlstr	=	"select a.replid, a.departemen, a.departemen_sekolah_id, a.nis, a.nama, a.nisn, a.nik, a.idangkatan, a.idangkatan1, a.foto_file, a.nama, a.panggilan, a.idkelas, a.kelamin, a.tmplahir, a.tgllahir, a.agama, a.warga, a.anakke, a.jsaudara, a.jtiri, a.jangkat, a.yatim, a.bahasa, a.desa_kode, a.kecamatan_kode, a.kota_kode, a.provinsi_kode, a.alamatsiswa, a.rt_siswa, a.rw_siswa, a.dusun, a.desa, a.kecamatan, a.kodepossiswa, a.jenistinggal, a.alamatortu, a.telponsiswa, a.hpsiswa, b.kelas, c.tingkat from siswa a left join kelas b on a.idkelas=b.replid left join tingkat c on b.idtingkat=c.replid left join jenispekerjaan d on a.pekerjaanayah=d.replid left join jenispekerjaan e on a.pekerjaanibu=e.replid left join siswa_virtualaccount f on a.nis=f.nis " . $where . " order by a.replid ";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
	...
	//---------get data siswa riwayat
	function list_siswa_riwayat_raport_p5($ref='', $replid='', $idtingkat='', $kelas='', $nama='', $all='', $departemen='', $nik='', $kelamin='', $aktif='', $alumni='', $idangkatan='', $idangkatan1='', $multi_siswa=''){
		$dbpdo = DB::create();
		...
		if($multi_siswa != "") {
			$sqlstr = "select nis from siswa where replid in ($multi_siswa)";
			$sql=$dbpdo->prepare($sqlstr);
			$sql->execute();
			...
			while($data = $sql->fetch(PDO::FETCH_OBJ)) {
				if($multi_siswa == "") {
					$multi_siswa = "'".$data->nis."'";
				} else {
					$multi_siswa = $multi_siswa.",'".$data->nis."'";
				}
			}
			if ($where == "") {
				$where = " where a.nis in ($multi_siswa) ";
			} else {
				$where = $where . " and a.nis in ($multi_siswa) ";
			}
		}
		
		
		$sqlstr	=	"select a.replid, a.departemen, a.departemen_sekolah_id, a.nis, a.nik, a.nisn, a.idangkatan, a.idangkatan1, a.foto_file, a.nama, a.idkelas, a.idminat, a.kelamin, a.tmplahir, a.tgllahir, a.agama, a.warga, a.anakke, a.jsaudara, a.jtiri, a.jangkat, a.yatim, a.bahasa, a.alamatsiswa, a.alamatortu, a.telponsiswa, a.hpsiswa, a.telponortu, a.hportu, a.hpibu, a.jaraksekolah, a.kesekolah, a.berat, a.tinggi, a.kesehatan, a.darah, a.file_darah, a.kelainan, a.asalsekolah_id, a.tglijazah, a.noijazah, a.tglskhun, a.skhun, a.noujian, a.nisnasal, a.namaayah, a.namaibu, a.tmplahirayah, a.tgllahirayah, a.tmplahiribu, a.tgllahiribu, a.pekerjaanayah, a.pekerjaanibu, a.penghasilanayah, a.penghasilanibu, a.pendidikanayah, a.pendidikanibu, a.wnayah, a.wnibu, a.wali, a.tmplahirwali, a.tgllahirwali, a.pendidikanwali, a.pekerjaanwali, a.penghasilanwali, a.alamatwali, a.hpwali, a.hubungansiswa, a.pekerjaanayah_lain, a.pekerjaanibu_lain, a.pekerjaanwali_lain, a.jalurmasuk, a.uid, a.ts, b.idtingkat, b.kelas, c.tingkat, a.uid2, a.dlu2 from riwayatkelassiswa d left join siswa a on d.nis=a.nis left join kelas b on d.idkelas=b.replid left join tingkat c on b.idtingkat=c.replid " . $where . " order by a.nama, a.idkelas, a.nis, a.replid";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
