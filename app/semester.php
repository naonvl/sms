		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_semester=$sql->fetch(PDO::FETCH_OBJ);	
					
					$tanggal_ttd = date("d-m-Y", strtotime($row_semester->tanggal_ttd));
					if($tanggal_ttd == "01-01-1970") {
						$tanggal_ttd = "";
					}
					
					$aktif = "";
					if ($row_semester->aktif == 1) {
						$aktif = "checked";
					} else {
						$aktif = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="semester2" id="semester2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('semester');" >
        ...
        <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_departemen($row_semester->departemen); ?>
						</select>
					</div>
				</div>
      	...
      	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="semester" name="semester" class="form-control" value="<?php echo $row_semester->semester ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $row_semester->keterangan ?></textarea>
					</div>
				</div>
				
				<div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">Titimangsa Raport</label>
                    <div class="col-lg-3">
                      <input type="text" id="tanggal_ttd" name="tanggal_ttd" class="form-control date-picker" data-date-format="dd-mm-yyyy" value="<?php echo $tanggal_ttd ?>">
					</div>
				</div>
