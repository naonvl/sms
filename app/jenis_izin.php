		...
		<div class="col-xs-12">
			...
			<form action="" method="post" name="jenis_izin2" id="jenis_izin2" class="form-horizontal" onSubmit="return cekinput('nama');">
            	...
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jenis Izin Siswa *)</label>
					<div class="col-sm-3">
						<input type="text" name="nama" id="nama" class="form-control"  value="<?php echo $jenis_izin_data->nama ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea name="keterangan" id="keterangan" class='form-control' rows="4"><?php echo $jenis_izin_data->keterangan ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="checkbox" name="aktif" id="aktif" class="ace" value="1" <?php echo $act ?> ><span class="lbl"></span>
					</div>
				</div><!-- /.row -->
