<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('konseling_siswa_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
				...
				<?php
					...
					if ($delete == "xm8r389xemx23xb2378e23") {
						...
						$delete2=new delete;
						$delete2->delete_konseling_siswa($segmen4);
				?>
						<div class="alert alert-success">
							<strong>Delete Data successfully</strong>
						</div>

						<meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('konseling_siswa_view') ?>" />
				<?php
					}
				?>
									...
									<tr>					
										...
										<td>
											<?php if (allowupd('frmkonseling_siswa')==1) { ?>
												<a href="<?php echo $__folder ?><?php echo obraxabrix('konseling_siswa') ?>/<?php echo $konseling_siswa_view->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
													<span class="green">
                                            ...
                                            <?php if (allowdel('frmkonseling_siswa')==1) { ?>    
                                                &nbsp;
												<a href="JavaScript:hapus('<?php echo $konseling_siswa_view->ref ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
													<span class="red">
