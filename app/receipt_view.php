...
<?php
	...
	if ($delete == "xm8r389xemx23xb2378e23") {
		...
		$delete2=new delete;
		$delete2->delete_receipt($segmen4);
?>
		<div class="alert alert-success">
			<strong>Delete Receipt successfully</strong>
		</div>
		
		<meta http-equiv="Refresh" content="0;url=<?php echo $nama_folder . '/' . obraxabrix('receipt_view'); ?>" />
<?php
	}
?>
...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo obraxabrix('receipt_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
			                    	...
			                    	<th><?php if($lng==1) { echo 'Customer Name'; } else { echo 'Nama Member'; } ?></th>			
							...
							<tbody>
                                <?php			
									$sql=$select->list_receipt("", $from_date, $to_date, $client_code, $all, $departemen, $departemen_sekolah_id);
									while($row_receipt=$sql->fetch(PDO::FETCH_OBJ)){
										...
										$receipt_type = "";
										if ($row_receipt->receipt_type == "cash" || $row_receipt->receipt_type == "Tunai") {
											$receipt_type = "Tunai";
										}
										...
										if ($row_receipt->receipt_type == "transfer" || $row_receipt->receipt_type == "Bank") {
											$receipt_type = "Transfer Bank";
										}
                                        ...
                                        <tr>
											...
											<td>
                                                ...
                                                <?php if (allowupd('frmreceipt')==1) { ?>
    												<a href="<?php echo obraxabrix('receipt') ?>/<?php echo $row_receipt->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
														<span class="green">
