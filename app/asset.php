	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="asset" id="asset" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('ref,asset_name');" >
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">No. Kode Barang *)</label>
					<div class="col-lg-3">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nama Barang/Jenis Barang *)</label>
					<div class="col-sm-3">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <select id="asset_type_id" name="asset_type_id" class="chosen-select form-control" tabindex="2" style="width: auto">
                        <option value=""></option>
                        <?php 
                        	select_where("asset_type","id","type","active","1",$row_asset->asset_type_id) 
                        ?>	                            
                      </select>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Perolehan Dari</label>
					<div class="col-sm-3">
						<textarea id="perolehan" name="perolehan" class="autosize-transition form-control"><?php echo $row_asset->perolehan ?></textarea>
					</div>
				</div>
