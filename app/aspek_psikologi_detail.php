		...
		<div class="col-xs-12">
			...
			<form action="" method="post" name="aspek_psikologi_detail" id="aspek_psikologi_detail" class="form-horizontal" onSubmit="return cekinput('departemen,jenis_aspek_id,aspek');">
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class='chosen-select form-control' onchange="loadHTMLPost2('<?= $__folder ?>app/aspek_psikologi_detail_ajax.php','departemen_id','cekjenis','departemen')" >
							<option value="">...</option>
                ...
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jenis Aspek Psikologi *)</label>
					<div class="col-sm-3" id="departemen_id">
						<select name="jenis_aspek_id" id="jenis_aspek_id" class='chosen-select form-control'>
							<option value="">...</option>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Aspek Psikologi Detail *)</label>
					<div class="col-sm-3" id="siswa_id">
						<input type="text" name="aspek" id="aspek" class="form-control" value="<?php echo $aspek_psikologi_detail_data->aspek ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="checkbox" name="aktif" id="aktif" class="ace" value="1" <?php echo $aktif ?> ><span class="lbl"></span>
					</div>
				</div>
