		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_aspek_psikologi_detail($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('aspek_psikologi_detail_view') ?>" />
			<?php
										...
										<tr>
											...
											<td align="center">
                                                ...
                                                <?php if (allowupd('frmaspek_psikologi_detail')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('aspek_psikologi_detail') ?>/<?php echo $aspek_psikologi_detail_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmaspek_psikologi_detail')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $aspek_psikologi_detail_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
