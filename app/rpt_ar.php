						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
			                    	...
			                    	<th><?php if($lng==1) { echo 'Student Name'; } else { echo 'Nama Siswa'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Amount Due'; } else { echo 'Total Iuran'; } ?></th>
							...
							<tbody>
                                <?php			
									...
									while ($row_rpt_ar=$sql->fetch(PDO::FETCH_OBJ)) {
										...
										$total_debit = $total_debit + $row_rpt_ar->debit_amount;
	                                	$total_credit = $total_credit + $row_rpt_ar->credit_amount;
	                                	$total_result = $total_result + $row_rpt_ar->amount;
								?>
							...
							<tr style="font-weight: bold;">
		                    	...
		                    	<td align="right"><?php echo number_format($total_result,0,".",",") ?></td>
							</tr>
						</table>
					</div>
				</div>
