...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('rpp_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_rpp($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <!--<meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('rpp_view') ?>" />-->
			<?php
				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="jam_view" id="jam_view" enctype="multipart/form-data" >
		            	...
		            	<div class="form-group">
							...
							<div class="col-sm-3">
								<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/rpp_ajax.php','tingkat_id','gettingkat_list','departemen')" >
									<option value=""></option>
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th style="font-weight:bold ">Minimal Kehadiran &nbsp;&nbsp;</th>
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_rpp("", $idtingkat, $idpelajaran, $all, $departemen);
								...
								?>
                                        ...
                                        <tr>
											...
											<td><?php echo $rpp_view->deskripsi ?></td>
											<td><?php echo $rpp_view->minimum_hadir ?></td>
											<td>
											...
											<td align="center">
                                                ...
                                                <?php if (allowupd('frmrpp')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('rpp') ?>/<?php echo $rpp_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmrpp')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $rpp_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
