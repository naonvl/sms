		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="soal_siswa" id="soal_siswa" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('ref,tanggal,idtingkat,idkelas,idsemester');" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen__" id="departemen__" disabled class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/general_ajax.php','sekolah_id','getsekolah_tingkat','departemen')" >
							<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-4" id="sekolah_id">
						<select name="departemen_sekolah_id__" id="departemen_sekolah_id__" disabled class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/general_ajax.php','tingkat_id','getkelas_tingkat_sekolah','departemen_sekolah_id')">
							<option value=""></option>
        		...
        		<div class="form-group">
					...
					<div class="col-sm-3" id="tingkat_id">
						<select name="idtingkat__" id="idtingkat__" disabled class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/general_ajax.php','kelas_id','getkelas_departemen_sekolah','idtingkat')" >
							<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-3" id="kelas_id">
						<select name="idkelas__" id="idkelas__" disabled class="chosen-select form-control" >
							<option value=""></option>
