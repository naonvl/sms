	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='dasarpenilaian') {
			alert('Kode Dasar Penilaian tidak boleh kosong!');				
		  }
		  
		  if (document.getElementById(arrf[i]).name=='keterangan') {
			alert('Dasar Penilaian tidak boleh kosong!');				
		  }
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="dasarpenilaian2" id="dasarpenilaian2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('departemen,kode,dasarpenilaian');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control">
							<option value=""></option>
							<?php select_departemen($dasarpenilaian_data->departemen); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="dasarpenilaian" id="dasarpenilaian" class="form-control" value="<?php echo $dasarpenilaian_data->dasarpenilaian ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Dasar Penilaian *)</label>
					<div class="col-sm-3">
						<input type="text" name="keterangan" id="keterangan" class="form-control" value="<?php echo $dasarpenilaian_data->keterangan ?>">
					</div>
				</div>
