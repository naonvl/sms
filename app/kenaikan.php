...
$idkelas3				= 	$_POST['idkelas3'];

/*departemen, departemen_sekolah_id, idtingkat2, idkelas2
departemen1, departemen_sekolah_id1, idtingkat3, idkelas3*/
		...
		<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<?php
						if($_POST['submit'] == "Proses Naik") {
							include("app/exec/insert_kenaikan.php");
						}
					?>
			
					<form class="form-horizontal" role="form" action="" method="post" name="kenaikan_filter" id="kenaikan_filter" enctype="multipart/form-data" onsubmit="return prosesnaik()" >
						
						<div class="col-sm-6">
							<div class="widget-box">
								<div class="widget-header widget-header-flat">
									<h4 class="widget-title">Tingkat Awal</h4>
								</div>
									...
									<div class="widget-main">
										<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-sm-4" id="tingkat_id">
													<select name="idtingkat2" id="idtingkat2" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/general_ajax.php','kelas_id','getkelas_departemen_sekolah','idtingkat2')">
														<option value=""></option>
														<?php 
															//select_tingkat_unit("SMA", $idtingkat2); 
															select_tingkat_sekolah($departemen_sekolah_id, $idtingkat2);
														?>
													</select>								
												</div>
											</div>
						...
						<div class="col-sm-6">
							<div class="widget-box">
								<div class="widget-header widget-header-flat">
									<h4 class="widget-title">Tingkat Tujuan</h4>
								</div>
									...
									<div class="widget-main">
										<div class="row">
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Unit</label>
												<div class="col-sm-3">
													<select name="departemen1" id="departemen1" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/general_ajax.php','sekolah_id1','getsekolah_tingkat1','departemen1')" >
														<option value=""></option>
											...
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nama Sekolah</label>
												<div class="col-sm-5" id="sekolah_id1">
													<select name="departemen_sekolah_id1" id="departemen_sekolah_id1" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/general_ajax.php','tingkat_id1','getkelas_tingkat_sekolah1','departemen_sekolah_id1')">
														<option value=""></option>
														<?php select_sekolah_unit($departemen1, $departemen_sekolah_id1); ?>
													</select>
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tingkat</label>
												<div class="col-sm-4" id="tingkat_id1">
													<select name="idtingkat3" id="idtingkat3" class="chosen-select form-control" onchange="loadHTMLPost2('app/kenaikan_ajax.php','kelas_id2','getkelas_departemen_sekolah1','idtingkat3')">
														<option value=""></option>
														<?php 
															//select_tingkat_unit("SMA", $idtingkat3); 
															select_tingkat_sekolah($departemen_sekolah_id1, $idtingkat3)
														?>
													</select>								
												</div>
											</div>
			...
			<form class="form-horizontal" role="form" action="" method="post" name="kenaikan" id="kenaikan" enctype="multipart/form-data" >
				<div class="row">
					<div class="col-xs-12">
						<div class="clearfix">
						...
						<div>
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								<thead>
									<tr>
										...
										<th style="text-align: center">
											<label class="pos-rel">
												<input type="checkbox" id="naikall" name="naikall" class="ace" value="1" checked="" /><span class="lbl"></span>
											</label>
										</th>
									</tr>
								</thead>
								...
								<tbody>
	                                <?php			
										$sql=$selectview->list_siswa('', '', $idtingkat2, $idkelas2, $nama2, $all, $departemen, '', '');
									...
									?>
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td><?php echo $siswa_view->nama_sekolah ?></td>
												...
												<th style="text-align: center">
													<label class="pos-rel">
	                                                	<input type="checkbox" class='ace' id="naik_<?php echo $i ?>" name="naik_<?php echo $i ?>" class="ace" value="1" ><span class="lbl"></span>
	                                                </label>
	                                            </th>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
		                        ...
		                        <?php if (allowadd('kenaikan')==1) { ?>
		    						<?php if($ref=='') { ?>
		    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Proses Naik" onClick="return confirm('Apakah sudah yakin data sudah benar?')" />
		    						<?php } ?>
		                        <?php } ?>
