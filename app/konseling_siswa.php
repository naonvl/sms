...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form action="" method="post" name="pelanggaran_siswa2" id="pelanggaran_siswa2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tanggal,idtingkat,idkelas,idsiswa,idjenis_konseling');">
				...
				?>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<?php if( $ref == "" ) { ?>
									<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/konseling_siswa_ajax.php','tingkat_id','gettingkat','departemen')" >
										<option value=""></option>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jenis Konseling *)</label>
							<div class="col-sm-3">
								<select name="idjenis_konseling" id="idjenis_konseling" class="chosen-select form-control" >
									<option value=""></option>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								<?php if($konseling_siswa_data->data_file != "") { ?>
									<a class="label label-success" href="<?= $__folder ?>app/konseling_siswa_download.php?ref=<?php echo $konseling_siswa_data->ref ?>" target="_blank" title="Download"><?php echo $konseling_siswa_data->data_file; ?>
									</a>
								<?php } ?>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Petugas BK *)</label>
							<div class="col-sm-4">
								<select name="nip" id="nip" class="chosen-select form-control" />
									<option value=""></option>
						...
						<div class="col-sm-12">
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9">
									...
									&nbsp;
									<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $__folder . obraxabrix('konseling_siswa_view') ?>'" />
								</div>
							</div>
						</div>
