<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('surat_keluar_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_surat_keluar($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('surat_keluar_view') ?>" />
			<?php
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="font-size: 12px">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_surat_keluar("", $from_date, $to_date, $idkelompok_surat, $all);
						            while($surat_keluar_view=$sql->fetch(PDO::FETCH_OBJ)){
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $surat_keluar_view->tanggal ?></td>
											<td><?php echo $surat_keluar_view->no_surat ?></td>
											<td><?php echo $surat_keluar_view->kelompok_surat ?></td>
											<td><?php echo $surat_keluar_view->petugas ?></td>
											<td><?php echo $surat_keluar_view->tujuan ?></td>                                 
                                            <td><?php echo $surat_keluar_view->dlu ?></td>								
											<td align="center">
                                            
                                                <?php if (allowupd('frmsurat_keluar')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('surat_keluar') ?>/<?php echo $surat_keluar_view->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmsurat_keluar')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $surat_keluar_view->ref ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
