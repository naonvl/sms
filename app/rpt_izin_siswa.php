				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="siswa_lis" id="siswa_list" enctype="multipart/form-data" >
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onchange="loadHTMLPost2('app/rpt_izin_siswa_ajax.php','kelas_id','getkelas','idtingkat')" />
									<option value=""></option>
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									...
									$sql=$selectview->list_rpt_izin_siswa($daritgl, $ketgl, $idtingkat, $idkelas, $nama, $all);			
								...
								?>
									...
									<tr>
										...
										<td>
											<!-- <a href="<?php echo $__folder ?><?php echo obraxabrix('rpt_izin_siswa_surat') ?>/<?php echo $rpt_izin_siswa_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Cetak" target="_blank">
												<span class="green">
