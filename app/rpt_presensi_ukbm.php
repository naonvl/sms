...
<?php
	...
	if($tanggal1 == "") { $tanggal1 = date('d-m-Y'); }
				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="siswa_list" id="siswa_list" enctype="multipart/form-data" >
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="tanggal1" name="tanggal1" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $tanggal1 ?>">				
							</div>
						</div>
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="font-size: 12px">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$selectview->rpt_presensi_ukbm("", "", $idtingkat, $idkelas, $tanggal, $tanggal1, $idguru);
								...
								?>
                                        ...
                                        <tr>
											...
											<td align="center">
                                            	<a class="tooltip-success" href="javascript:void(0);" name="Find" title="Detail Siswa" onClick=window.open("<?php echo $__folder ?>app/rpt_presensi_ukbm_detail.php?idkelas=<?= $soal_ukbm_view->idkelas ?>&idtingkat=<?= $soal_ukbm_view->idtingkat ?>&tanggal=<?= $tanggal ?>&tanggal1=<?= $tanggal1 ?>&tanggal=<?= $tanggal ?>&idguru=<?= $soal_ukbm_view->idguru ?>&idpelajaran=<?= $soal_ukbm_view->idpelajaran ?>","Find","width=1200,height=600,left=50,top=20,toolbar=0,status=0,scroll=1,scrollbars=no"); >
													<span class="green">
