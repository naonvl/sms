    ...
    <body>
      ...
      <?php
        ...
        <?php
            ...
            header("Content-Disposition: attachment; filename=Daftar PTK PNS.xls");
        ...
        ?>
	        ...
	        <table border="1" id="dynamic-table" class="table table-striped table-bordered table-hover">
	        	<tr>
                    <th colspan="7" class="left" style="font-weight:bold ">DAFTAR DATA PTK PNS</th>
				</tr>
				<thead>
					<tr>
						...
						<th style="font-weight:bold ">NRK&nbsp;&nbsp;</th>
						<th style="font-weight:bold ">Pengkat/Golongan&nbsp;&nbsp;</th>
						...
						<th style="font-weight:bold ">Suku&nbsp;&nbsp;</th>
						...
						<th style="font-weight:bold ">No. SK CPNS&nbsp;&nbsp;</th>
						<th style="font-weight:bold ">TMT SK CPNS&nbsp;&nbsp;</th>
						<th style="font-weight:bold ">No. SK PNS&nbsp;&nbsp;</th>
						<th style="font-weight:bold ">TMT SK PNS&nbsp;&nbsp;</th>
				...
				<tbody>
					...
					?>
                            ...
                            <tr>
								...
								<?php
									$nip = $pegawai_view->nip;
									echo "<td>=\"$nip\"</td>";
								?>

								<td><?php echo $pegawai_view->nrk ?></td>
								<td><?= $pegawai_view->pangkat ?></td>
								...
								<td><?= $pegawai_view->no_sk_masuk ?></td>
								<td><?= date('d-m-Y', strtotime($pegawai_view->tmt_cpns)) ?></td>
								<td><?= $pegawai_view->no_sk_tetap ?></td>
								<td><?= date('d-m-Y', strtotime($pegawai_view->tanggal_sk_tetap)) ?></td>
								<td><?= $pegawai_view->status_pegawai ?></td>
