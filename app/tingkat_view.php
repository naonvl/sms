...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('tingkat_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_tingkat($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('tingkat_view') ?>" />
			<?php
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_tingkat("", $departemen, $all, $departemen_sekolah_id);
						            while($tingkat_view=$sql->fetch(PDO::FETCH_OBJ)){
            						
            						$i++;
										$tanggal_ttd = date("d-m-Y", strtotime($tingkat_view->tanggal_ttd));
                                        ...
                                        <tr>
											...
											<td align="center">
                                                ...
                                                <?php if (allowupd('frmtingkat')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('tingkat') ?>/<?php echo $tingkat_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmtingkat')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $tingkat_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
