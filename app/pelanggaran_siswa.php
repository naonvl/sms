			...
			<form action="" method="post" name="pelanggaran_siswa2" id="pelanggaran_siswa2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tanggal,idtingkat,idkelas,idsiswa,idjenis_pelanggaran,kejadian');">
					...
					?>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="ref" id="ref" class="form-control" readonly value="<?php echo $ref2; ?>" >
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<?php if( $_SESSION["adm"] == 1 || allowlvl("frmsiswa") == 2 ) { ?>
									<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/pelanggaran_siswa_ajax.php','tingkat_id','gettingkat_list','departemen')" >
										<option value=""></option>
						...
						<div class="form-group">
							...
							<div class="col-sm-3" id="tingkat_id">
								<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onClick="loadHTMLPost2('app/pelanggaran_siswa_ajax.php','kelas_id','getkelas','idtingkat')">
									<option value=""></option>
									<?php select_tingkat_unit($departemen, $pelanggaran_siswa_data->idtingkat); ?>
								</select>								
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4" id="siswa_id">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select name="idjenis_pelanggaran" id="idjenis_pelanggaran" class="chosen-select form-control" >
									<option value=""></option>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Kejadian *)</label>
							<div class="col-sm-4">
								<textarea name="kejadian" id="kejadian" class='form-control' rows="4"><?php echo $pelanggaran_siswa_data->kejadian ?></textarea>							
							</div>
						</div>

						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Hukuman *)</label>
							<div class="col-sm-4">
								<textarea name="hukuman" id="hukuman" class='form-control' rows="4"><?php echo $pelanggaran_siswa_data->hukuman ?></textarea>							
							</div>
						</div>

						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Photo Pelanggaran</label>
							<div class="col-sm-6">
								<input type="file" id="photo" name="photo" >
								
								<?php if ($pelanggaran_siswa_data->photo != "") { ?>
									<img src="<?= $__folder ?>app/file_foto_pelanggaran/<?php echo $pelanggaran_siswa_data->photo ?>" width="200" height="200" />
								<?php } ?>
						...
						<div class="col-sm-12">
			               ...
			               <?php if (allowupd('frmpelanggaran_siswa')==1) { ?>
											...
											&nbsp;
											<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $__folder . obraxabrix('pelanggaran_siswa_view') ?>'" />
								</div>
							</div>
						</div>
