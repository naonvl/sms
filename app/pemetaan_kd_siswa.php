	...
	function cekinput(fid) {  
	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='pemetaan_kd_id') {
			alert('Pemetaan KD tidak boleh kosong!');				
		  }
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_pemetaan_kd_siswa.php");
				
				$ekstra_sifat = "";
				$aktif = "checked";
				if ($ref != "") {
					$sql=$select->list_pemetaan_kd_siswa($ref);
					$pemetaan_kd_siswa_data=$sql->fetch(PDO::FETCH_OBJ);	
					
					$aktif = "";
					if ($pemetaan_kd_siswa_data->aktif == 1) {
						$aktif = "checked";
					} else {
						$aktif = "";
					}
					...
					$ekstra_sifat = "";
					if ($pemetaan_kd_siswa_data->ekstra_sifat == 1) {
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="pemetaan_kd_siswa2" id="pemetaan_kd_siswa2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('departemen,idsiswa,idguru,idpelajaran,pemetaan_kd_id');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control">
							<option value=""></option>
							<?php select_departemen($pemetaan_kd_siswa_data->departemen); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-4" id="tingkat_id">
						<select name="idsiswa" id="idsiswa" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_siswa_id($pemetaan_kd_siswa_data->idsiswa) ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<select name="idguru" id="idguru" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_petugas($pemetaan_kd_siswa_data->idguru) ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">						
						<select name="idpelajaran" id="idpelajaran" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_pelajaran_all($pemetaan_kd_siswa_data->idpelajaran) ?>
						</select>						
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<select name="pemetaan_kd_id" id="pemetaan_kd_id" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_pemetaan_kd($pemetaan_kd_siswa_data->pemetaan_kd_id) ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="nilai" id="nilai" class="form-control" value="<?php echo $pemetaan_kd_siswa_data->nilai ?>">
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmpemetaan_kd_siswa')==1) { ?>
    						<?php if($ref=='') { ?>
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('pemetaan_kd_siswa_view') ?>'" />
