		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$ekstra_sifat = "";
					if ($kompetensi_data->ekstra_sifat == 1) {
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="kompetensi2" id="kompetensi2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('departemen,kode,kompetensi');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control">
							<option value=""></option>
							<?php select_departemen($kompetensi_data->departemen); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="kode" id="kode" class="form-control" value="<?php echo $kompetensi_data->kode ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Komptensi *)</label>
					<div class="col-sm-5">
						<textarea id="kompetensi" name="kompetensi" class="form-control"><?php echo $kompetensi_data->kompetensi ?></textarea>
					</div>
				</div>
