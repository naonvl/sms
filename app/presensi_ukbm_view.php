...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('presensi_ukbm_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_presensi_ukbm($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('presensi_ukbm_view') ?>" />
			<?php
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="<?php echo $nama_folder ?>/<?php echo obraxabrix('presensi_ukbm_view') ?>" method="post" name="siswa_list" id="siswa_list" enctype="multipart/form-data" >
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="font-size: 12px">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_presensi_ukbm_view("", "", $idtingkat, $idkelas, $tanggal, $idguru);
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $soal_ukbm_view->tanggal ?></td>
											...
											<td align="center">
                                                ...
                                                <?php if (allowupd('frmsoal_ukbm')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('presensi_ukbm') ?>/<?php echo $soal_ukbm_view->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmsoal_ukbm')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $soal_ukbm_view->ref ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
