			...
			<form class="form-horizontal" role="form" action="" method="post" name="pegawai" id="pegawai" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('bagian,nip,nama,kelamin');" >
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="row">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">NRK</label>
								<div class="col-sm-6" id="nip_id">
									<input type="text" name="nrk" id="nrk" class="form-control" value="<?php echo $pegawai->nrk; ?>" >
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Pangkat/Golongan</label>
								<div class="col-sm-6">
									<select name="pangkat_id" id="pangkat_id" class="chosen-select form-control" >
										<option value=""></option>
										<?php select_pangkat($pegawai->pangkat_id); ?>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="panggilan" id="panggilan" class="form-control" value="<?php echo $pegawai->panggilan; ?>" >
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<input type="text" name="suku" id="suku" class="form-control" value="<?php echo $pegawai->suku; ?>" >
								</div>
							</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        &nbsp;
                        <a href="<?php echo $__folder ?>app/pegawai_download_format.php" target="_blank" title="Download Format File">
							<span class="blue">
								<i class="ace-icon fa fa-cloud-download bigger-220"></i>
							</span>
						</a>          
						&nbsp;
						<a href="#"  onClick="JavaScript:import_pegawai()" title="Upload Data Pegawai">
        					<span class="blue">
