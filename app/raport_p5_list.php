...
<script type="text/javascript">
	function raport_p5_proses(idtingkat, idkelas, semester_id, idtahunajaran, idtema, iddetail) 
	{
		...
		<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="raport_p5_view" id="raport_p5_view" enctype="multipart/form-data" >
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th style="font-weight:bold ">Tema &nbsp;&nbsp;</th>
							...
							<tbody>
                                <?php			
                                	$i = 0;
            						$sql=$select->list_deskripsi_raport_p5("", $tahunajaran_id, $tingkat_id, $semester_id, $guru_id, $all);
						            while($raport_p5_view=$sql->fetch(PDO::FETCH_OBJ)){
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
											<td><?php echo $raport_p5_view->tahunajaran ?></td>
											<td><?php echo $raport_p5_view->tingkat ?></td>
											<td><?php echo $raport_p5_view->semester ?></td>
											<td><?php echo $raport_p5_view->nama_guru ?></td>
											<td>
												<b><?php echo $raport_p5_view->tema ?><br>
												Penilaian :</b>
												<a href="javascript:void(0);" name="Find" title="Proses Nilai" onClick="raport_p5_proses('<?php echo $tingkat_id ?>','<?php echo $idkelas ?>','<?php echo $semester_id ?>','<?php echo $tahunajaran_id ?>','<?php echo $raport_p5_view->replid ?>','<?php echo $row_det->replid ?>')"><img src="assets/img/rapor_proses.png" /></a>
												<br><br>
												<table width="100%" border="1" style="border: 1px solid #93d145;" id="detail_<?= $y?>">
													...
													<?php
														$no = 0;
														$sql2=$select->list_deskripsi_raport_p5_dimensi($raport_p5_view->replid); 
											...
											<td><?php echo $raport_p5_view->uid ?></td>
											<td><?php echo $raport_p5_view->dlu ?></td>
																		
											<td align="center">
                                            
                                                <?php if (allowupd('frmraport_p5')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('raport_p5') ?>/<?php echo $raport_p5_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmraport_p5')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $raport_p5_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
