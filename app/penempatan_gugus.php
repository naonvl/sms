	...
	function cekinput(fid) {  
	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='idgugus') {
			alert('Gugus Tujuan tidak boleh kosong!');				
		  }
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<?php } ?>
				...
				<?php
					if($_POST['submit'] == "Proses Gugus") {
						include("app/exec/insert_penempatan_gugus.php");
					}
				?>
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form class="form-horizontal" role="form" action="" method="post" name="penempatan_list" id="penempatan_list" onSubmit="return cekinput('idgugus');" enctype="multipart/form-data">
							<div class="widget-header widget-header-flat">
								<h4 class="widget-title">Gugus</h4>
							</div>
							<div>&nbsp;</div>	
							<div class="form-group">
								...
								<div class="col-sm-4">
									<select name="idgugus" id="idgugus" class="chosen-select form-control" >
										<option value=""></option>
										<?php select_gugus_sekolah($departemen, $departemen_sekolah_id, $idgugus); ?>
									</select>								
								</div>
							</div>
						...
						<div>
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								...
								<tbody>
	                                <?php		
	                                	$x = 0;	
	                                	$sql=$selectview->get_registrasi('', '', $tahunmasuk, $idtingkat, '', $idjurusan, $nama, $all, $idproses, $idkelompok, $departemen, $departemen_sekolah_id, $kelamin);
									...
									?>
	                                        ...
	                                        <tr <?php echo $bgcolor ?>>
	                                            ...
	                                            <td>
	                                            	<?php echo $siswa_view->nopendaftaran ?>
	                                            </td>
								...
								<tr>
									<td colspan="14" align="right">
										<button type="submit" name="submit" id="submit" class="btn btn-white btn-info btn-bold" value="Proses Gugus" onClick="return confirm('Apakah yakin Anda data sudah benar?')">
