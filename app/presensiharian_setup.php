	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_presensiharian_setup.php");
				
				$aktif = "checked";
				
				if ($ref != "") {
					$sql=$select->list_presensiharian_setup($ref);
					$presensiharian_setup_data=$sql->fetch(PDO::FETCH_OBJ);	
					$departemen = $presensiharian_setup_data->departemen;
					$departemen_sekolah_id = $presensiharian_setup_data->departemen_sekolah_id;
					$idtingkat2 = $presensiharian_setup_data->idtingkat;
					$idkelas2 = $presensiharian_setup_data->idkelas;
					$jam_masuk = date("H:i", strtotime($presensiharian_setup_data->jam_masuk));
					$jam_terlambat = date("H:i", strtotime($presensiharian_setup_data->jam_terlambat));
					$jam_pulang_cepat = date("H:i", strtotime($presensiharian_setup_data->jam_pulang_cepat));
					$jam_pulang = date("H:i", strtotime($presensiharian_setup_data->jam_pulang));
					$aktif = "";
					if ($presensiharian_setup_data->aktif == 1) {
						$aktif = "checked";
					} else {
						$aktif = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="presensiharian_setup2" id="presensiharian_setup2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('departemen,departemen_sekolah_id');" >
				...
				<div class="form-group">
					...
					<div class="col-sm-5" id="sekolah_id">
				...
				<div class="form-group">
					...
					<div class="col-sm-3" id="tingkat_id">
						<select name="idtingkat2" id="idtingkat2" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/general_ajax.php','kelas_id','getkelas_departemen_sekolah','idtingkat2')" >
							<option value=""></option>
							<?php select_tingkat_sekolah($departemen_sekolah_id, $idtingkat2); ?>
						</select>			
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group bootstrap-timepicker">
							<input id="jam_masuk" name="jam_masuk" type="text" class="form-control" value="<?= $jam_masuk ?>" />
				...
				<?php /*
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jam Terlambat</label>
					<div class="col-sm-3">
						<div class="input-group bootstrap-timepicker">
							<input id="jam_terlambat" name="jam_terlambat" type="text" class="form-control" value="<?= $jam_pulang ?>" />
							<span class="input-group-addon">
								<i class="fa fa-clock-o bigger-110"></i>
							</span>
						</div>
				...
				<?php /*
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Batas Jam Pulang Cepat</label>
					<div class="col-sm-3">
						<div class="input-group bootstrap-timepicker">
							<input id="jam_pulang_cepat" name="jam_pulang_cepat" type="text" class="form-control" value="<?= $jam_pulang_cepat ?>" />
							<span class="input-group-addon">
								<i class="fa fa-clock-o bigger-110"></i>
							</span>
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group bootstrap-timepicker">
							<input id="jam_pulang" name="jam_pulang" type="text" class="form-control" value="<?= $jam_pulang ?>" />
							<span class="input-group-addon">
								<i class="fa fa-clock-o bigger-110"></i>
							</span>
						</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmpresensiharian_setup')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmpresensiharian_setup')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Simpan" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frmpresensiharian_setup')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('presensiharian_setup_view') ?>'" />
