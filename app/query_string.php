...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="country" id="country" class="form-horizontal" enctype="multipart/form-data" >
            
            	<input type="hidden" id="id" name="id" value="<?php echo $ref ?>" >
            	
            	<div class="form-group">
					<!--<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Query String</label>-->
					<div class="col-sm-10">
						<textarea id="query__" name="query__" rows="5" cols="100" ><?php echo $query__ ?></textarea>
					</div>
				</div>
				...
				<div class="form-group"> 
                    ...
                    <div class="col-xs-5">
						<input type="radio" id="main" name="main" class="ace" value="1"/><span class="lbl"></span>
					</div>
				</div>
				
				<div class="form-group"> 
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">/app</label>
                    <div class="col-xs-5">
				...
				<div class="form-group"> 
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">/app/class</label>
                    <div class="col-xs-5">
				...
				<div class="form-group"> 
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">/app/include</label>
                    <div class="col-xs-5">
				...
				<div class="form-group"> 
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">/app/exec</label>
                    <div class="col-xs-5">
