	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='kode') {
			alert('Klas tidak boleh kosong!');				
		  }
		  
		  if (document.getElementById(arrf[i]).name=='nama') {
			alert('Indeks tidak boleh kosong!');				
		  }
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_kelompok_surat.php");
				
				$aktif = "checked";
				if ($ref != "") {
					$sql=$select->list_kelompok_surat($ref);
					$kelompok_surat_data=$sql->fetch(PDO::FETCH_OBJ);	
					
					$aktif = "";
					if ($kelompok_surat_data->aktif == 1) {
						$aktif = "checked";
					} else {
						$aktif = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="kelompok_surat2" id="kelompok_surat2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('kode,nama');" >
            	
            	<input type="hidden" id="id" name="id" value="<?php echo $ref ?>" >
                
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Klas *)</label>
					<div class="col-sm-3">
						<input type="text" name="kode" id="kode" class="form-control" value="<?php echo $kelompok_surat_data->kode ?>">
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="nama" id="nama" class="form-control" value="<?php echo $kelompok_surat_data->nama ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="uraian" name="uraian" class="form-control"><?php echo $kelompok_surat_data->uraian ?></textarea>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmkelompok_surat')==1) { ?>
    						<?php if($ref=='') { ?>
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('kelompok_surat_view') ?>'" />
