		...
		<div class="col-xs-12">
			...
			<form action="" method="post" name="assesmen_observasi" id="assesmen_observasi" class="form-horizontal" onSubmit="return cekinput('tanggal,departemen,idtingkat,idkelas,nis,idpegawai,idpegawai1');" enctype="multipart/form-data" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('app/assesmen_observasi_ajax.php','tingkat_id','gettingkat','departemen')" />
							<option value="">...</option>
				...
				<div class="form-group">
					...
					<div class="col-sm-4" id="siswa_id1">
				...
				<div class="form-group" id="siswa_id">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php if($assesmen_observasi_data->data_file != "") { ?>
							<a class="label label-success" href="<?= $__folder ?>app/assesmen_observasi_download.php?ref=<?php echo $assesmen_observasi_data->ref ?>" target="_blank" title="Download"><?php echo $assesmen_observasi_data->data_file; ?>
							</a>
						<?php } ?>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Orthopaedagog *)</label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Supporting Teacher *)</label>
					<div class="col-sm-4">
						<select name="idpegawai1" id="idpegawai1" class="chosen-select form-control" />
                            <option value="">...</option>
