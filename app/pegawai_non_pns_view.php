<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('pegawai_non_pns_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/pegawai_non_pns_xls.php?bagian="+bagian+"&nip="+nip+"&nama="+nama+"&all="+all+"";	
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_pegawai($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=main.php?menu=app&act=<?php echo obraxabrix('pegawai_non_pns_view') ?>" />
			<?php
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="pegawai_lis" id="pegawai_list" enctype="multipart/form-data" >
                                        ...
                                        <tr>
											...
											<td align="center">
                                                ...
                                                <?php if (allowupd('frmpegawai_non_pns')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('pegawai_non_pns') ?>/<?php echo $pegawai_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmpegawai_non_pns')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $pegawai_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
