...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="kelas" id="kelas" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('kelas');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<?php if($ref == "") { ?>
							<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_ajax.php','sekolah_id','getsekolah_kelas','departemen')" >
								<option value=""></option>
								<?php select_departemen($row_kelas->departemen); ?>
							</select>
						<?php } else { ?>
							<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_ajax.php','sekolah_id','getsekolah_kelas_update','departemen')" >
								<option value=""></option>
								<?php select_departemen($row_kelas->departemen); ?>
							</select>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-4" id="sekolah_id">
						<select name="departemen_sekolah_id" id="departemen_sekolah_id" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_ajax.php','tingkat_id','getkelas_sekolah','departemen_sekolah_id')">
							<option value=""></option>
							<?php select_sekolah_unit($row_kelas->departemen, $row_kelas->departemen_sekolah_id); ?>
						</select>
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3" id="tingkat_id">
						<select name="idtingkat" id="idtingkat" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_tingkat_sekolah($row_kelas->departemen_sekolah_id, $row_kelas->idtingkat); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-lg-2">
						<select name="idtahunajaran" id="idtahunajaran" class="chosen-select form-control" />
							<option value=""></option>
							<?php select_thnajaran($row_kelas->idtahunajaran); ?>
						</select>
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="kelas" name="kelas" class="form-control" value="<?php echo $row_kelas->kelas ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="kapasitas" name="kapasitas" class="form-control" value="<?php echo $row_kelas->kapasitas ?>">
					</div>
				</div>
				
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Pembimbing Akademik</label>
					<div class="col-sm-3">
						<select name="nipwali" id="nipwali" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_pegawai($row_kelas->nipwali); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $row_kelas->keterangan ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="file" id="ttd_file_hd" name="ttd_file_hd" class="form-control" style="width: auto" value="" >
						<?php if (!empty($row_kelas->ttd_file_hd)) { ?>
    						<br>
	    					<a href="<?php echo $__folder ?>app/file_ttd/<?php echo $row_kelas->ttd_file_hd ?>" rel="lightbox" style="text-decoration:none;" title="Photo View">
								<label>
									<img src="../app/file_ttd/<?php echo $row_kelas->ttd_file_hd; ?>" width="50" height="50" />
								</label>
							</a>
							
	    				<?php } ?>
	    				<input type="hidden" id="ttd_file_hd2" name="ttd_file_hd2" value="<?php echo $row_kelas->ttd_file_hd; ?>">	
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="aktif" id="aktif" value="1" <?php if($row_kelas->aktif==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
