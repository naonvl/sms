	...
	function cekinput(fid) {  
	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='booked') {
			alert('Tanggal Pinjam tidak boleh kosong!');				
		  }
		  
		  if (document.getElementById(arrf[i]).name=='booked_finish') {
			alert('Selesai Tanggal Pinjam tidak boleh kosong!');				
		  }
...
<?php
	...
	$from_time		=	date("H:i");
	$to_time		=	date("H:i");
	$to_time 		=	date('H:i',strtotime('+2 hours',strtotime($to_time)));
?>
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				$ref2 = notran(date('y-m-d'), 'frmregistration', '', '', ''); 
				
				include("app/exec/pinjam_alat_insert.php"); 
				
				if($_POST['submit'] == "Tampilkan Kamar") {
            ...
            <?php if($ref == "") { ?>
				<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" role="form" action="<?php echo obraxabrix('pinjam_alat') ?>" method="post" name="registration2" id="registration2" enctype="multipart/form-data" onSubmit="return cekinput('booked,booked_finish');" >
	            	
	            	<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tanggal Pinjam</label>
						<div class="col-sm-3">
							<div class="input-daterange input-group">
								<input type="text" id="booked" name="booked" style="font-size: 12px" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $booked ?>">
								
								<span class="input-group-addon">
									s/d
								</span>
								
								<input type="text" id="booked_finish" name="booked_finish" style="font-size: 12px" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $booked_finish ?>">	
							</div>							
						</div>
					</div>
					...
					<div class="clearfix form-actions">
						<div class="col-md-offset-3 col-md-9">
							  <input type="submit" name="submit" id="submit" class='btn btn-primary' value="Tampilkan Barang"/>
