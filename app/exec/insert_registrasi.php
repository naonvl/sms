...
if ($post == "lulus_all" ){
	...
	$hs=$update->update_registrasi_lulus();
	
	if($hs){			
?>
		<div class="alert alert-success">Seleksi Lulus successfully</div>
<?php
	}else{
?>
		<div class="alert alert-error">Seleksi Lulus Error Update</div>
<?php		
