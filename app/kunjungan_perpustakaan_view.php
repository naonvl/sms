...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('kunjungan_perpustakaan_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
...
<script type="text/javascript">
	function print() {
		...
		window.open('app/kunjungan_perpustakaan_pdf.php?idsiswa='+idsiswa+'&idtingkat='+idtingkat+'&idkelas='+idkelas+'&tanggal='+tanggal+'&tanggal1='+tanggal1+'&all='+all, 'Daftar Siswa Terlambat Print','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_kunjungan_perpustakaan($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('kunjungan_perpustakaan_view') ?>" />
			<?php
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="kunjungan_perpustakaan_view" id="kunjungan_perpustakaan_view" enctype="multipart/form-data" >
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_kunjungan_perpustakaan("", $tanggal, $tanggal1, $idsiswa, $idtingkat, $kelas, $all);
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
											<td><?php echo date("d-m-Y", strtotime($kunjungan_perpustakaan_view->tanggal)) ?></td>
											<td><?php echo date("H:i", strtotime($kunjungan_perpustakaan_view->jam)) ?></td>
											<td><?php echo $kunjungan_perpustakaan_view->nis . ' ' .$kunjungan_perpustakaan_view->nama_siswa ?></td>
											<td><?php echo $kunjungan_perpustakaan_view->tingkat ?></td>
											<td><?php echo $kunjungan_perpustakaan_view->kelas ?></td>
											<td><?php echo $kunjungan_perpustakaan_view->keterangan ?></td>
											<td align="center">
                                            
                                                <?php if (allowupd('frmkunjungan_perpustakaan')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('kunjungan_perpustakaan') ?>/<?php echo $kunjungan_perpustakaan_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmkunjungan_perpustakaan')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $kunjungan_perpustakaan_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
