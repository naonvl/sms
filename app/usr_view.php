						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
                                    ...
                                    <th class="center" style="font-weight:bold ">Copy</th>    
								</tr>
							</thead>
							...
							<tbody>
								...
								?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo obraxabrix('usr') ?>/<?php echo $usr_view->id ?>/copy" class="tooltip-success" data-rel="tooltip" title="Copy Hak Akses">
													<span class="green">
														<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
													</span>
												</a>
