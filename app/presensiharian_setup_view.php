...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('presensiharian_setup_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_presensiharian_setup($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('presensiharian_setup_view') ?>" />
			<?php
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="jam_view" id="jam_view" enctype="multipart/form-data" >
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th style="font-weight:bold ">Jam Masuk &nbsp;&nbsp;</th>
									<!-- <th style="font-weight:bold ">Jam Terlambat &nbsp;&nbsp;</th> -->
									<!-- <th style="font-weight:bold ">Batas Jam Pulang Cepat &nbsp;&nbsp;</th> -->
									<th style="font-weight:bold ">Jam Pulang &nbsp;&nbsp;</th>
									<th style="font-weight:bold ">Aktif &nbsp;&nbsp;</th>
									<th style="font-weight:bold ">Diedit Oleh &nbsp;&nbsp;</th>
									<th style="font-weight:bold ">Diedit Tanggal &nbsp;&nbsp;</th>
									<th>Edit/Hapus</th>	
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_presensiharian_setup("", $departemen, $departemen_sekolah_id, $all);
						            while($presensiharian_setup_view=$sql->fetch(PDO::FETCH_OBJ)){
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $presensiharian_setup_view->departemen ?></td>
											<td><?php echo $presensiharian_setup_view->nama_sekolah ?></td>
											<td><?php echo $presensiharian_setup_view->tingkat ?></td>
											<td><?php echo $presensiharian_setup_view->kelas ?></td>
											<td><?php echo date("H:i", strtotime($presensiharian_setup_view->jam_masuk)) ?></td>
											<!-- <td><?php echo date("H:i", strtotime($presensiharian_setup_view->jam_terlambat)) ?></td> -->
											<!-- <td><?php echo date("H:i", strtotime($presensiharian_setup_view->jam_pulang_cepat)) ?></td> -->
											<td><?php echo date("H:i", strtotime($presensiharian_setup_view->jam_pulang)) ?></td>
											<td>
												<?php if ($presensiharian_setup_view->aktif == 1) { ?>
													<button class="btn btn-xs btn-success">
														<i class="ace-icon fa fa-check bigger-120"></i>
													</button>
												<?php } ?>
											</td>
											<td><?php echo $presensiharian_setup_view->uid ?></td>
											<td><?php echo $presensiharian_setup_view->dlu ?></td>
											<td align="center">
                                            
                                                <?php if (allowupd('frmpresensiharian_setup')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('presensiharian_setup') ?>/<?php echo $presensiharian_setup_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmpresensiharian_setup')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $presensiharian_setup_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
