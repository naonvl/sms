...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="<?php echo $nama_folder ?>/<?php echo obraxabrix('presensi_general') ?>" method="post" name="siswa_list" id="siswa_list" enctype="multipart/form-data" >
            	
        <!-- <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Guru/Staff/TU</label>
				...
				<!-- <div class="form-group">
					...
					<div class="col-sm-3" id="kelas_id"> -->
						<input type="hidden" name="all" id="all" value="1"><span class="lbl"></span>							
					<!-- </div>
				</div> -->
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="submit" name="submit" id="submit" class='btn btn-primary' value="Tampilkan Data Guru/Pegawai"/>
                      
                      &nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $__folder . obraxabrix('presensi_general_view') ?>'" />
                    </div>  
				</div>
