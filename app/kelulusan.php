...
<script type="text/javascript">
	...
	function prosesnaik() {
		...
		var tgllulus = document.getElementById('tgllulus').value;
		if(tgllulus == "") {
...
$tgllulus	= date("d-m-Y", strtotime($_REQUEST['tgllulus']));
		...
		<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<?php
						if($_POST['submit'] == "Proses Lulus") {
							include("app/exec/insert_kelulusan.php");
						}
						
						//$idtingkat2 = 46; //default tingkat XII
						if($_REQUEST['tgllulus'] == "") {
							$tgllulus = "";
						}
					?>
						...
						<div class="col-sm-6">
							<div class="widget-box">
								<div class="widget-header widget-header-flat">
									<h4 class="widget-title">Tingkat</h4>
								</div>
								...
								<div class="widget-body">
									<div class="widget-main">
										<div class="row">
											...
											<div class="form-group">
							                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tanggal Kelulusan</label>
							                    <div class="col-sm-4">
							                    	 <input type="text" name="tgllulus" id="tgllulus" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $tgllulus ?>">
												</div>
					...
					<div class="col-xs-12">
						...
						<div>
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								...
								<tbody>
	                                <?php			
										$sql=$selectview->list_siswa('', '', $idtingkat2, $idkelas2, $nama2, $all, $departemen, '', '', '', '', '', '', $departemen_sekolah_id);
									...
									?>
										<div class="hide">
											...
											<input type="text" id="tgllulus" name="tgllulus" value="<?php echo $tgllulus ?>" />
											<input type="text" id="idtingkat" name="idtingkat" value="<?php echo $idtingkat2 ?>" />
											<input type="text" id="departemen" name="departemen" value="<?php echo $departemen ?>" />
											<input type="text" id="departemen_sekolah_id" name="departemen_sekolah_id" value="<?php echo $departemen_sekolah_id ?>" />
										</div>
									...
									?>
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td><?php echo $siswa_view->departemen ?></td>
												...
												<th style="text-align: center">
													<label class="pos-rel">
	                                                	<input type="checkbox" class='ace' id="lulus_<?php echo $i ?>" name="lulus_<?php echo $i ?>" class="ace" value="1" ><span class="lbl"></span>
	                                                </label>
	                                            </th>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
		                        ...
		                        <?php if (allowadd('kelulusan')==1) { ?>
		    						<?php if($ref=='') { ?>
		    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Proses Lulus" onClick="return confirm('Apakah sudah yakin data sudah benar?')" />
		    						<?php } ?>
		                        <?php } ?>
