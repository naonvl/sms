...
<form name="frm" id="frm" method="post" action="presensi_absen_siswa_lup.php">
    ...
    <script langauge="javascript">
    	function post_value(j){
        	...
        	var zz= "nis" + j;        	
            opener.document.absen_siswa.tnis.value = aa.elements[zz].value;

            var yy= "nis2" + j;        	
            opener.document.absen_siswa.nisx.value = aa.elements[yy].value;

            var xx= "nama" + j;        	
            opener.document.absen_siswa.tnama.value = aa.elements[xx].value;

            var ww= "kelas" + j;        	
            opener.document.absen_siswa.kelas.value = aa.elements[ww].value;

        	opener.document.absen_siswa.tnis.focus();
						...
						<div>
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
	                      	...
	                      	<?php
	    						...
	    						$sql=$selectview->get_siswa_presensi($nis, $nisn, $nama);
