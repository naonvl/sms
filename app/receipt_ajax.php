		 ...
		 <table id="simple-table" class="table table-striped table-bordered table-hover" />
			...
			<tbody>
				<?php 
					...
					if($row_receipt_detail->invoice_type == "iuran_siswa") {
						$transaction = "Iuran Siswa "." ".$row_receipt_detail->description;
					}
				...
				?>
					...
					<input type="hidden" id="departemen_<?php echo $no ?>" name="departemen_<?php echo $no ?>" value="<?php echo $row_receipt_detail->departemen; ?>" >
					<input type="hidden" id="departemen_sekolah_id_<?php echo $no ?>" name="departemen_sekolah_id_<?php echo $no ?>" value="<?php echo $row_receipt_detail->departemen_sekolah_id; ?>" >
					...
					<input type="hidden" id="discount_<?php echo $no; ?>" name="discount_<?php echo $no; ?>" style="text-align: right; width: 110px" class="form-control" onkeyup="formatangka('discount_<?php echo $no; ?>'), sub_totals('<?php echo $jmldata ?>')" readonly value="" >
					...
					<tr style="background-color:ffffff;"> 
						...
						<td align="center">
							<input type="checkbox" id="select_<?php echo $no; ?>" name="select_<?php echo $no; ?>" class="ace" onchange="cek_one('<?php echo $no ?>', '<?php echo $jmldata; ?>')" value="1" ><span class="lbl"></span>
						</td>
					...
					<!--<tr>
						...
						<td align="right">-->							
							<input type="hidden" id="round_amount" name="round_amount" class="form-control" onkeyup="formatangka('round_amount'), sub_totals('<?php echo $jmldata; ?>')" style="text-align: right; width: 110px" value="<?php echo $round_amount ?>">
						<!--</td>
						<td>&nbsp;</td>-->
					<!--</tr>
					...
					<tr>
						...
						<td align="right">-->							
							<input type="hidden" id="bank_charge" name="bank_charge" class="form-control" onkeyup="formatangka('bank_charge'), sub_totals('<?php echo $jmldata; ?>')" style="text-align: right; width: 110px" value="<?php echo $bank_charge ?>">
						<!--</td>
						<td>&nbsp;</td>
					</tr>-->
					
					<tr>
						<td align="right" colspan="1">Jumlah Terima :</td>
						<td align="center" id="amount2" colspan="1">
