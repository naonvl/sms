	...
	function cekinput(fid) {  
	  ...
	  for(i=0; i < arrf.length; i++) {
		...
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='idtahunajaran') {
		  ...
		  if (document.getElementById(arrf[i]).name=='tingkat_id') {
			alert('Tingkat tidak boleh kosong!');				
		  }
		  
		  if (document.getElementById(arrf[i]).name=='peminatan') {
		  ...
		  if (document.getElementById(arrf[i]).name=='kelompok_pelajaran_id') {
			alert('Kelompok Pelajaran tidak boleh kosong!');				
		  }
		  
		  if (document.getElementById(arrf[i]).name=='pelajaran_id') {
...
<script type="text/javascript">
	...
	function loadHTMLPost3(URL, destination, button, getId, getId1, getId2, getId3){
		dest = destination;	
		str = getId + '=' + document.getElementById(getId).value;		
		...
		var str = str + '&' + str1 + '&' + str2  + '&' + str3 + '&button=' + button;
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_kartu_rencana_studi.php");
				
				if ($ref != "") {
					$sql=$select->list_kartu_rencana_studi($ref);
					$row_kartu_rencana_studi=$sql->fetch(PDO::FETCH_OBJ);	
					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="kartu_rencana_studi" id="kartu_rencana_studi" enctype="multipart/form-data" onSubmit="return cekinput('idtahunajaran,departemen,tingkat_id,peminatan,semester_id,kelompok_pelajaran_id,pelajaran_id');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idtahunajaran" id="idtahunajaran" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_thnajaran($row_kartu_rencana_studi->idtahunajaran); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/kartu_rencana_studi_ajax.php','tingkat_idx','gettingkat_list','departemen')" >
							<option value=""></option>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3" id="tingkat_idx">
						<select name="tingkat_id" id="tingkat_id" class="chosen-select form-control"onchange="loadHTMLPost3('<?php echo $__folder ?>app/kartu_rencana_studi_ajax.php', 'kode_id', 'getdata', 'peminatan', 'tingkat_id', 'kelompok_pelajaran_id', 'urutan')"  >
							<option value=""></option>
							<?php select_tingkat_unit($departemen, $row_kartu_rencana_studi->tingkat_id); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="peminatan" id="peminatan" class="chosen-select form-control" onchange="loadHTMLPost3('<?php echo $__folder ?>app/kartu_rencana_studi_ajax.php', 'kode_id', 'getdata', 'peminatan', 'tingkat_id', 'kelompok_pelajaran_id', 'urutan')" >
							<option value=""></option>
							<?php select_peminatan2($row_kartu_rencana_studi->peminatan); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-lg-2">
						<select name="semester_id" id="semester_id" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_semester_all("SMA", $row_kartu_rencana_studi->semester_id); ?>
						</select>
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-4">
						<select name="kelompok_pelajaran_id" id="kelompok_pelajaran_id" class="chosen-select form-control" onchange="loadHTMLPost3('<?php echo $__folder ?>app/kartu_rencana_studi_ajax.php', 'kode_id', 'getdata', 'peminatan', 'tingkat_id', 'kelompok_pelajaran_id', 'urutan')" >
							<option value=""></option>
							<?php select_kelompok_pelajaran($row_kartu_rencana_studi->kelompok_pelajaran_id); ?>
						</select>
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Kode Mata Pelajaran</label>
					<div class="col-sm-2">
						<input type="text" id="pelajaran_kode" name="pelajaran_kode" class="form-control" value="<?php echo $row_kartu_rencana_studi->pelajaran_kode ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-4">
						<select name="pelajaran_id" id="pelajaran_id" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_pelajaran_all($row_kartu_rencana_studi->pelajaran_id); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jumlah SKS</label>
					<div class="col-sm-2">
						<input type="text" id="sks" name="sks" class="form-control" onkeyup="formatangka('sks')" value="<?php echo $row_kartu_rencana_studi->sks ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" id="urutan" name="urutan" class="form-control" onkeyup="formatangka('urutan'), loadHTMLPost3('<?php echo $__folder ?>app/kartu_rencana_studi_ajax.php', 'kode_id', 'getdata', 'peminatan', 'tingkat_id', 'kelompok_pelajaran_id', 'urutan')" value="<?php echo number_format($row_kartu_rencana_studi->urutan,0,'.',',') ?>">
					</div>
				</div>

				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Kode Rapor Smt Ganjil</label>
					<div class="col-sm-4">
						<div class="input-group" id="kode_id">
							<input type="text" id="kode1" name="kode1" class="form-control" value="<?php echo $row_kartu_rencana_studi->kode1 ?>">							
							<span class="input-group-addon">
							Smt Genap
							</span>							
							<input type="text" id="kode2" name="kode2" class="form-control" value="<?php echo $row_kartu_rencana_studi->kode2 ?>">
						</div>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmkartu_rencana_studi')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmkartu_rencana_studi')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Simpan" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frmkartu_rencana_studi')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('kartu_rencana_studi_view') ?>'" />
