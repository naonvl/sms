	...
	function cekinput(fid) {  
	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='gugus') {
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_gugus.php");
				
				if ($ref != "") {
					$sql=$select->list_gugus($ref);
					$row_gugus=$sql->fetch(PDO::FETCH_OBJ);	
					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="gugus" id="gugus" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('gugus');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/general_ajax.php','sekolah_id','getsekolah','departemen')" >
							<option value=""></option>
							<?php select_departemen($row_gugus->departemen); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4" id="sekolah_id">
						<select name="departemen_sekolah_id" id="departemen_sekolah_id" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/general_ajax.php','kelas_id','getkelas_unit_sekolah','departemen_sekolah_id')">
							<option value=""></option>
							<?php select_sekolah_unit($row_gugus->departemen, $row_gugus->departemen_sekolah_id); ?>
						</select>
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="gugus" name="gugus" class="form-control" value="<?php echo $row_gugus->gugus ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="kapasitas" name="kapasitas" class="form-control" value="<?php echo $row_gugus->kapasitas ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jumlah Laki-Laki</label>
					<div class="col-sm-3">
						<input type="text" id="kapasitas_l" name="kapasitas_l" class="form-control" value="<?php echo $row_gugus->kapasitas_l ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jumlah Perempuan</label>
					<div class="col-sm-3">
						<input type="text" id="kapasitas_p" name="kapasitas_p" class="form-control" value="<?php echo $row_gugus->kapasitas_p ?>">
					</div>
				</div>
               ...
               <div class="space-4"></div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmgugus')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmgugus')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Simpan" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frmgugus')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('gugus_view') ?>'" />
