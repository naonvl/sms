		...
		<form role="form" action="" method="post" name="dashboard_sales" id="dashboard_sales" enctype="multipart/form-data">
			...
			<table>
				<tr>
					...
					<td align="center" colspan="2" style="font-weight: bold;">Jumlah Pengunjung Perpustakaan</td>
				</tr>
				<tr>
			...
			while ($row_tingkat=$sql1->fetch(PDO::FETCH_OBJ)) {
				$sqlstr2 = "select count(a.replid) count_surat, month(a.tanggal), a.tanggal from kunjungan_perpustakaan a  group by month(a.tanggal) having year(a.tanggal)='$tahun' and month(a.tanggal)='$row_tingkat->kode'";
			...
			<script type="text/javascript">
				AmCharts.ready(function () {
					...
					chart.dataProvider = chartData_pengunjung;
					...
					valueAxis.title = "Jumlah Pengunjung per Bulan";
					...
					// WRITE
					chart.write("chartdiv_pengunjung");
				});
			</script>

			<div id="chartdiv_pengunjung" style="width: 100%; height: 300px;"></div>
