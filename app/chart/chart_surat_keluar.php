		...
		<form role="form" action="" method="post" name="dashboard_sales" id="dashboard_sales" enctype="multipart/form-data">
			...
			<table width="40%">
				<tr>
					...
					<td align="center" colspan="2" style="font-weight: bold;">Jumlah Surat Keluar</td>
				</tr>
				<tr>
			...
			while ($row_tingkat=$sql1->fetch(PDO::FETCH_OBJ)) {
				$sqlstr2 = "select count(a.ref) count_surat, month(a.tanggal), a.tanggal from surat_keluar a group by month(a.tanggal) having year(a.tanggal)='$tahun' and month(a.tanggal)='$row_tingkat->kode'";
			...
			<script type="text/javascript">
				AmCharts.ready(function () {
					...
					valueAxis.title = "Jumlah Surat Keluar per Bulan";
					...
					// WRITE
					chart.write("chartdiv_surat_keluar");
				});
			</script>

			<div id="chartdiv_surat_keluar" style="width: 100%; height: 300px;"></div>
