		...
		<form role="form" action="" method="post" name="dashboard_sales" id="dashboard_sales" enctype="multipart/form-data">
			...
			<table>
				<tr>
					...
					<td align="center" colspan="2" style="font-weight: bold;">Jumlah Buku yang sering Dipinjam</td>
				</tr>
				<tr>
			...
			$sqlstr="select a.kodepustaka, a.kodepustaka name from daftarpustaka a left join pustaka b on a.pustaka=b.replid order by b.judul";
			$sql1 = $dbpdo->query($sqlstr);
			while ($row_tingkat=$sql1->fetch(PDO::FETCH_OBJ)) {
				$sqlstr2 = "select count(a.kodepustaka) count_surat, month(a.tglpinjam), a.tglpinjam, a.kodepustaka from pinjam a  group by a.kodepustaka having year(a.tglpinjam)='$tahun' and a.kodepustaka='$row_tingkat->kodepustaka'";
			...
			<script type="text/javascript">
				AmCharts.ready(function () {
					...
					chart.dataProvider = chartData_rating;
					...
					valueAxis.title = "Buku yang Sering Dipinjam";
			...
			<div id="chartdiv_rating" style="width: 100%; height: 300px;"></div>
