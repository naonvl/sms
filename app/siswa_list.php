...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('siswa_list') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>

<script>
	function siswa_excel() {
		...
		document.location.href = 'app/siswa_xls.php?idtingkat2='+idtingkat2+'&idkelas2='+idkelas2+'&kelamin='+kelamin+'&all='+all+'&nama2='+nama2+'&nis='+nis+'&nik='+nik+'';
	}
</script>
...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo obraxabrix('siswa_list') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			?>
                    ...
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('siswa_list') ?>" />
			<?php
				...
				<div class="col-xs-12">
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="font-size: 12px">
							...
							<tbody>
                                <?php			
									$sql=$selectview->list_siswa($nis, '', $idtingkat2, $idkelas2, $nama2, $all, $departemen, $nik, $kelamin, '', '', '', '', $departemen_sekolah_id);
