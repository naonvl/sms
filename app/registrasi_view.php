...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('registrasi_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
                                        ...
                                        <tr>
											...
											<td>
												<?php if (allowupd('frmregistrasi')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('registrasi') ?>/<?php echo $registrasi_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmregistrasi')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $registrasi_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
