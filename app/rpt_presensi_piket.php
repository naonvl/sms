						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$total = 0;													
									$sql=$selectview->rpt_presensi_piket($daritgl, $ketgl, $nis, $nama);												
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td> 
                                            <td><?php echo $rpt_presensi_harian_siswa_view->nip ?></td>
											<td><?php echo $rpt_presensi_harian_siswa_view->nama ?></td>
											<td><?php echo $rpt_presensi_harian_siswa_view->tanggal ?></td>
