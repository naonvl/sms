	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='tingkat') {
			alert('Tingkat/Level tidak boleh kosong!');				
		  }
		  
		  if (document.getElementById(arrf[i]).name=='tanggal_ttd') {
			alert('Titimangsa Raport tidak boleh kosong!');				
		  }
		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_tingkat=$sql->fetch(PDO::FETCH_OBJ);	
					
					$tanggal_ttd = date("d-m-Y", strtotime($row_tingkat->tanggal_ttd));
					if($tanggal_ttd == "01-01-1970") {
						$tanggal_ttd = "";
					}
					
					if ($row_tingkat->aktif == 1) {
						$act = "checked";
					} else {
						$act = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="tingkat" id="tingkat" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('departemen,tingkat,tanggal_ttd');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_ajax.php','sekolah_id','getsekolah','departemen')" >
							<option value=""></option>
							<?php select_departemen($row_tingkat->departemen); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4" id="sekolah_id">
						<select name="departemen_sekolah_id" id="departemen_sekolah_id" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_ajax.php','kelas_id','getkelas','departemen_sekolah_id')">
							<option value=""></option>
							<?php select_sekolah_unit($row_tingkat->departemen, $row_tingkat->departemen_sekolah_id); ?>
						</select>
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="tingkat" name="tingkat" class="form-control" value="<?php echo $row_tingkat->tingkat ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Titimangsa Raport *)</label>
					<div class="col-sm-3">
						<input type="text" id="tanggal_ttd" name="tanggal_ttd" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $tanggal_ttd ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $row_tingkat->keterangan ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="aktif" id="aktif" value="1" <?php if($row_tingkat->aktif==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
	            ...
	            <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="urutan" name="urutan" class="form-control" value="<?php echo $row_tingkat->urutan ?>">
					</div>
				</div>
