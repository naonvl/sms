...
<script>
    function submitForm(tipe)
    {
		...
		if(tipe == 'print') {
			...
			$("#rpt_konseling_siswa").attr('action', '<?= $__folder ?>app/rpt_konseling_siswa_print.php')
			   .attr('target', '_BLANK');
			$("#rpt_konseling_siswa").submit();
			
		} 
		
		if(tipe == 'find') {
			$("#rpt_konseling_siswa").attr('action', '')
				.attr('target', '_self');
			$("#rpt_konseling_siswa").submit();
		}
		
		if(tipe == 'excel') {
			$("#rpt_konseling_siswa").attr('action', 'app/rpt_konseling_siswa_xls.php')
			   .attr('target', '_BLANK');
			$("#rpt_konseling_siswa").submit();
		}
				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="siswa_lis" id="siswa_list" enctype="multipart/form-data" >
		            	...
		            	<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="daritgl" name="daritgl" class="form-control date-picker" data-date-format="dd-mm-yyyy" value="<?php echo $daritgl ?>">					
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tanggal</label>
							<div class="col-sm-3">
								<input type="text" id="ketgl" name="ketgl" class="form-control date-picker" data-date-format="dd-mm-yyyy" value="<?php echo $ketgl ?>">		
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onchange="loadHTMLPost2('app/rpt_konseling_siswa_ajax.php','kelas_id','getkelas','idtingkat')" />
									<option value=""></option>
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									...
									$sql=$selectview->list_rpt_konseling_siswa($daritgl, $ketgl, $idtingkat, $idkelas, $nama, $all, $departemen);			
