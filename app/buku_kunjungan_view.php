<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('buku_kunjungan_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
...
<div class="page-content">		
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="buku_kunjungan_view1" id="buku_kunjungan_view1" enctype="multipart/form-data" >
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_buku_kunjungan($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <!--<meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('buku_kunjungan_view') ?>" />-->
			<?php
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="font-size: 12px">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_buku_kunjungan("", $from_date, $to_date, $all);
						            while($buku_kunjungan_view=$sql->fetch(PDO::FETCH_OBJ)){
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $buku_kunjungan_view->tanggal ?></td>
											<td><?php echo $buku_kunjungan_view->nama ?></td>
											<td><?php echo $buku_kunjungan_view->instansi ?></td>
											<td><?php echo $buku_kunjungan_view->telepon ?></td>
											<td><?php echo $buku_kunjungan_view->keperluan ?></td>
											<td><?php echo $buku_kunjungan_view->kesan_pesan ?></td>                                 
                                            <td><?php echo $buku_kunjungan_view->keterangan ?></td>								
											<td align="center">
                                            
                                                <?php if (allowupd('frmbuku_kunjungan')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('buku_kunjungan') ?>/<?php echo $buku_kunjungan_view->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmbuku_kunjungan')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $buku_kunjungan_view->ref ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
