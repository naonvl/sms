...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="<?php echo $nama_folder ?>/<?php echo obraxabrix('presensi_ukbm') ?>" method="post" name="siswa_list" id="siswa_list" enctype="multipart/form-data" >
