...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('guru_absen_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_guru_absen($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <!--<meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('guru_absen_view') ?>" />-->
			<?php
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="guru_absen_view" id="guru_absen_view" enctype="multipart/form-data" >
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th style="font-weight:bold ">Penyelesaian tugas guru ybs &nbsp;&nbsp;</th>
									<th>Edit/Hapus</th>	
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_guru_absen("", $tanggal, $idguru, $idtingkat, $kelas, $all);
						            while($guru_absen_view=$sql->fetch(PDO::FETCH_OBJ)){
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
											<td><?php echo date("d-m-Y", strtotime($guru_absen_view->tanggal)) ?></td>
											<td><?php echo $guru_absen_view->nip . ' ' .$guru_absen_view->nama_guru ?></td>
											<td><?php echo $guru_absen_view->tingkat ?></td>
											<td><?php echo $guru_absen_view->kelas ?></td>
											<td><?php echo $guru_absen_view->alasan ?></td>
											<td><?php echo $guru_absen_view->tugas ?></td>
											<td align="center">
                                            
                                                <?php if (allowupd('frmguru_absen')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('guru_absen') ?>/<?php echo $guru_absen_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmguru_absen')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $guru_absen_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
