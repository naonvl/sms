	...
	function cekinput(fid) {  
	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  /*if (document.getElementById(arrf[i]).name=='idminat') {
			alert('Peminatan harus dipilih!');				
		  }*/
		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					if($_SESSION["adm"] == 1 || allowlvl("frmsiswa") == 2) {
						$readonly = "";
					} 
				}		
			?>
							...
							<div class="widget-main">
								<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<?php if( $_SESSION["adm"] == 1 || allowlvl("frmsiswa") == 2 ) { ?>
												<?php if($ref == "") { ?>
													<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_ajax.php','sekolah_id','getsekolah','departemen')" >
														<option value=""></option>
														<?php select_departemen($row_siswa->departemen); ?>
													</select>
												<?php } else { ?>
													<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_ajax.php','tingkat_id','gettingkat_upd','departemen')" >
														<option value=""></option>
														<?php select_departemen($row_siswa->departemen); ?>
													</select>
												<?php } ?>	
											<?php } else { ?>
												...
												<input type="hidden" name="departemen" id="departemen" value="<?php echo $row_siswa->departemen ?>"/>
											<?php } ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6" id="sekolah_id">
											<select name="departemen_sekolah_id" id="departemen_sekolah_id" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_ajax.php','kelas_id','getkelas_unit_sekolah','departemen_sekolah_id')">
												<option value=""></option>
												<?php select_sekolah_unit($row_siswa->departemen, $row_siswa->departemen_sekolah_id); ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<?php } else { ?>
												<select name="idangkatan2" id="idangkatan2" disabled="" class="chosen-select form-control" >
													<option value=""></option>
													<?php select_thnajaran($row_siswa->idangkatan); ?>
												</select>
												<input type="hidden" name="idangkatan" id="idangkatan" value="<?php echo $row_siswa->idangkatan ?>"/>
											<?php } ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<?php } else { ?>
												<select name="idangkatan12" id="idangkatan12" disabled="" class="chosen-select form-control" >
													<option value=""></option>
													<?php select_angkatan($row_siswa->idangkatan1); ?>
												</select>
												<input type="hidden" name="idangkatan1" id="idangkatan1" value="<?php echo $row_siswa->idangkatan1 ?>"/>
											<?php } ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6" id="nis_id">
											<?php if($ref == '') { ?>
												<input type="text" id="nis" name="nis" class="form-control" onblur="loadHTMLPost3('<?php echo $__folder ?>app/siswa_nis_ajax.php','nis_id','ceknis','replid','nis')" <?php echo $readonly ?> value="<?php echo $row_siswa->nis ?>">
											<?php } else { ?>
												<input type="text" id="nis" name="nis" class="form-control" onblur="loadHTMLPost3('<?php echo $__folder ?>app/siswa_nis_ajax_update.php','nis_id','ceknis','replid','nis')" <?php echo $readonly ?> value="<?php echo $row_siswa->nis ?>">
											<?php } ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6" id="nisn_id">
											<?php if($ref == '') { ?>
												<input type="text" id="nisn" name="nisn" class="form-control" onblur="loadHTMLPost3('<?php echo $__folder ?>app/siswa_nis_ajax.php','nisn_id','ceknisn','replid','nisn')" <?php echo $readonly ?> value="<?php echo $row_siswa->nisn ?>">
											<?php } else { ?>
												<input type="text" id="nisn" name="nisn" class="form-control" onblur="loadHTMLPost3('<?php echo $__folder ?>app/siswa_nis_ajax_update.php','nisn_id','ceknisn','replid','nisn')" <?php echo $readonly ?> value="<?php echo $row_siswa->nisn ?>">
											<?php } ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" id="nama" name="nama" class="form-control" onKeyup="this.value=this.value.toUpperCase()" <?php echo $readonly ?> value="<?php echo $row_siswa->nama ?>">
										</div>
									</div>
									...
									<?php if($_SESSION["tipe_user"] != "Siswa") { ?>
										<div class="form-group">
											...
											<div class="col-sm-6" id="tingkat_id">
												<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_ajax.php','kelas_id','getkelas','idtingkat')" >
													<option value=""></option>
													<?php 
														//select_tingkat($row_siswa->idtingkat); 
														select_tingkat_unit($row_siswa->departemen, $row_siswa->idtingkat);
													?>
												</select>
											</div>
										</div>
									...
									<?php } else { ?>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tanggal diterima</label>
											<div class="col-sm-6">
												<input type="text" id="tglmasuk" name="tglmasuk" readonly="" value="<?php echo $tglmasuk ?>">
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jenis Kelamin</label>
											<div class="col-sm-6">
												<select name="kelamin2" id="kelamin2" disabled="" class="chosen-select form-control" >
													<option value=""></option>
													<?php select_kelamin($row_siswa->kelamin); ?>
												</select>
											</div>
										</div>
										<input type="hidden" id="kelamin" name="kelamin"  value="<?php echo $row_siswa->kelamin ?>">
									<?php } ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											...
											<?php } else { ?>
												<select name="provinsi_kode" id="provinsi_kode" class="chosen-select form-control" onChange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_update_ajax.php','kota','getkota','provinsi_kode')" />
					                        	<option value=""></option>
												<?php select_provinsi($row_siswa->provinsi_kode); ?>
											</select>
											<?php } ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											...
											(Lainnya sebutkan)
											<input type="text" name="transportasi_lain" id="transportasi_lain" sclass="form-control" value="<?php echo $row_siswa->transportasi; ?>" >
										</div>
									</div>
									...
									<?php } else { ?>
										<input type="hidden" name="aktif" id="aktif" value="<?php echo $row_siswa->aktif ?>"/>
									<?php } ?>
								</div>
							</div>
						</div>
									...
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												...
												<?php } else { ?>
													<select name="idminat2" id="idminat2" disabled="" class="chosen-select form-control" >
														<option value=""></option>
														<?php select_peminatan($row_siswa->idminat); ?>
													</select>
													<input type="hidden" name="idminat" id="idminat" value="<?php echo $row_siswa->idminat ?>" />
												<?php } ?>
											</div>
										</div>
										...
										<input type="hidden" name="jalurmasuk_id" id="jalurmasuk_id" value="<?php echo $row_siswa->jalurmasuk_id ?>" />
										
										<div class="form-group">
											<!--<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jalur Masuk Prestasi</label>-->
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jalur Masuk Tahap Pertama</label>
											<div class="col-sm-6">
												<select name="jalurmasukprestasi_id" id="jalurmasukprestasi_id" class="chosen-select form-control" >
													<option value=""></option>
													<?php 
														//populate_select("jalurmasuk_prestasi", "replid", "nama", $row_siswa->jalurmasukprestasi_id); 
														combo_select_active("jalurmasuk_prestasi", "replid", "nama", "aktif", "1", $row_siswa->jalurmasukprestasi_id); 
													?>
												</select>
											</div>
										</div>
								...
								<div class="widget-main">
									<div class="row">				
										...
										<!--<div class="form-group">
											...
											<div class="col-sm-6">-->
												<input type="hidden" id="skhun" name="skhun" class="form-control" value="<?php echo $row_siswa->skhun ?>">
											<!--</div>
										</div>-->
										...
										<input type="hidden" id="tahunskhun" name="tahunskhun" class="form-control" value="<?php echo $row_siswa->tahunskhun ?>">
										
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1">No Ujian Nasional</label>
											<div class="col-sm-6">
												<input type="text" id="noujian" name="noujian" class="form-control" value="<?php echo $row_siswa->noujian ?>">
											</div>
										</div>
