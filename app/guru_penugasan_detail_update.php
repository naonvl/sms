        ...
        <table id="simple-table" class="table table-striped table-bordered table-hover">
            ...
            <thead>
        		<tr>            
        			<?php
        				$idtingkat = array();
        				$sql=$select->list_tingkat("", $departemen);
		                			...
		                			<table>
					                    <?php         
							            	...
							            	while($row_guru_penugasan=$sql->fetch(PDO::FETCH_OBJ)) { 
							            		...
							            		$sqlkelas = $select->get_guru_penugasan_kelas($idtahunajaran, $idguru, $idtingkat[$no], $row_guru_penugasan->replid);
							            		$datakelas = $sqlkelas->fetch(PDO::FETCH_OBJ);
							            		
							            		$pilihkelas = "";
							            		if($datakelas->idkelas != "") {
													$pilihkelas = "checked";
												}
							            ...
							            ?>
							            	<tr style="background-color:ffffff;"> 
						        				<td width="200">
						        					...
						        					<input type="checkbox" class="ace" id="pilihkelas_<?php echo $no.$x; ?>" name="pilihkelas_<?php echo $no.$x; ?>" <?php echo $pilihkelas ?> value="1" ><span class="lbl"></span>
						        				</td>
						        			</tr>
