<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('evaluasi_psikologi_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_evaluasi_psikologi($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $nama_folder . '/' . obraxabrix('evaluasi_psikologi_view'); ?>" />
			<?php
									...
									<tr>
										...
										<td>
                                            ...
                                            <?php if (allowupd('frmevaluasi_psikologi')==1) { ?>
												<a href="<?php echo $__folder ?><?php echo obraxabrix('evaluasi_psikologi') ?>/<?php echo $evaluasi_psikologi_view->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
													<span class="green">
                                            ...
                                            <?php if (allowdel('frmevaluasi_psikologi')==1) { ?>    
                                                &nbsp;
												<a href="JavaScript:hapus('<?php echo $evaluasi_psikologi_view->ref ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
													<span class="red">
