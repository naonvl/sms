	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form action="" method="post" name="aspek_psikologi" id="aspek_psikologi" class="form-horizontal" onSubmit="return cekinput('departemen,aspek');">
            	...
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Aspek Psikologi *)</label>
					<div class="col-sm-3">
						<input type="text" name="aspek" id="aspek" class="form-control" value="<?php echo $aspek_psikologi_data->aspek ?>">
					</div>
				</div>
