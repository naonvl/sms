...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('siswa_izin_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_siswa_izin($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('siswa_izin_view') ?>" />
			<?php
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="siswa_izin_view" id="siswa_izin_view" enctype="multipart/form-data" >
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_siswa_izin("", $tanggal, $idsiswa, $idtingkat, $kelas, $all, $departemen);
						            while($siswa_izin_view=$sql->fetch(PDO::FETCH_OBJ)){
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
											<td><?php echo date("d-m-Y", strtotime($siswa_izin_view->tanggal)) ?></td>
											<td><?php echo $siswa_izin_view->departemen ?></td>
											<td><?php echo $siswa_izin_view->nis . ' ' .$siswa_izin_view->nama_siswa ?></td>
											<td><?php echo $siswa_izin_view->tingkat ?></td>
											<td><?php echo $siswa_izin_view->kelas ?></td>
											<td><?php echo $siswa_izin_view->alasan ?></td>
											<td><?php echo $siswa_izin_view->penanganan ?></td>
											<td align="center">
                                            
                                                <?php if (allowupd('frmsiswa_izin')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('siswa_izin') ?>/<?php echo $siswa_izin_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmsiswa_izin')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $siswa_izin_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
