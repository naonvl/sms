	...
	function cekinput(fid) {  
		...
		for(i=0; i < arrf.length; i++) {
			if(document.getElementById(arrf[i]).value=='') {       
			  ...
			  if (document.getElementById(arrf[i]).name=='hari') {
...
<script type="text/javascript">
	...
	function loadHTMLPost2(URL, destination, button, getId, getId1, getId2, getId3){
		dest = destination;	
		str = getId + '=' + document.getElementById(getId).value;	
		str2 = getId1 + '=' + document.getElementById(getId1).value;
		str3 = getId2 + '=' + document.getElementById(getId2).value;
		str4 = getId3 + '=' + document.getElementById(getId3).value;	
		var str = str + '&' + str2 + '&' + str3 + '&' + str4 + '&button=' + button;
...
<script type="text/javascript">
	function jadwal_input(hari, idtingkat, idkelas, idguru, idjam, departemen) {
		window.open("app/jadwal_input.php?hari="+hari+"&idtingkat="+idtingkat+"&idkelas="+idkelas+"&idguru="+idguru+"&idjam="+idjam+"&departemen="+departemen,"Find","width=500,height=620,left=50,top=10,toolbar=0,status=0,scroll=1,scrollbars=no");
	}
	
	function jadwal_update(hari, idtingkat, idkelas, idguru, idjam, idjadwal, departemen) {
		window.open("app/jadwal_update.php?hari="+hari+"&idtingkat="+idtingkat+"&idkelas="+idkelas+"&idguru="+idguru+"&idjam="+idjam+"&idjadwal="+idjadwal+"&departemen="+departemen,"Find","width=500,height=620,left=50,top=10,toolbar=0,status=0,scroll=1,scrollbars=no");
	}
</script>            
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="jadwal" id="jadwal" enctype="multipart/form-data" onSubmit="return cekinput('hari,idtingkat');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('app/jadwal_ajax.php','jadwal_jam','getjadwal','hari','idtingkat','idguru','departemen')">
							<option value=""></option>
							<?php select_departemen($row_jadwal->departemen); ?>
						</select>
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-4">
						<select name="hari" id="hari" class="chosen-select form-control" onchange="loadHTMLPost2('app/jadwal_ajax.php','jadwal_jam','getjadwal','hari','idtingkat','idguru','departemen')" >
							<option value=""></option>
							<?php select_hari($row_jadwal->hari); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onchange="loadHTMLPost2('app/jadwal_ajax.php','jadwal_jam','getjadwal','hari','idtingkat','idguru','departemen')" >
							<option value=""></option>
							<?php select_tingkat($row_jadwal->idtingkat); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<select name="idguru" id="idguru" class="chosen-select form-control" onchange="loadHTMLPost2('app/jadwal_ajax.php','jadwal_jam','getjadwal','hari','idtingkat','idguru','departemen')" >
							<option value=""></option>
							<?php select_petugas($idguru); ?>
						</select>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php /*if (allowupd('frmjadwal')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmjadwal')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Simpan" />
    						<?php } ?>
                        <?php }*/ ?>
                        
                        <?php /*if (allowdel('frmjadwal')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('jadwal_view') ?>'" />
