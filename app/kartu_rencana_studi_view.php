...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('kartu_rencana_studi_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
...
<div class="page-content">		
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="kartu_rencana_studi" id="kartu_rencana_studi" enctype="multipart/form-data" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3" id="tingkat_idx">
						<select name="tingkat_id" id="tingkat_id" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_tingkat_unit($departemen, $tingkat_id); ?>
						</select>
					</div>
				</div>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_kartu_rencana_studi($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <!--<meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('kartu_rencana_studi_view') ?>" />-->
			<?php
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="font-size: 12px">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_kartu_rencana_studi("", $kelompok_pelajaran_id, $tingkat_id, $semester_id, $peminatan, $idtahunajaran, '', '', $departemen);
						            while($kartu_rencana_studi_view=$sql->fetch(PDO::FETCH_OBJ)){
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $kartu_rencana_studi_view->departemen ?></td>
                                            <td><?php echo $kartu_rencana_studi_view->nama_tahunajaran ?></td>
                                            <td><?php echo $kartu_rencana_studi_view->tingkat ?></td>
											<td><?php echo $kartu_rencana_studi_view->peminatan ?></td>
											<td><?php echo $kartu_rencana_studi_view->semester ?></td>
											<td><?php echo $kartu_rencana_studi_view->kelompok_pelajaran ?></td>
											<td><?php echo $kartu_rencana_studi_view->nama_pelajaran ?></td>
											<td><?php echo $kartu_rencana_studi_view->kode ?></td>
											<td><?php echo $kartu_rencana_studi_view->sks ?></td>
											<td><?php echo $kartu_rencana_studi_view->kode1.'/'.$kartu_rencana_studi_view->kode2 ?></td>
											<td><?php echo $kartu_rencana_studi_view->urutan ?></td>
											<td align="center">
                                            
                                                <?php if (allowupd('frmkartu_rencana_studi')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('kartu_rencana_studi') ?>/<?php echo $kartu_rencana_studi_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmkartu_rencana_studi')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $kartu_rencana_studi_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
