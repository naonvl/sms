<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('assesmen_observasi_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_assesmen_observasi($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('assesmen_observasi_view') ?>" />
			<?php
									...
									<tr>
										...
										<td align="center">
                                            ...
                                            <?php if (allowupd('frmassesmen_observasi')==1) { ?>
												<a href="<?php echo $__folder ?><?php echo obraxabrix('assesmen_observasi') ?>/<?php echo $assesmen_observasi_view->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
													<span class="green">
                                            ...
                                            <?php if (allowdel('frmassesmen_observasi')==1) { ?>    
                                                &nbsp;
												<a href="JavaScript:hapus('<?php echo $assesmen_observasi_view->ref ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
													<span class="red">
