<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			//document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('material_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('material_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
...
<script type="text/javascript">
	function excel_export() {
		...
		var all1						=	document.getElementById('all').checked;
		...
		document.location.href = "app/material_xls.php?code="+code+"&old_code="+old_code+"&name="+name+"&item_group_id="+item_group_id+"";	
	}
</script>
...
<div class="page-content">		
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="material_view" id="material_view" class="form-horizontal" enctype="multipart/form-data" >
            	
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Kode System</label>
					<div class="col-lg-3">
				...
				<div class="form-group">
					...
					<div class="col-lg-4">
						<select id="name" name="name" class="chosen-select form-control" style="width: auto">
	                        <option value=""></option>
	                        <?php 
	                        	combo_select_active("item","syscode","name","active","1",$name)
	                        ?>	                            
                      </select>
					</div>
				</div>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					//$delete2->delete_material($segmen4);
			...
			?>
                    ...
                    <meta http-equiv="Refresh" content="0;url=<?php echo $nama_folder . '/' . obraxabrix('material_view'); ?>" />
			<?php
                    	...
                    	<td align="center">
											...
											<td>
                                                ...
                                                <?php if (allowupd('frmmaterial')==1) { ?>
    												<a href="<?php echo obraxabrix('material') ?>/<?php echo $row_item->syscode ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
