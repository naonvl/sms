...
while($datadimensi = $sqldimensi->fetch(PDO::FETCH_OBJ)) {
		//if($id_elemen == "") {
	      ...
	      /*} else {
	      	$id_elemen = $id_elemen.','.$row_elemen->iddesk;
	      }*/

		$dimensi = $datadimensi->dimensi;
		$output .= $rowsdimensi.'>>>><br>'.'<tr style="font-weight: bold">
...
$document->stream("Rapor_P5_Siswa_".$nisn_siswa, array("Attachment"=>0));
//1  = Download
//0 = Preview
