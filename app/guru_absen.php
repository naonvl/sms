	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_guru_absen.php");
				
				$tanggal = date("d-m-Y");
				
				if ($ref != "") {
					$sql=$select->list_guru_absen($ref);
					$guru_absen_data=$sql->fetch(PDO::FETCH_OBJ);	
					
					$tanggal = date("d-m-Y", strtotime($guru_absen_data->tanggal));					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="guru_absen2" id="guru_absen2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tanggal,idguru,idtingkat,idkelas');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-5">						
						<select name="idguru" id="idguru" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_petugas($guru_absen_data->idguru) ?>
						</select>						
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/siswa_ajax.php','tingkat_id','gettingkat','departemen')" >
							<option value=""></option>
							<?php select_departemen($guru_absen_data->departemen); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3" id="tingkat_id">
						<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onchange="loadHTMLPost3('<?php echo $__folder ?>app/presensi_ukbm_ajax.php','kelas_id','getkelas','idtingkat')" >
							<option value=""></option>
							<?php select_tingkat_unit($departemen, $guru_absen_data->idtingkat); ?>
						</select>			
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3" id="kelas_id">
						<select name="idkelas" id="idkelas" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_kelas($guru_absen_data->idtingkat, $guru_absen_data->idkelas); ?>
						</select>								
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<textarea id="alasan" name="alasan" class="form-control"><?php echo $guru_absen_data->alasan ?></textarea>
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Penyelesaian tugas guru ybs</label>
					<div class="col-sm-5">
						<textarea id="tugas" name="tugas" class="form-control"><?php echo $guru_absen_data->tugas ?></textarea>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmguru_absen')==1) { ?>
    						<?php if($ref=='') { ?>
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('guru_absen_view') ?>'" />
