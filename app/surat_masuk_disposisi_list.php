					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="font-size: 12px">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->get_surat_masuk_outstanding("", $from_date, $to_date, $idkelompok_surat, $all);
								...
								?>
                                        ...
                                        <tr>
											...
											<td align="center">
                                                ...
                                                <?php if (allowupd('frmsurat_masuk_disposisi')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('surat_masuk_disposisi') ?>/<?php echo $surat_masuk_view->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
