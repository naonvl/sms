...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/rpt_presensi_harian_siswa_xls.php?departemen="+departemen+"&daritgl="+daritgl+"&ketgl="+ketgl+"&idtingkat="+idtingkat+"&nama="+nama+"&idkelas="+idkelas+"&departemen_sekolah_id="+departemen_sekolah_id+"";
	}
</script>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		.dataTable( {
			...
			"aoColumns": [
			  { "bSortable": false },
			  null, null, null, null, null, null, null, null, null, null, null, null, //kalau nambah kolom, null ditambahkan
			  { "bSortable": false }
			],
			"aaSorting": [],
