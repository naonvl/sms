...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix(alumni_view) ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_alumni($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <!--<meta http-equiv="Refresh" content="0;url=main.php?menu=app&act=<?php echo obraxabrix('alumni_view') ?>" />-->
			<?php
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="alumni_list" id="alumni_list" enctype="multipart/form-data" >
		            	...
		            	<div class="form-group">
		                    ...
		                    <div class="col-sm-3">
		                    	 <input type="text" name="tahunmasuk" id="tahunmasuk" class="form-control" value="<?php echo $tahunmasuk ?>">
							</div>
		                    
						</div>
						
						<div class="form-group">
		                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nama Alumni</label>
		                    <div class="col-sm-3">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tanggal Lulus</label>
							<div class="col-sm-3">
								<input type="text" name="tgllulus" id="tgllulus" class="form-control date-picker" data-date-format="dd-mm-yyyy" value="<?php echo $tgllulus ?>">								
							</div>
						</div>
				...
				<div class="col-xs-12">
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$sql=$selectview->list_alumni('', $departemen, $idangkatan1, $tahunmasuk, $tgllulus, $nama, $all, $departemen_sekolah_id);
								...
								?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $alumni_view->nama_sekolah ?></td>
                                            ...
                                            <td align="center">
                                                ...
                                                <?php if (allowupd('frmalumni')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('alumni') ?>/<?php echo $alumni_view->idsiswa ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
