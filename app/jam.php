	...
	function cekinput(fid) {  
	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='jamke') {
			alert('Jam-ke tidak boleh kosong!');				
		  }
		  
		  if (document.getElementById(arrf[i]).name=='jam1') {
			alert('Jam ke-1 tidak boleh kosong!');				
		  }
		  
		  if (document.getElementById(arrf[i]).name=='jam2') {
			alert('Jam ke-2 tidak boleh kosong!');				
		  }
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_jam.php");
				
				$act = "checked";
				if ($ref != "") {
					$sql=$select->list_jam($ref);
					$row_jam=$sql->fetch(PDO::FETCH_OBJ);	
					
					$ref2	=	$row_jam->replid;		
					
					$jam1	=	date("H:i", strtotime($row_jam->jam1));
					$jam2	=	date("H:i", strtotime($row_jam->jam2));
					
					$istirahat = "";
					if($row_jam->istirahat == 1) {
						$istirahat = "checked";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="jam" id="jam" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('jam');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_departemen($row_jam->departemen); ?>
						</select>
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" id="jamke" name="jamke" class="form-control" autocomplete="off" value="<?php echo $row_jam->jamke ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" id="jam1" name="jam1" class="form-control" autocomplete="off" value="<?php echo $jam1 ?>">
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" id="jam2" name="jam2" class="form-control" autocomplete="off" value="<?php echo $jam2 ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="checkbox" id="istirahat" name="istirahat" class="ace" value="1" <?php echo $istirahat ?> /><span class="lbl"></span>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="info1" name="info1" class="autosize-transition form-control"><?php echo $row_jam->info1 ?></textarea>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmjam')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmjam')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Simpan" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frmjam')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('jam_view') ?>'" />
