	    ...
	    ?>
	    			...
	    			<tr style="background-color:ffffff;"> 
	    				...
	    				<td width="10%" align="center">
	    					<label class="pos-rel">
	    						<input type="checkbox" class="ace" id="registration_slc_<?php echo $no; ?>" name="registration_slc_<?php echo $no; ?>" onclick="checklist(<?php echo $no ?>)" value="1" ><span class="lbl"></span>
	    					</label>
