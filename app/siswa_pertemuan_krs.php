...
<script>
	function siswa_pertemuan_krs_excel() {
		...
		document.location.href = 'app/siswa_pertemuan_krs_xls.php?idtingkat2='+idtingkat2+'&idkelas2='+idkelas2+'&idtahunajaran='+idtahunajaran+'&semester_id='+semester_id+'&pelajaran_id='+pelajaran_id+'&approved='+approvedx+'';
	}
</script>
		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="kartu_rencana_studi" id="kartu_rencana_studi" enctype="multipart/form-data" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/daftar_nilai_ajax.php','tingkat_id','gettingkat_list2','departemen'), loadHTMLPost('<?php echo $__folder ?>app/daftar_nilai_ajax.php','semester_id','getsemester','departemen')" >
							<option value=""></option>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-2" id="semester_id">
						<select name="semester_id" id="semester_id" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_semester_all($departemen, $semester_id); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="radio" id="approved" name="approved" class="ace" value="1" <?php echo $approvedx ?> ><span class="lbl">&nbsp;Sudah Approved&nbsp;&nbsp;</span>
						<input type="radio" id="approved1" name="approved" class="ace" value="0" <?php echo $approvedx1 ?> ><span class="lbl">&nbsp;Belum Approved</span>
					</div>
				</div>
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-3">
                      ...
                      &nbsp;&nbsp;<a href="JavaScript:siswa_pertemuan_krs_excel()">
							...
							<tbody>
                                <?php			
						            ...
						            while($siswa_krs_view=$sql->fetch(PDO::FETCH_OBJ)){
										...
										//jumlah KBM
										$sql_ukbm = $selectview->list_ukbm("", $idtingkat2, $pelajaran_id);
								...
								?>
                                        ...
                                        <tr>
											...
											<td><?php echo $siswa_krs_view->tahunajaran ?></td>
											<td><?php echo $siswa_krs_view->semester ?></td>
											<td><?php echo $jmlkbm ?></td>
											<!--<td align="center">
