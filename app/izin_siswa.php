		...
		<div class="col-xs-12">
			...
			<form action="" method="post" name="izin_siswa" id="izin_siswa" class="form-horizontal" onSubmit="return cekinput('idsiswa,tanggal,jam,menit,idjenis_izin,status,idpegawai');">
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onchange="loadHTMLPost2('app/izin_siswa_ajax.php','kelas_id','getkelas','idtingkat')" />
							<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-3" id="siswa_id">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jenis Izin *)</label>
					<div class="col-sm-3">						
						<select name="idjenis_izin" id="idjenis_izin" class="chosen-select form-control" />
                            <option value=""></option>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Format Surat</label>
					<div class="col-sm-3">						
						<textarea name="format_surat" id="format_surat" class='span12 cleditor'><?php echo $izin_siswa_data->format_surat ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">						
						<textarea name="keterangan" id="keterangan" class='span12 input-square' rows="3"><?php echo $izin_siswa_data->keterangan ?></textarea>
					</div>
				</div>
