		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$ref2	=	$row_tahunajaran->code;		
					
					$tglmulai	=	date("d-m-Y", strtotime($row_tahunajaran->tglmulai));
					$tglakhir	=	date("d-m-Y", strtotime($row_tahunajaran->tglakhir));
					
					if ($row_tahunajaran->aktif == 1) {
						$act = "checked";
					} else {
						$act = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="tahunajaran" id="tahunajaran" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tahunajaran');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_departemen($row_tahunajaran->departemen); ?>
						</select>
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="tahunajaran" name="tahunajaran" class="form-control" autocomplete="off" value="<?php echo $row_tahunajaran->tahunajaran ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Kepala Sekolah</label>
					<div class="col-sm-2">
						<select name="info1" id="info1" class="chosen-select form-control" style="width:auto;" >
							<option value=""></option>
							<?php select_pegawai($row_tahunajaran->info1); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" id="tglmulai" name="tglmulai" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $tglmulai ?>">
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="tglakhir" name="tglakhir" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $tglakhir ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" onKeyup="this.value=this.value.toUpperCase()" class="autosize-transition form-control"><?php echo $row_tahunajaran->keterangan ?></textarea>
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Upload TTD</label>
					<div class="col-sm-3">
						<input type="file" id="ttd_file" name="ttd_file" class="form-control" style="width: auto" value="" >
						<?php if (!empty($row_tahunajaran->ttd_file)) { ?>
    						<br>
	    					<a href="<?php echo $__folder ?>app/file_ttd/<?php echo $row_tahunajaran->ttd_file ?>" rel="lightbox" style="text-decoration:none;" title="Photo View">
								<label>
									<img src="../app/file_ttd/<?php echo $row_tahunajaran->ttd_file; ?>" width="50" height="50" />
								</label>
							</a>
							
	    				<?php } ?>
	    				<input type="hidden" id="ttd_file2" name="ttd_file2" value="<?php echo $row_tahunajaran->ttd_file; ?>">	
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<?php if($ref=='') { ?>
							<input class="ace" type="checkbox" name="aktif" id="aktif" value="1" <?php echo $act ?>/>
						<?php } else { ?>
							<input class="ace" type="checkbox" name="aktif" id="aktif" value="1" <?php if($row_tahunajaran->aktif==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Plot Tahun Ajaran</label>
					<div class="col-sm-3">
						<input class="ace" type="checkbox" name="info2" id="info2" value="1" <?php echo $info2 ?>/>
						<span class="lbl"></span>
