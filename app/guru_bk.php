	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_guru_bk.php");
				
				$aktif = "checked";
				
				if ($ref != "") {
					$sql=$select->list_guru_bk($ref);
					$guru_bk_data=$sql->fetch(PDO::FETCH_OBJ);	
					
					$aktif = "";
					if($guru_bk_data->aktif == 1) {
						$aktif = "checked";
					}					
				}		
			?>
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="guru_bk2" id="guru_bk2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('departemen,idtahunajaran,idguru');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control">
							<option value=""></option>
							<?php select_departemen($guru_bk_data->departemen); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-5">						
						<select name="idguru" id="idguru" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_petugas($guru_bk_data->idguru) ?>
						</select>						
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('guru_bk_view') ?>'" />
