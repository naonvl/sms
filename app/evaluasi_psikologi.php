...
<script type="text/javascript">
	function getnissemester() {
		...
		if( tanggal != "" && departemen != "" && idtingkat == "" && idkelas == "") {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('evaluasi_psikologi') ?>/"+tanggal+"/"+departemen+"";
		}
		if( tanggal != "" && departemen != "" && idtingkat != "" && idkelas == "") {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('evaluasi_psikologi') ?>/"+tanggal+"/"+departemen+"/"+idtingkat+"";
		}
		if( tanggal != "" && departemen != "" && idtingkat != "" && idkelas != "") {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('evaluasi_psikologi') ?>/"+tanggal+"/"+departemen+"/"+idtingkat+"/"+idkelas+"";
		}
	}
</script>
...
$tanggal = $segmen3; //$_GET["tanggal"];
$tanggal = date("d-m-Y", strtotime($tanggal));
$departemen = $segmen4; //$_GET["departemen"];
$idtingkat = $segmen5; //$_GET["idtingkat"];
$idkelas = $segmen6; //$_GET["idkelas"];
		...
		<div class="col-xs-12">
			...
			<form action="" method="post" name="evaluasi_psikologi" id="evaluasi_psikologi" class="form-horizontal" onSubmit="return cekinput('tanggal,departemen,idtingkat,idkelas,nis,idsemester');" enctype="multipart/form-data" />
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="ref2" id="ref2" class="form-control" readonly="" value="<?php echo $ref2 ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<select name="nis" id="nis" class="chosen-select form-control" onchange="loadHTMLPost3('<?= $__folder ?>app/evaluasi_psikologi_detail_ajax.php','aspek_psikologi_id','get_jenisaspek_psikologi','departemen','nis','idsemester')" >
							<option value="">...</option>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idsemester" id="idsemester" class="chosen-select form-control" onchange="loadHTMLPost3('<?= $__folder ?>app/evaluasi_psikologi_detail_ajax.php','aspek_psikologi_id','get_jenisaspek_psikologi','departemen','nis','idsemester')" >
							<option value="">...</option>
