...
<script type="text/javascript">
	function penugasan_input() {
		var departemen = document.getElementById('departemen').value;
		window.location = '<?php echo $__folder ?><?php echo obraxabrix('guru_penugasan') ?>/'+departemen;
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				if($departemen == "PG" || $departemen == "TK" || $departemen == "SD" || $departemen == "SMP" || $departemen == "SMA") {
					$ref = "";
				}	
				...
				include("app/exec/insert_guru_penugasan.php"); 
				if ($ref != "") {
					$departemen = $segmen5;
					$sql=$select->list_guru_penugasan("", $segmen4, $ref, "", "", "", "", $departemen);
					$row_guru_penugasan=$sql->fetch(PDO::FETCH_OBJ);
					$idtahunajaran = $row_guru_penugasan->idtahunajaran;
					$idguru = $row_guru_penugasan->idguru;
					$departemen = $row_guru_penugasan->departemen;
					
					$aktif = $row_guru_penugasan->aktif;	
					if($aktif == 1) {
						$aktif = "checked";
					}
				}		
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="guru_penugasan" id="guru_penugasan" enctype="multipart/form-data" onSubmit="return cekinput('departemen,idtahunajaran,idpegawai');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" onchange="penugasan_input()" >
							<option value=""></option>
					...
					<div class="col-lg-2">
						<select name="idtahunajaran" id="idtahunajaran" class="chosen-select form-control" />
							...
							<?php //select_thnajaran_unit($departemen, $idtahunajaran); 
								select_thnajaran($idtahunajaran);
							?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Guru </label>
                    <div class="col-sm-5">
						<select id="idpegawai" name="idpegawai" data-placeholder="..." class="chosen-select form-control" style="width: auto">
	                        <option value=""></option>
	                        <?php 
	                        	select_guru_mengajar($idguru)
	                        ?>	
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="checkbox" name="aktif" id="aktif" class="ace" style="width:70px; height:16px; " value="1" <?php echo $aktif ?> ><span class="lbl"></span>
					</div>
				</div>
                ...
                <?php 
					if($ref == "") {
						include("guru_penugasan_detail.php");
					} else {
						include("guru_penugasan_detail_update.php");
					}
				?>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmguru_penugasan','')==1) { ?>
    						<?php if($ref=='') { ?>
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('guru_penugasan_view') ?>'" />
