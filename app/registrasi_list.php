...
<script type="text/javascript">
	function lulus_batal(id) {
		if (confirm('Yakin Batal Lulus ?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('registrasi_list') ?>/unlulus/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($unlulus == "unlulus") 
				{
					...
					$update2=new update;
					$update2->update_registrasi_unlulus($segmen4);
			?>
					<meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('registrasi_list') ?>" />
			<?php
				}
			?>
				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="siswa_lis" id="siswa_list" enctype="multipart/form-data" >
		            	...
		            	<div class="form-group">
							...
							<div class="col-sm-3">
								<select name="tahunmasuk" id="tahunmasuk" class="chosen-select form-control" />
									<option value=""></option>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="tanggal" name="tanggal" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $tanggal ?>">						
							</div>
						</div>
						...
						<!--<div class="form-group">
							...
							<div class="col-sm-3">
								<select name="idjurusan" id="idjurusan" class="chosen-select form-control" />
									<option value=""></option>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="reg_list" id="reg_list" enctype="multipart/form-data">
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="font-size: 11px">
							<thead>
								<tr>
                                    ...
                                    <th style="font-weight:bold ">Nama Sekolah &nbsp;&nbsp;</th>
									...
									<th style="font-weight:bold ">Jenis Pendaftaran &nbsp;&nbsp;</th>
									<th style="font-weight:bold ">Jalur Masuk &nbsp;&nbsp;</th>
									<th style="font-weight:bold ">Download Berkas &nbsp;&nbsp;</th>
							...
							<tbody>
                                <?php			
									$sql=$selectview->list_registrasi("", "", $tahunmasuk, $idtingkat, $tanggal, $idjurusan, $nama, $all, $idproses, $idkelompok, $departemen, $departemen_sekolah_id);		
								...
								?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $registrasi_view->departemen ?></td>
                                            <td><?php echo $registrasi_view->nama_sekolah ?></td>
                                            <td><?php echo $tanggal ?></td>
											<td>
												<a href="<?php echo $__folder ?><?php echo obraxabrix('registrasi') ?>/<?php echo $registrasi_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="View Detail" target="_blank">
													<span class="blue">
														<?php echo $registrasi_view->nopendaftaran ?>
													</span>
												</a>		
											</td>
											<td><?php echo $registrasi_view->nama ?></td>
											<td><?php echo $kelamin ?></td>
											<td><?php echo $registrasi_view->jenis_pendaftaran ?></td>
											<td><?php echo $registrasi_view->jalur_masuk ?></td>
											<td>
												<?php if($registrasi_view->info3 != "") { ?>
													Bukti Bayar :
													<a href="<?php echo $__folder ?>app/registrasireg_download.php?ref=<?php echo $registrasi_view->replid ?>&type=1" target="_blank" title="<?= $registrasi_view->info3 ?>">
														<span class="blue">
															<i class="ace-icon fa fa-cloud-download bigger-220"></i>
														</span>
													</a>
												<?php } ?>	
												<?php if($registrasi_view->file_raport != "") { ?>
													<br>
													File Sanggup Bayar :
													<a href="<?php echo $__folder ?>app/registrasireg_download.php?ref=<?php echo $registrasi_view->replid ?>&type=6" target="_blank" title="<?= $registrasi_view->file_raport ?>">
														<span class="blue">
															<i class="ace-icon fa fa-cloud-download bigger-220"></i>
														</span>
													</a>
												...
												<?php if($registrasi_view->file_kk != "") { ?>
													<br>
													File KK :
													<a href="<?php echo $__folder ?>app/registrasireg_download.php?ref=<?php echo $registrasi_view->replid ?>&type=2" target="_blank" title="<?= $registrasi_view->file_kk ?>">
														<span class="blue">
															<i class="ace-icon fa fa-cloud-download bigger-220"></i>
														</span>
													</a>
												<?php } ?>	
												<?php if($registrasi_view->file_akte != "") { ?>
													<br>
													File Akte Kelahiran :
													<a href="<?php echo $__folder ?>app/registrasireg_download.php?ref=<?php echo $registrasi_view->replid ?>&type=3" target="_blank" title="<?= $registrasi_view->file_akte ?>">
														<span class="blue">
															<i class="ace-icon fa fa-cloud-download bigger-220"></i>
														</span>
													</a>
												<?php } ?>	
												<?php if($registrasi_view->file_ktp != "") { ?>
													<br>
													File KTP :
													<a href="<?php echo $__folder ?>app/registrasireg_download.php?ref=<?php echo $registrasi_view->replid ?>&type=4" target="_blank" title="<?= $registrasi_view->file_ktp ?>">
														<span class="blue">
															<i class="ace-icon fa fa-cloud-download bigger-220"></i>
														</span>
													</a>
												<?php } ?>	
												<?php if($registrasi_view->file_memo_ortu != "") { ?>
													<br>
													File Sanggup Bayar :
													<a href="<?php echo $__folder ?>app/registrasireg_download.php?ref=<?php echo $registrasi_view->replid ?>&type=5" target="_blank" title="<?= $registrasi_view->file_memo_ortu ?>">
														<span class="blue">
															<i class="ace-icon fa fa-cloud-download bigger-220"></i>
														</span>
													</a>
											...
											<th style="text-align: center;">
												<input type="hidden" id="ref_<?php echo $i ?>" name="ref_<?php echo $i ?>" value="<?php echo $registrasi_view->replid ?>"/>

												<?php if($registrasi_view->lulus == 0) { ?>
													<input type="checkbox" name="select_<?= $i ?>" id="select_<?= $i ?>" class="ace" value="1" ><span class="lbl"></span>
												<?php } else { ?>
													<a href='JavaScript:lulus_batal("<?= $registrasi_view->replid ?>")' class='tooltip-error' data-rel='tooltip' title='Batal Lulus'>
														<span class="green">
							...
							<?php if (allowadd('registrasi_list')==1) { ?> 
								<tr>
									<td colspan="11" align="right">
										<button type="submit" name="submit" id="submit" class="btn btn-white btn-succes btn-bold" value="lulus_all" onClick="return confirm('Yakin data sudah benar ?')">
